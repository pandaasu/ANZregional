...
/* Package Header */
/******************/
create or replace package qv_app.qvi_oraqvi01_dim_retriever as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : qvi_oraqvi01_dim_retriever
    Owner   : qv_app
   ...
   *******************************************************************************/
   ...
   /* Public declarations
   /*-*/
   function get_table(par_dim_code in varchar2) return qvi_oraqvi01_dim_tab pipelined;

end qvi_oraqvi01_dim_retriever;
/

/****************/
/* Package Body */
/****************/
create or replace package body qv_app.qvi_oraqvi01_dim_retriever as
   ...
   con_package_name constant varchar2(30) := 'QVI_ORAQVI01_DIM_RETRIEVER';
   ...
   /******************************************************/
   function get_table(par_dim_code in varchar2) return qvi_oraqvi01_dim_tab pipelined is
      /*-*/
...
grant execute on procedure qvi_oraqvi01_dim_retriever to qv_user;
