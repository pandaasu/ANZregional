...
'// Script  : qvi_das_config_part_select.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration part select functionality            //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_maintenance.select_part_list)"
