...
'// Script  : qvi_das_config_part_update.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration part update functionality            //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the dashboard part update
   '//
   call objProcedure.Execute("qv_app.qvi_das_maintenance.update_part_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
