...
'// Script  : qvi_das_config_time_retrieve.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration time retrieve functionality          //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the dashboard time definition
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_maintenance.retrieve_time_data)"
