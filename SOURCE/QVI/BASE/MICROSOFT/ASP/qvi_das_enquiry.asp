...
'// Script  : qvi_das_enquiry.asp                                //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard enquiry       //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "qvi_das_enquiry.asp"
   strHeading = "Dashboard Enquiry"
   ...
   '//
   strReturn = GetSecurityCheck("QVI_DAS_ENQUIRY")
...
<!--
   ...
   function loadFunction() {
      ...
      cobjScreens[2] = new clsScreen('dspFactSelect','hedFactSelect');
   ...
   function requestSelectList(strAction) {
      ...
      doPostRequest('<%=strBase%>qvi_das_enquiry_select.asp',function(strResponse) {checkSelectList(strResponse);},false,streamXML(strXML));
   }
   ...
   function checkFactSelectList(strResponse) {
      ...
      if (strResponse.substring(0,3) != '*OK') {
         ...
         document.getElementById('hedFactData').innerHTML = '<p>Dashboard ('+cstrSelectDasCode+')</p>';
   ...
   function checkTimeSelectList(strResponse) {
      ...
      if (strResponse.substring(0,3) != '*OK') {
         ...
         document.getElementById('hedTimeData').innerHTML = '<p>Dashboard ('+cstrSelectDasCode+') Fact ('+cstrSelectFacCode+')</p>';
   ...
   function checkPartSelectList(strResponse) {
      ...
      if (strResponse.substring(0,3) != '*OK') {
         ...
         document.getElementById('hedPartData').innerHTML = '<p>Dashboard ('+cstrSelectDasCode+') Fact ('+cstrSelectFacCode+') Time ('+cstrSelectTimCode+')</p>';
...
<body class="clsBody02" scroll="auto" onLoad="parent.setStatus('<%=strStatus%>');parent.setHelp('qvi_das_enquiry_help.htm');parent.setHeading('<%=strHeading%>');parent.showContent();loadFunction();">
   ...
   <table id="dspSelect" class="clsGrid02" style="display:none;visibility:visible" height=100% width=100% align=center valign=top cols=2 cellpadding=1 cellspacing=0>
      ...
      <tr>
         <td id="hedSelect" class="clsFunction" align=center colspan=2 nowrap><nobr>Dashboard Enquiry</nobr></td>
      </tr>
      <tr>
