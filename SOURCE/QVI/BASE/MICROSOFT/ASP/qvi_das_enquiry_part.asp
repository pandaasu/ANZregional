...
'// Script  : qvi_das_enquiry_part.asp                           //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard enquiry part  //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the dashboard part selection
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_enquiry.select_part_list)"
