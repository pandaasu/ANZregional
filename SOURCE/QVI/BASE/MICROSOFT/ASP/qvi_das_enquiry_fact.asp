...
'// Script  : qvi_das_enquiry_fact.asp                           //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard enquiry fact  //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the dashboard fact selection
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_enquiry.select_fact_list)"
