...
'// Date    : September 2005                                     //
'// Text    : This script implements the interface for job error //
...
sub ProcessUpdateLoad()
   ...
   call objForm.AddField("DTA_IntProcedure", objSelection.ListValue14("LIST",objSelection.ListLower("LIST")))
   call objForm.AddField("DTA_IntStatus", objSelection.ListValue15("LIST",objSelection.ListLower("LIST")))
