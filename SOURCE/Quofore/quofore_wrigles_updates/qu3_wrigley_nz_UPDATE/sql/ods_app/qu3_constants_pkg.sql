...
create or replace package ods_app.qu3_constants as
  /*****************************************************************************
  ** Package Definition
  ******************************************************************************
...
create or replace package body ods_app.qu3_constants as
  ...
  -- Public : Functions : Application Instance Specific
  function app_instance_name return varchar2 as begin return 'Quofore - Wrigley New Zealand'; end app_instance_name;
  function setting_group return varchar2 as begin return 'QU3_WRIGLEY_NZ'; end setting_group;
...
-- Synonyms
create or replace public synonym qu3_constants for ods_app.qu3_constants;

-- Grants
grant execute on ods_app.qu3_constants to public;
