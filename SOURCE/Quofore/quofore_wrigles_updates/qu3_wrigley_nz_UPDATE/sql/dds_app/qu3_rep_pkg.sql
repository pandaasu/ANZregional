...
create or replace package dds_app.qu3_rep_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    View Package, Entity [Rep] Table [qu3_rep][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu3_rep_type is table of ods.qu3_rep_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu3_rep_type pipelined;
  function view_history return qu3_rep_type pipelined;

end qu3_rep_pkg;
/

create or replace package body dds_app.qu3_rep_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu3_rep_pkg';
  g_entity_name constant varchar2(64 char) := 'Rep';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu3_rep_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu3_rep_type pipelined is
...
-- Synonyms
create or replace public synonym qu3_rep_pkg for dds_app.qu3_rep_pkg;

-- Grants
grant execute on dds_app.qu3_rep_pkg to qv_user, bo_user;
