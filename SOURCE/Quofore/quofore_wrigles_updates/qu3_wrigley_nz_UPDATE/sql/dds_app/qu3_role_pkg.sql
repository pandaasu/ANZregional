...
create or replace package dds_app.qu3_role_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    System   : qu3
    Owner    : dds_app
    Package  : qu3_role_pkg
    Author   : [Auto-Generate]

    Description
    ------------------------------------------------------------------------------
    [qu3] Quofore - Wrigley New Zealand
    View Package, Entity [Role] Table [qu3_role][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu3_role_type is table of ods.qu3_role_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu3_role_type pipelined;
  function view_history return qu3_role_type pipelined;

end qu3_role_pkg;
/

create or replace package body dds_app.qu3_role_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu3_role_pkg';
  g_entity_name constant varchar2(64 char) := 'Role';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu3_role_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu3_role_type pipelined is
...
-- Synonyms
create or replace public synonym qu3_role_pkg for dds_app.qu3_role_pkg;

-- Grants
grant execute on dds_app.qu3_role_pkg to qv_user, bo_user;
