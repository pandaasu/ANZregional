...
create or replace package dds_app.qu3_terr_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    System   : qu3
    Owner    : dds_app
    Package  : qu3_terr_pkg
    Author   : [Auto-Generate]

    Description
    ------------------------------------------------------------------------------
    [qu3] Quofore - Wrigley New Zealand
    View Package, Entity [Territory] Table [qu3_terr][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu3_terr_type is table of ods.qu3_terr_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu3_terr_type pipelined;
  function view_history return qu3_terr_type pipelined;

end qu3_terr_pkg;
/

create or replace package body dds_app.qu3_terr_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu3_terr_pkg';
  g_entity_name constant varchar2(64 char) := 'Territory';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu3_terr_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu3_terr_type pipelined is
...
-- Synonyms
create or replace public synonym qu3_terr_pkg for dds_app.qu3_terr_pkg;

-- Grants
grant execute on dds_app.qu3_terr_pkg to qv_user, bo_user;
