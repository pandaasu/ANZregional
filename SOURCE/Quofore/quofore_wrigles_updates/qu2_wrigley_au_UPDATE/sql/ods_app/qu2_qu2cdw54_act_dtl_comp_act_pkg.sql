...
create or replace package ods_app.qu2_qu2cdw54 as
  /*****************************************************************************
  ** Package Definition
  ******************************************************************************
    ...
    System   : qu2
    Owner    : ods_app
    Package  : qu2_qu2cdw54
    Author   : [Auto-Generate]

    Description
    ----------------------------------------------------------------------------
    [qu2] Quofore - Wrigley Australia
    Loader Package, Interface [qu2cdw54] Entity [ActivityDetailCompetitionAct] Table [qu2_act_dtl_comp_act][_load/_hist]
...
create or replace package body ods_app.qu2_qu2cdw54 as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'ods_app.qu2_qu2cdw54';
  g_entity_name constant varchar2(64 char) := 'ActivityDetailCompetitionAct';
  ...
  *****************************************************************************/
  ...
  begin
    ...
    lics_inbound_utility.set_csv_definition('wwy_comp',3);
    lics_inbound_utility.set_csv_definition('wwy_comp_call_cycle',4);
    lics_inbound_utility.set_csv_definition('wwy_comp_focus',5);
    lics_inbound_utility.set_csv_definition('wwy_offer_to_retailer',6);
    lics_inbound_utility.set_csv_definition('wwy_comp_act_app_by',7);
    lics_inbound_utility.set_csv_definition('wwy_impact_hardware',8);
    lics_inbound_utility.set_csv_definition('wwy_impact_facings',9);
    lics_inbound_utility.set_csv_definition('wwy_result_exit',10);
    lics_inbound_utility.set_csv_definition('wwy_value_reward',11);
    lics_inbound_utility.set_csv_definition('wwy_result_exit_app_by',12);
    lics_inbound_utility.set_csv_definition('hier_node_id',13);
  ...
  *****************************************************************************/
  procedure process_header_row(p_row in varchar2) is
    ...
    l_expected_row varchar2(4000 char) := 'ID,Activity_ID,WrigCompetitor,WrigCompCallCycle,WrigCompFocus,WrigOfferToRetailer,WrigCompActAppBy,WrigImpactHardware,WrigImpactFacings,WrigResultExit,WrigValueReward,WrigResultExitAppBy,HierarchyNode_Id';
  ...
  *****************************************************************************/
  procedure process_data_row(p_row in varchar2) is
    ...
    l_entity_load_row ods.qu2_act_dtl_comp_act_load%rowtype;
  ...
  begin
    ...
    begin
      ...
      l_entity_load_row.wwy_comp := qu2_util.get_number('wwy_comp',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_comp_call_cycle := qu2_util.get_number('wwy_comp_call_cycle',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_comp_focus := qu2_util.get_number('wwy_comp_focus',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_offer_to_retailer := qu2_util.get_number('wwy_offer_to_retailer',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_comp_act_app_by := qu2_util.get_number('wwy_comp_act_app_by',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_impact_hardware := qu2_util.get_number('wwy_impact_hardware',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_impact_facings := qu2_util.get_number('wwy_impact_facings',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_result_exit := qu2_util.get_number('wwy_result_exit',10,0,true,g_source_file_error_flag);
      l_entity_load_row.wwy_value_reward := qu2_util.get_string('wwy_value_reward',4000,true,g_source_file_error_flag);
      l_entity_load_row.wwy_result_exit_app_by := qu2_util.get_number('wwy_result_exit_app_by',10,0,true,g_source_file_error_flag);
    ...
    -- Insert row
    begin
      insert into ods.qu2_act_dtl_comp_act_load values l_entity_load_row;
    exception
      when others then
         lics_inbound_utility.add_exception(substr('['||g_package_name||'.process_data_row] Insert Failed [ods.qu2_act_dtl_comp_act_load] : '||SQLERRM, 1, 4000));
         g_source_file_error_flag := true;
    end;
  ...
  *****************************************************************************/
  ...
  begin
    ...
    from ods.qu2_act_dtl_comp_act_load
    ...
    update ods.qu2_act_dtl_comp_act_load
    set q4x_modify_user = user,
      q4x_modify_time = sysdate
    where q4x_batch_id = p_batch_id;

    -- Insert ALL of Load Batch into History
    insert into ods.qu2_act_dtl_comp_act_hist
    select *
    from ods.qu2_act_dtl_comp_act_load
    where q4x_batch_id = p_batch_id;

    -- Delete Load Batch
    delete from ods.qu2_act_dtl_comp_act_load
    where q4x_batch_id = p_batch_id;

  exception
    when others then
      g_abort_processing_flag := true;
      raise_application_error(-20000, substr('['||g_package_name||'.process_batch] Failed [ods.qu2_act_dtl_comp_act/_load/_hist] : '||SQLERRM, 1, 4000));
...
-- Synonyms
create or replace public synonym qu2_qu2cdw54 for ods_app.qu2_qu2cdw54;

-- Grants
grant execute on ods_app.qu2_qu2cdw54 to lics_app;
