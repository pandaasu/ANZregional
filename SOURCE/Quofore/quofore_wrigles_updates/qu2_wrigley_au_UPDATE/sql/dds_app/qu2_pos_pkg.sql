...
create or replace package dds_app.qu2_pos_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    View Package, Entity [Position] Table [qu2_pos][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu2_pos_type is table of ods.qu2_pos_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu2_pos_type pipelined;
  function view_history return qu2_pos_type pipelined;

end qu2_pos_pkg;
/

create or replace package body dds_app.qu2_pos_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu2_pos_pkg';
  g_entity_name constant varchar2(64 char) := 'Position';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu2_pos_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu2_pos_type pipelined is
...
-- Synonyms
create or replace public synonym qu2_pos_pkg for dds_app.qu2_pos_pkg;

-- Grants
grant execute on dds_app.qu2_pos_pkg to qv_user, bo_user;
