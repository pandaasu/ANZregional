...
create or replace package dds_app.qu2_task_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    System   : qu2
    Owner    : dds_app
    Package  : qu2_task_pkg
    Author   : [Auto-Generate]

    Description
    ------------------------------------------------------------------------------
    [qu2] Quofore - Wrigley Australia
    View Package, Entity [Task] Table [qu2_task][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu2_task_type is table of ods.qu2_task_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu2_task_type pipelined;
  function view_at_start_date(p_date in date) return qu2_task_type pipelined;
  function view_history return qu2_task_type pipelined;

end qu2_task_pkg;
/

create or replace package body dds_app.qu2_task_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu2_task_pkg';
  g_entity_name constant varchar2(64 char) := 'Task';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu2_task_type pipelined is
  ...
  *****************************************************************************/
  function view_at_start_date(p_date in date) return qu2_task_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu2_task_type pipelined is
...
-- Synonyms
create or replace public synonym qu2_task_pkg for dds_app.qu2_task_pkg;

-- Grants
grant execute on dds_app.qu2_task_pkg to qv_user, bo_user;
