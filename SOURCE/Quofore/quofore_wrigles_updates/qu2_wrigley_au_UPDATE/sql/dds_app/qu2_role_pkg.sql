...
create or replace package dds_app.qu2_role_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    System   : qu2
    Owner    : dds_app
    Package  : qu2_role_pkg
    Author   : [Auto-Generate]

    Description
    ------------------------------------------------------------------------------
    [qu2] Quofore - Wrigley Australia
    View Package, Entity [Role] Table [qu2_role][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu2_role_type is table of ods.qu2_role_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu2_role_type pipelined;
  function view_history return qu2_role_type pipelined;

end qu2_role_pkg;
/

create or replace package body dds_app.qu2_role_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu2_role_pkg';
  g_entity_name constant varchar2(64 char) := 'Role';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu2_role_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu2_role_type pipelined is
...
-- Synonyms
create or replace public synonym qu2_role_pkg for dds_app.qu2_role_pkg;

-- Grants
grant execute on dds_app.qu2_role_pkg to qv_user, bo_user;
