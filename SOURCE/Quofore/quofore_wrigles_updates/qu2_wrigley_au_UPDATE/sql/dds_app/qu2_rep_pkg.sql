...
create or replace package dds_app.qu2_rep_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    View Package, Entity [Rep] Table [qu2_rep][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu2_rep_type is table of ods.qu2_rep_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu2_rep_type pipelined;
  function view_history return qu2_rep_type pipelined;

end qu2_rep_pkg;
/

create or replace package body dds_app.qu2_rep_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu2_rep_pkg';
  g_entity_name constant varchar2(64 char) := 'Rep';

  /*****************************************************************************
  ** Function : Return Entity : As at Date
  *****************************************************************************/
  function view_at_date(p_date in date) return qu2_rep_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu2_rep_type pipelined is
...
-- Synonyms
create or replace public synonym qu2_rep_pkg for dds_app.qu2_rep_pkg;

-- Grants
grant execute on dds_app.qu2_rep_pkg to qv_user, bo_user;
