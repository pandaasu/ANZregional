...
create or replace package quo_quocdw11 as
/*******************************************************************************
** Package Definition
********************************************************************************
  ...
  System  : quo
  Owner   : ods_app
  Package : quo_quocdw11
  Author  : Mal Chambeyron
  
  Description
  ------------------------------------------------------------------------------
  Quofore Loader Package - Interface [quocdw11] Entity [CustomerContact] Table [quo_cust_contact] 
...
create or replace package body quo_quocdw11 as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'ods_app.quo_quocdw11';
  g_entity_name constant varchar2(32 char) := 'CustomerContact';
  ...
  g_entity_load_row ods.quo_cust_contact_load%rowtype;
  g_entity_row ods.quo_cust_contact%rowtype;
  g_entity_hist_row ods.quo_cust_contact_hist%rowtype;
  ...
  *****************************************************************************/
  ...
  begin
    ...
    lics_inbound_utility.set_csv_definition('cansign',4);
    lics_inbound_utility.set_csv_definition('cust_id',5);
    lics_inbound_utility.set_csv_definition('cust_id_lookup',6);
    lics_inbound_utility.set_csv_definition('dept_id',7);
    lics_inbound_utility.set_csv_definition('dept_id_lookup',8);
    lics_inbound_utility.set_csv_definition('dept_id_desc',9);
    lics_inbound_utility.set_csv_definition('email',10);
    lics_inbound_utility.set_csv_definition('first_name',11);
    lics_inbound_utility.set_csv_definition('full_name',12);
    lics_inbound_utility.set_csv_definition('last_name',13);
    lics_inbound_utility.set_csv_definition('middle_name',14);
    lics_inbound_utility.set_csv_definition('mobile_no',15);
    lics_inbound_utility.set_csv_definition('phone_no',16);
    lics_inbound_utility.set_csv_definition('photo_file_name',17);
    lics_inbound_utility.set_csv_definition('pos_id',18);
    lics_inbound_utility.set_csv_definition('pos_id_lookup',19);
    lics_inbound_utility.set_csv_definition('pos_id_desc',20);
    lics_inbound_utility.set_csv_definition('pref_contact_method_id',21);
    lics_inbound_utility.set_csv_definition('pref_contact_method_id_lookup',22);
    lics_inbound_utility.set_csv_definition('pref_contact_method_id_desc',23);
    lics_inbound_utility.set_csv_definition('cust_id_desc',24);
  ...
  *****************************************************************************/
  procedure process_header_row(p_row in varchar2) is
    ...
    l_expected_row varchar2(4000 char) := 'ID,IsActive,CreatedDate,CanSign,Customer_Id,Customer_Id_Lookup,DepartmentId,DepartmentId_Lookup,DepartmentId_Description,Email,FirstName,FullName,LastName,MiddleName,MobileNumber,PhoneNumber,PhotoFileName,PositionId,PositionId_Lookup,PositionId_Description,PreferredContactMethodID,PreferredContactMethodID_Lookup,PreferredContactMethodID_Description,customer_id_description';
  ...
  *****************************************************************************/
  procedure process_data_row(p_row in varchar2) is
    ...
    l_entity_load_row ods.quo_cust_contact_load%rowtype;
  ...
  begin
    ...
    begin
      ...
      l_entity_load_row.cansign := quo_util.get_boolean_as_number('cansign',true,g_source_file_error_flag);
      ...
      l_entity_load_row.dept_id := quo_util.get_number('dept_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.dept_id_lookup := quo_util.get_string('dept_id_lookup',50,true,g_source_file_error_flag);
      l_entity_load_row.dept_id_desc := quo_util.get_string('dept_id_desc',50,true,g_source_file_error_flag);
      l_entity_load_row.email := quo_util.get_string('email',60,true,g_source_file_error_flag);
      l_entity_load_row.first_name := quo_util.get_string('first_name',50,true,g_source_file_error_flag);
      l_entity_load_row.full_name := quo_util.get_string('full_name',101,true,g_source_file_error_flag);
      l_entity_load_row.last_name := quo_util.get_string('last_name',50,true,g_source_file_error_flag);
      l_entity_load_row.middle_name := quo_util.get_string('middle_name',50,true,g_source_file_error_flag);
      l_entity_load_row.mobile_no := quo_util.get_string('mobile_no',30,true,g_source_file_error_flag);
      l_entity_load_row.phone_no := quo_util.get_string('phone_no',30,true,g_source_file_error_flag);
      l_entity_load_row.photo_file_name := quo_util.get_string('photo_file_name',50,true,g_source_file_error_flag);
      l_entity_load_row.pos_id := quo_util.get_number('pos_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.pos_id_lookup := quo_util.get_string('pos_id_lookup',50,true,g_source_file_error_flag);
      l_entity_load_row.pos_id_desc := quo_util.get_string('pos_id_desc',50,true,g_source_file_error_flag);
      l_entity_load_row.pref_contact_method_id := quo_util.get_number('pref_contact_method_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.pref_contact_method_id_lookup := quo_util.get_string('pref_contact_method_id_lookup',50,true,g_source_file_error_flag);
      l_entity_load_row.pref_contact_method_id_desc := quo_util.get_string('pref_contact_method_id_desc',50,true,g_source_file_error_flag);
    ...
    -- Insert row
    begin
      insert into ods.quo_cust_contact_load values l_entity_load_row;
    exception
      when others then
         lics_inbound_utility.add_exception(substr('['||g_package_name||'.process_data_row] Insert Failed [ods.quo_cust_contact_load] : '||SQLERRM, 1, 4000));
         g_source_file_error_flag := true;
    end;
  ...
  *****************************************************************************/
  ...
  begin
    ...
    from ods.quo_cust_contact_load
    ...
    delete from ods.quo_cust_contact
    where q4x_source_id = p_source_id
    and q4x_batch_id < p_batch_id
    ...
    update ods.quo_cust_contact_load
    ...
    insert into ods.quo_cust_contact
    select * 
    from ods.quo_cust_contact_load
    where q4x_source_id = p_source_id
    and q4x_batch_id = p_batch_id
    and (q4x_source_id,id) not in (
      select q4x_source_id,id 
      from ods.quo_cust_contact 
      where q4x_source_id = p_source_id
    );

    -- Insert ALL of Load Batch into History
    insert into ods.quo_cust_contact_hist
    select * 
    from ods.quo_cust_contact_load
    where q4x_source_id = p_source_id
    and q4x_batch_id = p_batch_id;
    ...
    -- Delete Load Batch
    delete from ods.quo_cust_contact_load 
    where q4x_source_id = p_source_id
    and q4x_batch_id = p_batch_id;
  ...
  exception
    when others then
      g_abort_processing_flag := true;
      raise_application_error(-20000, substr('['||g_package_name||'.process_batch] Failed [ods.quo_cust_contact/_load/_hist] : '||SQLERRM, 1, 4000));
...
-- Synonyms
create or replace public synonym quo_quocdw11 for ods_app.quo_quocdw11;

-- Grants
grant execute on ods_app.quo_quocdw11 to lics_app;
