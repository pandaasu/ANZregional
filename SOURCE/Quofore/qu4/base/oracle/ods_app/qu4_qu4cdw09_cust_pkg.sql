...
create or replace package ods_app.qu4_qu4cdw09 as
  /*****************************************************************************
  ** Package Definition
  ******************************************************************************
    ...
    System   : qu4
    Owner    : ods_app
    Package  : qu4_qu4cdw09
    Author   : [Auto-Generate]

    Description
    ----------------------------------------------------------------------------
    [qu4] Quofore - Australia Chocolate
    Loader Package, Interface [qu4cdw09] Entity [Customer] Table [qu4_cust][_load/_hist]
...
create or replace package body ods_app.qu4_qu4cdw09 as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'ods_app.qu4_qu4cdw09';
  g_entity_name constant varchar2(64 char) := 'Customer';
  ...
  *****************************************************************************/
  ...
  begin
    ...
    lics_inbound_utility.set_csv_definition('cust_name',4);
    lics_inbound_utility.set_csv_definition('cust_ref_id',5);
    lics_inbound_utility.set_csv_definition('email',6);
    lics_inbound_utility.set_csv_definition('fax_no',7);
    lics_inbound_utility.set_csv_definition('group_edi_code',8);
    lics_inbound_utility.set_csv_definition('outlet_ref_id',9);
    lics_inbound_utility.set_csv_definition('phone_no',10);
    lics_inbound_utility.set_csv_definition('store_edi_code',11);
    lics_inbound_utility.set_csv_definition('web_addrs',12);
    lics_inbound_utility.set_csv_definition('channel_hier_id',13);
    lics_inbound_utility.set_csv_definition('store_size_hier_id',14);
    lics_inbound_utility.set_csv_definition('must_win_hier_id',15);
    lics_inbound_utility.set_csv_definition('sales_region_hier_id',16);
    lics_inbound_utility.set_csv_definition('merchant_code',17);
    lics_inbound_utility.set_csv_definition('merchant_name',18);
    lics_inbound_utility.set_csv_definition('buying_group',19);
    lics_inbound_utility.set_csv_definition('abn',20);
    lics_inbound_utility.set_csv_definition('visit_frequency',21);
    lics_inbound_utility.set_csv_definition('is_wholesaler',22);
    lics_inbound_utility.set_csv_definition('xml_ord_flag',23);
    lics_inbound_utility.set_csv_definition('corporate_flag',24);
  ...
  *****************************************************************************/
  procedure process_header_row(p_row in varchar2) is
    ...
    l_expected_row varchar2(4000 char) := 'Id,IsActive,CreatedDate,CustomerName,CustomerRefID,Email,FaxNumber,GroupEDICode,OutletRefID,PhoneNumber,StoreEDICode,WebAddress,Channel_Hierarchy_ID,StoreSize_Hierarchy_ID,MustWin_Hierarchy_ID,SalesRegion_Hierarchy_ID,MerchantCode,MerchantName,BuyingGroup,ABN,VisitFrequency,IsWholesaler,XMLOrderFlag,CorporateFlag';
  ...
  *****************************************************************************/
  procedure process_data_row(p_row in varchar2) is
    ...
    l_entity_load_row ods.qu4_cust_load%rowtype;
  ...
  begin
    ...
    begin
      ...
      l_entity_load_row.cust_name := qu4_util.get_string('cust_name',50,true,g_source_file_error_flag);
      l_entity_load_row.cust_ref_id := qu4_util.get_string('cust_ref_id',10,true,g_source_file_error_flag);
      l_entity_load_row.email := qu4_util.get_string('email',60,true,g_source_file_error_flag);
      l_entity_load_row.fax_no := qu4_util.get_string('fax_no',30,true,g_source_file_error_flag);
      l_entity_load_row.group_edi_code := qu4_util.get_string('group_edi_code',50,true,g_source_file_error_flag);
      l_entity_load_row.outlet_ref_id := qu4_util.get_string('outlet_ref_id',10,true,g_source_file_error_flag);
      l_entity_load_row.phone_no := qu4_util.get_string('phone_no',30,true,g_source_file_error_flag);
      l_entity_load_row.store_edi_code := qu4_util.get_string('store_edi_code',50,true,g_source_file_error_flag);
      l_entity_load_row.web_addrs := qu4_util.get_string('web_addrs',60,true,g_source_file_error_flag);
      l_entity_load_row.channel_hier_id := qu4_util.get_number('channel_hier_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.store_size_hier_id := qu4_util.get_number('store_size_hier_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.must_win_hier_id := qu4_util.get_number('must_win_hier_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.sales_region_hier_id := qu4_util.get_number('sales_region_hier_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.merchant_code := qu4_util.get_string('merchant_code',50,true,g_source_file_error_flag);
      l_entity_load_row.merchant_name := qu4_util.get_string('merchant_name',50,true,g_source_file_error_flag);
      l_entity_load_row.buying_group := qu4_util.get_string('buying_group',50,true,g_source_file_error_flag);
      l_entity_load_row.abn := qu4_util.get_string('abn',50,true,g_source_file_error_flag);
      l_entity_load_row.visit_frequency := qu4_util.get_number('visit_frequency',10,0,true,g_source_file_error_flag);
      l_entity_load_row.is_wholesaler := qu4_util.get_boolean_as_number('is_wholesaler',true,g_source_file_error_flag);
      l_entity_load_row.xml_ord_flag := qu4_util.get_boolean_as_number('xml_ord_flag',true,g_source_file_error_flag);
      l_entity_load_row.corporate_flag := qu4_util.get_boolean_as_number('corporate_flag',true,g_source_file_error_flag);
      exception
      when others then
    ...
    -- Insert row
    begin
      insert into ods.qu4_cust_load values l_entity_load_row;
    exception
      when others then
         lics_inbound_utility.add_exception(substr('['||g_package_name||'.process_data_row] Insert Failed [ods.qu4_cust_load] : '||SQLERRM, 1, 4000));
         g_source_file_error_flag := true;
    end;
  ...
  *****************************************************************************/
  ...
  begin
    ...
    update ods.qu4_cust_load
    set q4x_modify_user = user,
      q4x_modify_time = sysdate
    where q4x_batch_id = p_batch_id;

    -- Insert ALL of Load Batch into History
    insert into ods.qu4_cust_hist
    select *
    from ods.qu4_cust_load
    where q4x_batch_id = p_batch_id;

    -- Delete Load Batch
    delete from ods.qu4_cust_load
    where q4x_batch_id = p_batch_id;

  exception
    when others then
      g_abort_processing_flag := true;
      raise_application_error(-20000, substr('['||g_package_name||'.process_batch] Failed [ods.qu4_cust/_load/_hist] : '||SQLERRM, 1, 4000));
...
-- Synonyms
create or replace public synonym qu4_qu4cdw09 for ods_app.qu4_qu4cdw09;

-- Grants
grant execute on ods_app.qu4_qu4cdw09 to lics_app;
