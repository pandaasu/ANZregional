...
create or replace package ods_app.qu4_qu4cdw34 as
  /*****************************************************************************
  ** Package Definition
  ******************************************************************************
    ...
    System   : qu4
    Owner    : ods_app
    Package  : qu4_qu4cdw34
    Author   : [Auto-Generate]

    Description
    ----------------------------------------------------------------------------
    [qu4] Quofore - Australia Chocolate
    Loader Package, Interface [qu4cdw34] Entity [ActivityHeader] Table [qu4_act_hdr][_load/_hist]
...
create or replace package body ods_app.qu4_qu4cdw34 as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'ods_app.qu4_qu4cdw34';
  ...
  *****************************************************************************/
  ...
  begin
    ...
    lics_inbound_utility.set_csv_definition('call_card_id',7);
    ...
    lics_inbound_utility.set_csv_definition('notes',10);
    ...
    lics_inbound_utility.set_csv_definition('comments',14);
    lics_inbound_utility.set_csv_definition('key_site_plcmnt_is_activated',15);
    lics_inbound_utility.set_csv_definition('mstm_reg_plcmnt_no_of_register',16);
    lics_inbound_utility.set_csv_definition('mstm_reg_plcmnt_no_of_mstm',17);
    lics_inbound_utility.set_csv_definition('fridge_plcmnt_is_activated',18);
    lics_inbound_utility.set_csv_definition('fridge_plcmnt_no_of_doors',19);
    lics_inbound_utility.set_csv_definition('fridge_plcmnt_no_of_frdg_units',20);
    lics_inbound_utility.set_csv_definition('fridge_plcmnt_is_sleeved_up',21);
    lics_inbound_utility.set_csv_definition('fridge_plcmnt_is_mars_and_coke',22);
    lics_inbound_utility.set_csv_definition('front_back_fronts_in_store',23);
    lics_inbound_utility.set_csv_definition('front_back_fronts_tied_to_prom',24);
    lics_inbound_utility.set_csv_definition('front_back_front_end_type',25);
    lics_inbound_utility.set_csv_definition('front_back_backs_in_store',26);
    lics_inbound_utility.set_csv_definition('front_back_backs_tied_to_prom',27);
    lics_inbound_utility.set_csv_definition('front_back_back_end_type',28);
    lics_inbound_utility.set_csv_definition('lead_in_lead_out_is_any',29);
  ...
  *****************************************************************************/
  procedure process_header_row(p_row in varchar2) is
    ...
    l_expected_row varchar2(4000 char) := 'ID,Task_ID,Rep_ID,StartDate,IsComplete,EndDate,Callcard_ID,IncompleteReasonID,IncompleteReasonID_Description,Notes,DueDate,FullName,Task_ID_Description,Comments,KeysitePlacement_IsActivated,MSTMRegPlacement_NoOfRegisters,MSTMRegPlacement_NoOfMSTM,FridgePlacement_IsActivated,FridgePlacement_NoOfDoors,FridgePlacement_NoOfFridgeUnits,FridgePlacement_IsSleevedUp,FridgePlacement_IsMarsAndCokeCombo,FrontEndsBackEnds_FrontsInStore,FrontEndsBackEnds_FrontsTiedToPromo,FrontEndsBackEnds_FrontEndType,FrontEndsBackEnds_BacksInStore,FrontEndsBackEnds_BacksTiedToPromo,FrontEndsBackEnds_BackEndType,LeadInLeadOut_IsAny';
  ...
  *****************************************************************************/
  procedure process_data_row(p_row in varchar2) is
    ...
    l_entity_load_row ods.qu4_act_hdr_load%rowtype;
  ...
  begin
    ...
    begin
      ...
      l_entity_load_row.task_id := qu4_util.get_number('task_id',10,0,false,g_source_file_error_flag);
      l_entity_load_row.rep_id := qu4_util.get_number('rep_id',10,0,false,g_source_file_error_flag);
      l_entity_load_row.start_date := qu4_util.get_datetime('start_date',true,g_source_file_error_flag);
      l_entity_load_row.is_complete := qu4_util.get_boolean_as_number('is_complete',true,g_source_file_error_flag);
      l_entity_load_row.end_date := qu4_util.get_datetime('end_date',true,g_source_file_error_flag);
      l_entity_load_row.call_card_id := qu4_util.get_number('call_card_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.incomplete_reason_id := qu4_util.get_number('incomplete_reason_id',10,0,true,g_source_file_error_flag);
      l_entity_load_row.incomplete_reason_id_desc := qu4_util.get_string('incomplete_reason_id_desc',50,true,g_source_file_error_flag);
      l_entity_load_row.notes := qu4_util.get_string('notes',200,true,g_source_file_error_flag);
      l_entity_load_row.due_date := qu4_util.get_datetime('due_date',true,g_source_file_error_flag);
      l_entity_load_row.full_name := qu4_util.get_string('full_name',101,true,g_source_file_error_flag);
      l_entity_load_row.task_id_desc := qu4_util.get_string('task_id_desc',200,true,g_source_file_error_flag);
      l_entity_load_row.comments := qu4_util.get_string('comments',100,true,g_source_file_error_flag);
      l_entity_load_row.key_site_plcmnt_is_activated := qu4_util.get_number('key_site_plcmnt_is_activated',10,0,true,g_source_file_error_flag);
      l_entity_load_row.mstm_reg_plcmnt_no_of_register := qu4_util.get_number('mstm_reg_plcmnt_no_of_register',10,0,true,g_source_file_error_flag);
      l_entity_load_row.mstm_reg_plcmnt_no_of_mstm := qu4_util.get_number('mstm_reg_plcmnt_no_of_mstm',10,0,true,g_source_file_error_flag);
      l_entity_load_row.fridge_plcmnt_is_activated := qu4_util.get_number('fridge_plcmnt_is_activated',10,0,true,g_source_file_error_flag);
      l_entity_load_row.fridge_plcmnt_no_of_doors := qu4_util.get_number('fridge_plcmnt_no_of_doors',10,0,true,g_source_file_error_flag);
      l_entity_load_row.fridge_plcmnt_no_of_frdg_units := qu4_util.get_number('fridge_plcmnt_no_of_frdg_units',10,0,true,g_source_file_error_flag);
      l_entity_load_row.fridge_plcmnt_is_sleeved_up := qu4_util.get_number('fridge_plcmnt_is_sleeved_up',10,0,true,g_source_file_error_flag);
      l_entity_load_row.fridge_plcmnt_is_mars_and_coke := qu4_util.get_number('fridge_plcmnt_is_mars_and_coke',10,0,true,g_source_file_error_flag);
      l_entity_load_row.front_back_fronts_in_store := qu4_util.get_number('front_back_fronts_in_store',10,0,true,g_source_file_error_flag);
      l_entity_load_row.front_back_fronts_tied_to_prom := qu4_util.get_number('front_back_fronts_tied_to_prom',10,0,true,g_source_file_error_flag);
      l_entity_load_row.front_back_front_end_type := qu4_util.get_number('front_back_front_end_type',10,0,true,g_source_file_error_flag);
      l_entity_load_row.front_back_backs_in_store := qu4_util.get_number('front_back_backs_in_store',10,0,true,g_source_file_error_flag);
      l_entity_load_row.front_back_backs_tied_to_prom := qu4_util.get_number('front_back_backs_tied_to_prom',10,0,true,g_source_file_error_flag);
      l_entity_load_row.front_back_back_end_type := qu4_util.get_number('front_back_back_end_type',10,0,true,g_source_file_error_flag);
      l_entity_load_row.lead_in_lead_out_is_any := qu4_util.get_number('lead_in_lead_out_is_any',10,0,true,g_source_file_error_flag);
      exception
      when others then
    ...
    -- Insert row
    begin
      insert into ods.qu4_act_hdr_load values l_entity_load_row;
    exception
      when others then
         lics_inbound_utility.add_exception(substr('['||g_package_name||'.process_data_row] Insert Failed [ods.qu4_act_hdr_load] : '||SQLERRM, 1, 4000));
         g_source_file_error_flag := true;
    end;
  ...
  *****************************************************************************/
  ...
  begin
    ...
    update ods.qu4_act_hdr_load
    set q4x_modify_user = user,
      q4x_modify_time = sysdate
    where q4x_batch_id = p_batch_id;

    -- Insert ALL of Load Batch into History
    insert into ods.qu4_act_hdr_hist
    select *
    from ods.qu4_act_hdr_load
    where q4x_batch_id = p_batch_id;

    -- Delete Load Batch
    delete from ods.qu4_act_hdr_load
    where q4x_batch_id = p_batch_id;

  exception
    when others then
      g_abort_processing_flag := true;
      raise_application_error(-20000, substr('['||g_package_name||'.process_batch] Failed [ods.qu4_act_hdr/_load/_hist] : '||SQLERRM, 1, 4000));
...
-- Synonyms
create or replace public synonym qu4_qu4cdw34 for ods_app.qu4_qu4cdw34;

-- Grants
grant execute on ods_app.qu4_qu4cdw34 to lics_app;
