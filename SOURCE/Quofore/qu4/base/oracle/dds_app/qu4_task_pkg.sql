...
create or replace package dds_app.qu4_task_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    System   : qu4
    Owner    : dds_app
    Package  : qu4_task_pkg
    Author   : [Auto-Generate]

    Description
    ------------------------------------------------------------------------------
    [qu4] Quofore - Australia Chocolate
    View Package, Entity [Task] Table [qu4_task][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu4_task_type is table of ods.qu4_task_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu4_task_type pipelined;
  function view_at_start_date(p_date in date) return qu4_task_type pipelined;
  function view_history return qu4_task_type pipelined;

end qu4_task_pkg;
/

create or replace package body dds_app.qu4_task_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu4_task_pkg';
  ...
  *****************************************************************************/
  function view_at_date(p_date in date) return qu4_task_type pipelined is
  ...
  *****************************************************************************/
  function view_at_start_date(p_date in date) return qu4_task_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu4_task_type pipelined is
...
-- Synonyms
create or replace public synonym qu4_task_pkg for dds_app.qu4_task_pkg;

-- Grants
grant execute on dds_app.qu4_task_pkg to qv_user, bo_user;
