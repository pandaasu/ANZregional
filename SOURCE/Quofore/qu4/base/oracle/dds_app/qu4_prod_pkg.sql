...
create or replace package dds_app.qu4_prod_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    System   : qu4
    Owner    : dds_app
    Package  : qu4_prod_pkg
    Author   : [Auto-Generate]

    Description
    ------------------------------------------------------------------------------
    [qu4] Quofore - Australia Chocolate
    View Package, Entity [Product] Table [qu4_prod][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu4_prod_type is table of ods.qu4_prod_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu4_prod_type pipelined;
  function view_history return qu4_prod_type pipelined;

end qu4_prod_pkg;
/

create or replace package body dds_app.qu4_prod_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu4_prod_pkg';
  ...
  *****************************************************************************/
  function view_at_date(p_date in date) return qu4_prod_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu4_prod_type pipelined is
...
-- Synonyms
create or replace public synonym qu4_prod_pkg for dds_app.qu4_prod_pkg;

-- Grants
grant execute on dds_app.qu4_prod_pkg to qv_user, bo_user;
