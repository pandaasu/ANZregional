...
create or replace package dds_app.qu4_pos_pkg as
  /***************************************************************-****************
  ** Package Definition
  ********************************************************************************
    ...
    View Package, Entity [Position] Table [qu4_pos][_load/_hist]
  ...
  *******************************************************************************/
  ...
  -- Public : Type
  type qu4_pos_type is table of ods.qu4_pos_hist%rowtype;

  -- Public : Functions
  function view_at_date(p_date in date) return qu4_pos_type pipelined;
  function view_history return qu4_pos_type pipelined;

end qu4_pos_pkg;
/

create or replace package body dds_app.qu4_pos_pkg as
  ...
  -- Private : Constants
  g_package_name constant varchar2(64 char) := 'qu4_pos_pkg';
  ...
  *****************************************************************************/
  function view_at_date(p_date in date) return qu4_pos_type pipelined is
  ...
  *****************************************************************************/
  function view_history return qu4_pos_type pipelined is
...
-- Synonyms
create or replace public synonym qu4_pos_pkg for dds_app.qu4_pos_pkg;

-- Grants
grant execute on dds_app.qu4_pos_pkg to qv_user, bo_user;
