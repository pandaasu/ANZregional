...
create or replace package body bp_app.bpip_mvmt_load as
   ...
   begin
      ...
      rcd_load_mvmt_data.consumption_qty := replace(lics_inbound_utility.get_number('CONSUMPTION_QTY','999,999,999,990.999'),' ',null);
      rcd_load_mvmt_data.sales_qty := replace(lics_inbound_utility.get_number('SALES_QTY','999,999,999,990.999'),' ',null);
      rcd_load_mvmt_data.production_qty := replace(lics_inbound_utility.get_number('PRODUCTION_QTY','999,999,999,990.999'),' ',null);
