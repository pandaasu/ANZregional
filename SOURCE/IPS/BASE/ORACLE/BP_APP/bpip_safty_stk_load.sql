...
/* Package Header */
/******************/
create or replace package bp_app.bpip_safty_stk_load as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : bpip_safty_stk_load
    Owner   : bp_app

    Description
    -----------
    Integrated Planning Demand Financials - Safety Stock Load 
...
create or replace package body bp_app.bpip_safty_stk_load as
   ...
   begin
      ...
      if var_trn_start = false then
         ...
         rcd_load_bpip_batch.batch_type_code := 'SAFETY_STOCK';
      ...
      rcd_load_safty_stk_data.batch_id := null;
      rcd_load_safty_stk_data.line_no := var_line_count;
      rcd_load_safty_stk_data.company := lics_inbound_utility.get_variable('COMPANY');
      ...
      /* Business segment 01
      /*-*/
      rcd_load_safty_stk_data.batch_id := var_batch_id_01;
      insert into load_safty_stk_data values rcd_load_safty_stk_data;

      /*-*/
      /* Business segment 02
      /*-*/
      rcd_load_safty_stk_data.batch_id := var_batch_id_02;
      insert into load_safty_stk_data values rcd_load_safty_stk_data;
...
/**************************/
create or replace public synonym bpip_safty_stk_load for bp_app.bpip_safty_stk_load;
grant execute on bp_app.bpip_safty_stk_load to lics_app;