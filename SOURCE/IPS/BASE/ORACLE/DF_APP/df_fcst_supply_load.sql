...
/* Package Header */
/******************/
create or replace package df_fcst_supply_load as
...
/* Package Body */
/****************/
create or replace package body df_fcst_supply_load as
...
/**************************/
create or replace public synonym df_fcst_supply_load for df_app.df_fcst_supply_load;
grant execute on df_fcst_supply_load to public;