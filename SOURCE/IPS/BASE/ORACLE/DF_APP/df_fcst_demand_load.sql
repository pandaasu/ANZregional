...
/* Package Header */
/******************/
create or replace package df_fcst_demand_load as
...
/* Package Body */
/****************/
create or replace package body df_fcst_demand_load as
...
/**************************/
create or replace public synonym df_fcst_demand_load for df_app.df_fcst_demand_load;
grant execute on df_fcst_demand_load to public;