...
'// Script  : prc_lst_matl_reload.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2008                                      //
...
sub ProcessReload()
   ...
   '//
   strQuery = "select t01.value, t01.text from table(pr_app.pricelist_material.reload(" & objForm.Fields("QRY_ReportId").Value & ")) t01"
