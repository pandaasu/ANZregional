...
/******************************************************************************/
/**
 Object : standard_hier_view 
 Owner  : ods_app 

 DESCRIPTION 
 -----------
 Operational Data Store - Standard Heirarchy View 
...
/* View creation 
/*-*/ 
create or replace force view ods_app.standard_hier_view as
...
/* Authority 
/*-*/
grant select on ods_app.standard_hier_view to dw_app;

/*-*/
/* Synonym 
/*-*/
create or replace public synonym standard_hier_view for ods_app.standard_hier_view;