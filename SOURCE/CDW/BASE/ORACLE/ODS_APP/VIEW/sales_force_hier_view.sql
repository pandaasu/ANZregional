...
/******************************************************************************/
/**
 Object : sales_force_hier_view 
 Owner  : ods_app 

 DESCRIPTION 
 -----------
 Operational Data Store - Sales Force Heirarchy View 
...
/* View creation 
/*-*/ 
create or replace force view ods_app.sales_force_hier_view as
...
/* Authority 
/*-*/
grant select on ods_app.sales_force_hier_view to dw_app;

/*-*/
/* Synonym 
/*-*/
create or replace public synonym sales_force_hier_view for ods_app.sales_force_hier_view;