...
/******************************************************************************/
/**
 Object : grd_matl_dim_view 
 Owner  : ods_app 

 DESCRIPTION 
 -----------
 Operational Data Store - GRD Material Dimension View 
...
/* View creation 
/*-*/ 
create or replace force view ods_app.grd_matl_dim_view as
select ltrim(t01.matnr, '0') as matl_code,                    -- SAP Material Code 
  ...
  v01.matl_grp_code,                                          -- SAP Material Group Code 
...
from sap_mat_hdr t01,
  ...
  bus_sgmnt_grd v02,                                          -- Business Segment 
  mkt_sgmnt_grd v03,                                          -- Market Segment 
  brand_essnc_grd v04,                                        -- Brand Essence 
  brand_flag_grd v05,                                         -- Brand Flag 
  brand_sub_flag_grd v06,                                     -- Brand Sub Flag 
  supply_sgmnt_grd v07,                                       -- Supply Segment 
  ingred_vrty_grd v08,                                        -- Ingredient Variety 
  funcl_vrty_grd v09,                                         -- Functional Variety 
  multi_pack_qty_grd v10,                                     -- Multi Pack Quantity 
  occsn_grd v11,                                              -- Occasion 
  prdct_ctgry_grd v12,                                        -- Product Category 
  prdct_type_grd v13,                                         -- Product Type 
  prdct_pack_size_grd v14,                                    -- Product Pack Size 
  cnsmr_pack_frmt_grd v15,                                    -- Consumer Pack Format
  cnsmr_pack_type_grd v16,                                    -- Consumer Pack Type 
  prdct_size_grp_grd v17,                                     -- Product Size Group 
  trad_unit_frmt_grd v18,                                     -- Traded Unit Format 
  trad_unit_config_grd v19,                                   -- Traded Unit Config 
  onpack_cnsmr_value_grd v20,                                 -- On-pack Consumer Value 
  onpack_cnsmr_offer_grd v21,                                 -- On-pack Consumer Offer 
  onpack_trade_offer_grd v22,                                 -- On-pack Trade Offer 
  mktg_concept_grd v23,                                       -- Marketing Concept 
  cuisine_grd v24,                                            -- Cuisine 
  disp_strg_cndtn_grd v25,                                    -- Display Storage Condition 
  trade_sector_grd v26,                                       -- Trade Sector 
  uom v27,                                                    -- Weight UOM 
  uom v28,                                                    -- Volume UOM 
  uom v29,                                                    -- Base UOM 
...
/* Authority 
/*-*/
grant select on ods_app.grd_matl_dim_view to dw_app;

/*-*/
/* Synonym 
/*-*/
create or replace public synonym grd_matl_dim_view for ods_app.grd_matl_dim_view;