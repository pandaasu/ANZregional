...
/**
 ...
 DESCRIPTION 
 -----------
 Operational Data Store - Ship To Heirarchy View 
...
/* View creation 
/*-*/ 
create or replace force view ods_app.ship_to_hier_view as
...
/* Authority 
/*-*/
grant select on ods_app.ship_to_hier_view to dw_app;

/*-*/
/* Synonym 
/*-*/
create or replace public synonym ship_to_hier_view for ods_app.ship_to_hier_view;
