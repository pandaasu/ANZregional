...
/* Package Header */
/******************/
create or replace package ods_app.efxcdw29_loader as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : efxcdw29_loader
    Owner   : ods_app

    Description
    -----------
    Operational Data Store - Efex Call Type - EFEX to CDW
...
/* Package Body */
/****************/
create or replace package body ods_app.efxcdw29_loader as
   ...
   rcd_efex_call_type efex_call_type%rowtype;
   ...
   begin
      ...
      lics_inbound_utility.set_definition('HDR','LVA_ID',10);
      lics_inbound_utility.set_definition('HDR','LVA_NAME',50);
   ...
   begin
      ...
      begin
         insert into efex_call_type values rcd_efex_call_type;
      exception
...
/**************************/
create or replace public synonym efxcdw29_loader for ods_app.efxcdw29_loader;
grant execute on ods_app.efxcdw29_loader to lics_app;
