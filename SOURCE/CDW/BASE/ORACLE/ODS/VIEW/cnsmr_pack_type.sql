...
/******************************************************************************/
/**
 Object : cnsmr_pack_type  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Consumer Pack Type View 
...
/* View creation 
/*-*/ 
create or replace force view ods.cnsmr_pack_type as
...
/* Authority
/*-*/
grant select on ods.cnsmr_pack_type to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym cnsmr_pack_type for ods.cnsmr_pack_type;