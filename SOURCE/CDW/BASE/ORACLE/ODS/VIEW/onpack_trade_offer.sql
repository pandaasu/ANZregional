...
/******************************************************************************/
/**
 Object : onpack_trade_offer  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - On-pack Trade Offer View 
...
/* View creation 
/*-*/ 
create or replace force view ods.onpack_trade_offer as
...
/* Authority
/*-*/
grant select on ods.onpack_trade_offer to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym onpack_trade_offer for ods.onpack_trade_offer;