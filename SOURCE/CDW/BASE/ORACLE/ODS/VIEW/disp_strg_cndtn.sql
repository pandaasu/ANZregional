...
/******************************************************************************/
/**
 Object : disp_strg_cndtn  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Display Storage Condition View 
...
/* View creation 
/*-*/ 
create or replace force view ods.disp_strg_cndtn as
...
/* Authority
/*-*/
grant select on ods.disp_strg_cndtn to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym disp_strg_cndtn for ods.disp_strg_cndtn;