...
/******************************************************************************/
/**
 Object : trad_unit_config  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Traded Unit Configuration View 
...
/* View creation 
/*-*/ 
create or replace force view ods.trad_unit_config as
...
/* Authority
/*-*/
grant select on ods.trad_unit_config to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym trad_unit_config for ods.trad_unit_config;