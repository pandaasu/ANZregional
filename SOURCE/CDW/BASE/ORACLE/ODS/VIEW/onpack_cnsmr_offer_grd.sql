...
/******************************************************************************/
/**
 Object : onpack_cnsmr_offer_grd  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - On-pack Consumer Offer View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.onpack_cnsmr_offer_grd as
...
/* Authority
/*-*/
grant select on ods.onpack_cnsmr_offer_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym onpack_cnsmr_offer_grd for ods.onpack_cnsmr_offer_grd;
