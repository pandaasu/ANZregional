...
/******************************************************************************/
/**
 Object : trade_sector_grd  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Trade Sector View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.trade_sector_grd as
...
/* Authority
/*-*/
grant select on ods.trade_sector_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym trade_sector_grd for ods.trade_sector_grd;
