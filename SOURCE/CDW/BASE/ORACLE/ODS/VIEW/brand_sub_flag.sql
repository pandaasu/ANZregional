...
/* View creation 
/*-*/ 
create or replace force view ods.brand_sub_flag as
...
/* Authority
/*-*/
grant select on ods.brand_sub_flag to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym brand_sub_flag for ods.brand_sub_flag;
