...
/******************************************************************************/
/**
 Object : funcl_vrty_grd 
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Functional Variety View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.funcl_vrty_grd as
...
/* Authority
/*-*/
grant select on ods.funcl_vrty_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym funcl_vrty_grd for ods.funcl_vrty_grd;