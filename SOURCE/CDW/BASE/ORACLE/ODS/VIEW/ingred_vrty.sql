...
/* View creation 
/*-*/ 
create or replace force view ods.ingred_vrty as
...
/* Authority
/*-*/
grant select on ods.ingred_vrty to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym ingred_vrty for ods.ingred_vrty;