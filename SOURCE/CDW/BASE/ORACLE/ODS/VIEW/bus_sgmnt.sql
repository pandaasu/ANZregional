...
/* View creation 
/*-*/ 
create or replace force view ods.bus_sgmnt as
...
/* Authority
/*-*/
grant select on ods.bus_sgmnt to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym bus_sgmnt for ods.bus_sgmnt;