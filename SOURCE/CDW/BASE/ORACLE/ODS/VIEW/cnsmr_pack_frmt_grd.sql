...
/******************************************************************************/
/**
 Object : cnsmr_pack_frmt_grd  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Consumer Pack Format View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.cnsmr_pack_frmt_grd as
...
/* Authority
/*-*/
grant select on ods.cnsmr_pack_frmt_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym cnsmr_pack_frmt_grd for ods.cnsmr_pack_frmt_grd;