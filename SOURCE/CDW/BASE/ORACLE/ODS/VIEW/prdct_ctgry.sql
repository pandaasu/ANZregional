...
/* View creation 
/*-*/ 
create or replace force view ods.prdct_ctgry as
...
/* Authority
/*-*/
grant select on ods.prdct_ctgry to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym prdct_ctgry for ods.prdct_ctgry;