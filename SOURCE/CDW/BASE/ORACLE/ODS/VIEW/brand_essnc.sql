...
/* View creation 
/*-*/ 
create or replace force view ods.brand_essnc as
...
/* Authority
/*-*/
grant select on ods.brand_essnc to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym brand_essnc for ods.brand_essnc;