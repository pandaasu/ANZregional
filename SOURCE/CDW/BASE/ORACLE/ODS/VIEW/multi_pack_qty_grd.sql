...
/******************************************************************************/
/**
 Object : multi_pack_qty_grd  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Multi-pack Quantity View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.multi_pack_qty_grd as
...
/* Authority
/*-*/
grant select on ods.multi_pack_qty_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym multi_pack_qty_grd for ods.multi_pack_qty_grd;