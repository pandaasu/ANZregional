...
/******************************************************************************/
/**
 Object : trad_unit_frmt  
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Traded Unit Format View 
...
/* View creation 
/*-*/ 
create or replace force view ods.trad_unit_frmt as
...
/* Authority
/*-*/
grant select on ods.trad_unit_frmt to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym trad_unit_frmt for ods.trad_unit_frmt;
