...
/******************************************************************************/
/**
 Object : onpack_cnsmr_value_grd   
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - On-pack Consumer Value View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.onpack_cnsmr_value_grd as
...
/* Authority
/*-*/
grant select on ods.onpack_cnsmr_value_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym onpack_cnsmr_value_grd for ods.onpack_cnsmr_value_grd;