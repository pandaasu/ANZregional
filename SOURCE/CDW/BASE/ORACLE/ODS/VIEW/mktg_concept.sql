...
/**
 ...
 DESCRIPTION 
 -----------
 Operational Data Store - Marketing Concept View 
...
/* View creation 
/*-*/ 
create or replace force view ods.mktg_concept as
...
/* Authority
/*-*/
grant select on ods.mktg_concept to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym mktg_concept for ods.mktg_concept;
