...
/******************************************************************************/
/**
 Object : prdct_pack_size_grd   
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Product Pack Size View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.prdct_pack_size_grd as
...
/* Authority
/*-*/
grant select on ods.prdct_pack_size_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym prdct_pack_size_grd for ods.prdct_pack_size_grd;