...
/******************************************************************************/
/**
 Object : brand_flag_grd   
 Owner  : ods 

 DESCRIPTION 
 -----------
 Operational Data Store - Brand Flag View (GRD) 
...
/* View creation 
/*-*/ 
create or replace force view ods.brand_flag_grd as
...
/* Authority
/*-*/
grant select on ods.brand_flag_grd to ods_app with grant option;

/*-*/
/* Synonym
/*-*/
create or replace public synonym brand_flag_grd for ods.brand_flag_grd;