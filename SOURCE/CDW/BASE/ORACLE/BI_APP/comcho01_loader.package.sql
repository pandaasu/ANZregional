create or replace package comcho01_loader as
  /*****************************************************************************
  ** PACKAGE DEFINITION
  ******************************************************************************
  
    Schema    : bi_app
    Package   : comcho01_loader
    Author    : Trevor Keon         
  
    Description
    ----------------------------------------------------------------------------
    [comcho01] Commercial - Chocolate - Supplier Settings
...
create or replace package body comcho01_loader as 
  ...
  -- Package constants
  pc_bus_sgmnt_value constant bi.com_supplier_settings.bus_sgmnt%type := '01';
...
grant execute on comcho01_loader to lics_app, fflu_app;
