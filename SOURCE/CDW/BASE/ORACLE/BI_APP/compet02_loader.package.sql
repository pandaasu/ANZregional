create or replace package compet02_loader as
  /*****************************************************************************
  ** PACKAGE DEFINITION
  ******************************************************************************
  
    Schema    : bi_app
    Package   : compet02_loader
    Author    : Trevor Keon         
  
    Description
    ----------------------------------------------------------------------------
    [compet02] Commercial - Petcare - DIFOT Overwrite
...
create or replace package body compet02_loader as 
  ...
  -- Package constants
  pc_bus_sgmnt_value constant bi.com_supplier_difot_update.bus_sgmnt%type := '05'; 
  ...
  begin
    if fflu_data.parse_data(p_row) = true then
      ...
      begin
        ...
        -- Add default value for Petcare business segment
...
grant execute on compet02_loader to lics_app, fflu_app;
