create or replace package compet01_loader as
  /*****************************************************************************
  ** PACKAGE DEFINITION
  ******************************************************************************
  
    Schema    : bi_app
    Package   : compet01_loader
    Author    : Trevor Keon         
  
    Description
    ----------------------------------------------------------------------------
    [compet01] Commercial - Petcare - Supplier Settings
...
create or replace package body compet01_loader as 
  ...
  -- Package constants
  pc_bus_sgmnt_value constant bi.com_supplier_settings.bus_sgmnt%type := '05';
...
grant execute on compet01_loader to lics_app, fflu_app;
