...
create or replace package dds_partition as
   ...
   /**
    ...
    2009/09   Steve Gregan   Added forecast partition logic
   ...
   *******************************************************************************/
   ...
   procedure check_create_forecast(par_table varchar2, par_partition varchar2, par_prefix varchar2);
   procedure truncate_forecast(par_table varchar2, par_partition varchar2, par_prefix varchar2);
...
create or replace package body dds_partition as
   ...
   /*****************************************************************************/
   /* This procedure performs the check/create forecast table partition routine */
   /*****************************************************************************/
   procedure check_create_forecast(par_table varchar2, par_partition varchar2) is
   ...
   /* End routine */
   /*-------------*/
   end check_create_forecast;

   /*************************************************************************/
   /* This procedure performs the truncate forecast table partition routine */
   /*************************************************************************/
   procedure truncate_forecast(par_table varchar2, par_partition number) is
