create or replace package qv_app.qv_csvqvs00_loader as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : qv_csvqvs00_loader
    Owner   : qv_app

    Description
    -----------
    CSV File to Qlikview - CSVQVS - Template Example
...
end qv_csvqvs00_loader;

create or replace package body qv_app.qv_csvqvs00_loader as
