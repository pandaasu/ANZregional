...
/* Package Header */
/******************/
create or replace package qv_app.template_source_loader as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : template_source_loader
    Owner   : qv_app
...
end template_source_loader;

/****************/
/* Package Body */
/****************/
create or replace package body qv_app.template_source_loader as
   ...
   begin
      ...
      lics_inbound_utility.set_csv_definition('MATERIAL',2);
      lics_inbound_utility.set_csv_definition('SRC_MOE',3);
...
/**************************/
create or replace public synonym template_source_loader for qv_app.template_source_loader;
grant execute on template_source_loader to lics_app;
