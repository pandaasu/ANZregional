...
/* Package Header */
/******************/
create or replace package qv_app.qvi_fac_maintenance as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : qvi_fac_maintenance
    Owner   : qv_app

    Description
    -----------
    QlikView Interfacing - Fact Maintenance

    This package contain the fact maintenance functions and procedures.
...
/* Package Body */
/****************/
create or replace package body qv_app.qvi_fac_maintenance as
   ...
   exception
      ...
      when others then
         ...
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - SELECT_LIST - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - RETRIEVE_DATA - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - UPDATE_DATA - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - DELETE_DATA - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - SELECT_PART_LIST - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - RETRIEVE_PART_DATA - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - UPDATE_PART_DATA - ' || substr(SQLERRM, 1, 1536));
   ...
   exception
      ...
      when others then
         ...
         /* Raise an exception to the calling application
         /*-*/
         qvi_gen_function.add_mesg_data('FATAL ERROR - QVI_FAC_MAINTENANCE - DELETE_PART_DATA - ' || substr(SQLERRM, 1, 1536));
...
/**************************/
create or replace public synonym qvi_fac_maintenance for qv_app.qvi_fac_maintenance;
grant execute on qv_app.qvi_fac_maintenance to public;
