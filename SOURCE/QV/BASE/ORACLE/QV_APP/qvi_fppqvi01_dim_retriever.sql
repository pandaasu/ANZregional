...
/* Package Header */
/******************/
create or replace package qv_app.qvi_fppqvi01_dim_retriever as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : qvi_fppqvi01_dim_retriever
    Owner   : qv_app
   ...
   *******************************************************************************/
   ...
   /* Public declarations
   /*-*/
   function get_table(par_dim_code in varchar2) return qvi_fppqvi01_dim_table pipelined;

end qvi_fppqvi01_dim_retriever;
/

/****************/
/* Package Body */
/****************/
create or replace package body qv_app.qvi_fppqvi01_dim_retriever as
   ...
   /******************************************************/
   function get_table(par_dim_code in varchar2) return qvi_fppqvi01_dim_table pipelined is
