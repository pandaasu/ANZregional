create or replace function qvi_app.qvi_to_xml(par_text in varchar2) return varchar2 is
...
/***************************/
create or replace public synonym qvi_to_xml for qvi_app.qvi_to_xml;
