...
'// Script  : qvi_das_config_part_retrieve.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration part retrieve functionality          //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the dashboard part definition
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_maintenance.retrieve_part_data)"
