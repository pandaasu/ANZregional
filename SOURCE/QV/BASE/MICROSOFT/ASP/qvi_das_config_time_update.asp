...
'// Script  : qvi_das_config_time_update.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration time update functionality            //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the dashboard time update
   '//
   call objProcedure.Execute("qv_app.qvi_das_maintenance.update_time_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
