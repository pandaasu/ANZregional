...
'// Script  : qvi_das_enquiry_time.asp                           //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard enquiry time  //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the dashboard time selection
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_enquiry.select_time_list)"
