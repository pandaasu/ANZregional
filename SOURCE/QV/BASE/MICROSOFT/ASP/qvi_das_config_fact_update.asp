...
'// Script  : qvi_das_config_fact_update.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration fact update functionality            //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the dashboard fact update
   '//
   call objProcedure.Execute("qv_app.qvi_das_maintenance.update_fact_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
