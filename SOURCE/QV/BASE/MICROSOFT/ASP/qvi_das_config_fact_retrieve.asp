...
'// Script  : qvi_das_config_fact_retrieve.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration fact retrieve functionality          //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the dashboard fact definition
   '//
   strStatement = "select xml_text from table(qv_app.qvi_das_maintenance.retrieve_fact_data)"
