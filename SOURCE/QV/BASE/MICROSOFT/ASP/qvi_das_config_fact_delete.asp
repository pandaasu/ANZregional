...
'// Script  : qvi_das_config_fact_delete.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : April 2012                                         //
'// Text    : This script implements the dashboard definition    //
'//           configuration fact delete functionality            //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the dashboard fact delete
   '//
   call objProcedure.Execute("qv_app.qvi_das_maintenance.delete_fact_data")
   if strReturn <> "*OK" then
      exit sub
   end if
