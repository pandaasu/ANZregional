...
'// Script  : psa_psc_config_update.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           maintenance update functionality                   //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule update
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.update_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
