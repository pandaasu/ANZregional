...
'// Script  : psa_psc_tonn_report.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           tonnage report functionality                       //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the producton schedule tonnage
   '//
   strStatement = "select xml_text from table(psa_app.psa_psc_function.retrieve_tonnage)"
