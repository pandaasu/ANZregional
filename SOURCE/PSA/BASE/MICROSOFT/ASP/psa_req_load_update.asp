...
'// Script  : psa_req_load_update.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production requirement  //
'//           loading update functionality                       //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production requirement update
   '//
   call objProcedure.Execute("psa_app.psa_req_function.update_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
