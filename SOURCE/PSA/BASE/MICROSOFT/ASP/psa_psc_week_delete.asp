...
'// Script  : psa_psc_week_delete.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           week delete functionality                          //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule week delete
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.delete_week")
   if strReturn <> "*OK" then
      exit sub
   end if
