...
'// Script  : psa_psc_actv_attach.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           activity attach functionality                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule activity attach
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.attach_activity('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
