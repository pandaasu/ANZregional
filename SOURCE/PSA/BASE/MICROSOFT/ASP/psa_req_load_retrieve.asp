...
'// Script  : psa_req_load_retrieve.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production requirement  //
'//           loading retrieve functionality                     //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the production requirement definition
   '//
   strStatement = "select xml_text from table(psa_app.psa_req_function.retrieve_data)"
