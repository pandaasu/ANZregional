...
'// Script  : psa_mat_config_master.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the material                //
'//           configuration master functionality                 //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the material master
   '//
   call objProcedure.Execute("psa_app.psa_mat_function.update_master('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
