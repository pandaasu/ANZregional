...
'// Script  : psa_psc_week_retrieve.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           week retrieve functionality                        //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the producton schedule week
   '//
   strStatement = "select xml_text from table(psa_app.psa_psc_function.retrieve_week)"
