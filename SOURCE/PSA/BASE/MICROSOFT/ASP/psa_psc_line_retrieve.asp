...
'// Script  : psa_psc_line_retrieve.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           line retrieve functionality                        //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the producton schedule line
   '//
   strStatement = "select xml_text from table(psa_app.psa_psc_function.retrieve_line)"
