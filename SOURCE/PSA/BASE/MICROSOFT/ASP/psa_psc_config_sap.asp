...
'// Script  : psa_psc_config_sap.asp                             //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           maintenance SAP functionality                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule SAP interface
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.sap_data")
   if strReturn <> "*OK" then
      exit sub
   end if
