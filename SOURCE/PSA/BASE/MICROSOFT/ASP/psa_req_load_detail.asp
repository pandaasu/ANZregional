...
'// Script  : psa_req_load_detail.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production requirement  //
'//           loading detail functionality                       //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the production requirement detail
   '//
   strStatement = "select xml_text from table(psa_app.psa_req_function.detail_data)"
