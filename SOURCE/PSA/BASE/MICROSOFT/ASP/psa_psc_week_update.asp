...
'// Script  : psa_psc_week_update.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           week update functionality                          //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule week update
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.update_week('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
