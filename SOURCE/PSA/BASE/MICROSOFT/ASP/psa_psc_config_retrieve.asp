...
'// Script  : psa_psc_config_retrieve.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           maintenance retrieve functionality                 //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the producton schedule definition
   '//
   strStatement = "select xml_text from table(psa_app.psa_psc_function.retrieve_data)"
