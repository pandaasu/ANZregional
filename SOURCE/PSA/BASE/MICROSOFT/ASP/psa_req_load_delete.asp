...
'// Script  : psa_req_load_delete.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production requirement  //
'//           loading delete functionality                       //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production requirement delete
   '//
   call objProcedure.Execute("psa_app.psa_req_function.delete_data")
   if strReturn <> "*OK" then
      exit sub
   end if
