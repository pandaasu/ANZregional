...
'// Script  : psa_psc_config_select.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           maintenance select functionality                   //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the production schedule selection
   '//
   strStatement = "select xml_text from table(psa_app.psa_psc_function.select_list)"
