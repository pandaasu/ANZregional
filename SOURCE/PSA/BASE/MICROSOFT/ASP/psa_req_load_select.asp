...
'// Script  : psa_req_load_select.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production requirement  //
'//           loading select functionality                       //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the production requirement selection
   '//
   strStatement = "select xml_text from table(psa_app.psa_req_function.select_list)"
