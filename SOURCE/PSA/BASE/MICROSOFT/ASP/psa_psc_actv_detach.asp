...
'// Script  : psa_psc_actv_detach.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           activity detach functionality                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule activity detach
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.detach_activity('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
