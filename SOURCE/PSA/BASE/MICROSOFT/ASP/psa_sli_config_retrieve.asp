...
'// Script  : psa_sli_config_retrieve.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the SAP line                //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strReturn = GetSecurityCheck("PSA_SLI_CONFIG")
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the SAP line definition
   '//
   strStatement = "select xml_text from table(psa_app.psa_sli_function.retrieve_data)"
