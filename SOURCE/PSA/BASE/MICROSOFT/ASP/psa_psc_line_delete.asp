...
'// Script  : psa_psc_line_delete.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           line delete functionality                          //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the production schedule line delete
   '//
   call objProcedure.Execute("psa_app.psa_psc_function.delete_line('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
