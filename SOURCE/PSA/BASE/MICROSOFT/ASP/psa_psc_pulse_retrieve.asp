...
'// Script  : psa_psc_pulse_retrieve.asp                         //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
'// Text    : This script implements the production schedule     //
'//           pulse retrieve functionality                       //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the producton schedule pulse
   '//
   strStatement = "select xml_text from table(psa_app.psa_psc_function.retrieve_pulse)"
