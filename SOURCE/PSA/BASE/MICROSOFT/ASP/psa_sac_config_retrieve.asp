...
'// Script  : psa_sac_config_retrieve.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : December 2009                                      //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the schedule activity definition
   '//
   strStatement = "select xml_text from table(psa_app.psa_sac_function.retrieve_data)"
