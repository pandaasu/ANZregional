...
{
    public class RetrieveProcessOrderViewModel
    {
        public RetrieveProcessOrderViewModel()
        {
    ...
    //public class RetrieveMaterialBatchListViewModel
    //{
    //    public RetrieveMaterialBatchListViewModel()
    //    {
