...
sub RetrieveType(strGroup)
   ...
   strQuery = strQuery & " from vds_val_typ t01"
   if strGroup <> "" then
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " from vds_val_fil t01"
...
sub ProcessInsertAccept()
   ...
   '// Insert the filter
   '//
   strStatement = "vds_val_configuration.insert_filter"
...
sub ProcessUpdateLoad()
   ...
   '// Retrieve the filter
   '//
   strStatement = "vds_val_configuration.retrieve_filter"
   strReturn = objFunction.Execute(strStatement)
   if strReturn <> "*OK" then
      strMode = "FATAL"
      exit sub
...
sub ProcessUpdateAccept()
   ...
   '// Update the filter
   '//
   strStatement = "vds_val_configuration.update_filter"
   strReturn = objFunction.Execute(strStatement)
   if strReturn <> "*OK" then
      strMode = "UPDATE"
      strError = FormatError(strReturn)
...
sub ProcessDeleteAccept()
   ...
   '// Update the filter
   '//
   strStatement = "vds_val_configuration.delete_filter"
   strReturn = objFunction.Execute(strStatement)
   if strReturn <> "*OK" then
      strMode = "DELETE"
      strError = FormatError(strReturn)
...
sub ProcessDetailAccept()
   ...
   '// Update the filter
   '//
   strStatement = "vds_val_configuration.load_filter"
   strReturn = objFunction.Execute(strStatement)
   if strReturn <> "*OK" then
      strMode = "DETAIL"
      strError = FormatError(strReturn)
