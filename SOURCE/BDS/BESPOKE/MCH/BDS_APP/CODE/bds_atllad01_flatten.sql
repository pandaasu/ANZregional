...
create or replace package body bds_atllad01_flatten AS
   ...
   /* Constants
   /*-*/
   con_date_err CONSTANT varchar2(32) := '*DATE';
   ...
   exception
      ...
      when user_exception then
         /*-*/
         /* Return to the calling application without errors
         /*-*/  
         rollback; 
  ...
  procedure send_error(par_err_type in varchar2, par_var_name in varchar2, par_var_ch in varchar2, par_var_value in varchar2) is
    ...
    /* Local definitions
    /*-*/
    var_email_group varchar2(500);
    var_email_msg varchar2(4000);

    /*-*/
    /* Local constants
    /*-*/
    con_function constant varchar2(128) := 'BDS ATLLAD01 Flatten';
    con_ema_group constant varchar2(32) := 'BDS_EMAIL_GROUP';
    con_ema_code constant varchar2(32) := 'BDS_ATLLAD01_FLATTEN';       
