...
/**
 System  : BDS
 Table   : BDS_MATERIAL_PKG_INSTR_SYSDATE
 Owner   : BDS
 Author  : Linden Glen

 Description
 -----------
 Business Data Store - Material Packaging Instruction View for SYSDATE
...
create or replace view bds_material_pkg_instr_sysdate as  
   ...
   where t01.pkg_instr_table_usage = 'P' 
     ...
     and t01.pkg_instr_start_date <= trunc(sysdate)
     and t01.pkg_instr_end_date >= trunc(sysdate)
...
/* Synonym
/**/
create or replace public synonym bds_material_pkg_instr_sysdate for bds.bds_material_pkg_instr_sysdate;
