...
/**
 System  : BDS
 Table   : BDS_MATERIAL_PLANT_MCH
 Owner   : BDS
 Author  : Linden Glen

 Description
 -----------
 Business Data Store - Material/Plant MCH (MATMAS)

   *NOTE : This is a custom table specific for the needs of the MCH Plant/Factory systems
 ...
 2007/05   Steve Gregan   Changed for China
...
/* Table creation
/**/
create table bds_material_plant_mch
   (sap_material_code                      varchar2(18 char)     not null, 
    ...
    sales_text_135_en                      varchar2(2000 char)   null,
    sales_text_234_en                      varchar2(2000 char)   null,
    sales_text_135_zh                      varchar2(2000 char)   null,
    sales_text_234_zh                      varchar2(2000 char)   null,
...
/**/
alter table bds_material_plant_mch
   add constraint bds_material_plant_mch_pk primary key (sap_material_code, plant_code);
...
/* Comments
/**/
comment on table bds_material_plant_mch is 'Business Data Store - Material/Plant for MCH (MATMAS)';
comment on column bds_material_plant_mch.sap_material_code is 'Material Number - bds_material_hdr.sap_material_code';
comment on column bds_material_plant_mch.plant_code is 'Plant Code - bds_material_plant.plant_code';


/**/
/* Synonym
/**/
create or replace public synonym bds_material_plant_mch for bds.bds_material_plant_mch;


/**/
/* Authority
/**/
grant select,update,delete,insert on bds_material_plant_mch to lics_app;
grant select,update,delete,insert on bds_material_plant_mch to bds_app;
grant select,update,delete,insert on bds_material_plant_mch to lads_app;
grant select on bds_material_plant_mch to lads with grant option;
grant select on bds_material_plant_mch to ics_app;
grant select on bds_material_plant_mch to vds_app;
grant select on bds_material_plant_mch to site_app;
grant select on bds_material_plant_mch to ics_reader;
