DROP PACKAGE BDS_APP.BDS_ATLLAD04_FLATTEN;

CREATE OR REPLACE PACKAGE BDS_APP.bds_atllad04_flatten as
   ...
   /**
    ...
    2010/10   Ben Halicki    Added ERSA and ZROH material types to extract
...
DROP PUBLIC SYNONYM BDS_ATLLAD04_FLATTEN;

CREATE PUBLIC SYNONYM BDS_ATLLAD04_FLATTEN FOR BDS_APP.BDS_ATLLAD04_FLATTEN;


GRANT EXECUTE ON BDS_APP.BDS_ATLLAD04_FLATTEN TO LADS_APP;

GRANT EXECUTE ON BDS_APP.BDS_ATLLAD04_FLATTEN TO LICS_APP;


DROP PACKAGE BODY BDS_APP.BDS_ATLLAD04_FLATTEN;

CREATE OR REPLACE PACKAGE BODY BDS_APP.bds_atllad04_flatten as
   ...
   procedure bds_flatten(par_matnr in varchar2) is
      ...
      cursor csr_lads_material_plant_mfanz is
         ...
         where t01.sap_material_code = t02.sap_material_code
           ...
           and t01.material_type IN ('ROH', 'VERP', 'NLAG', 'PIPE', 'FERT', 'ERSA', 'ZROH') -- all interested materials
