...
create or replace type bds_bom_hierarchy_object as object
   (hierarchy_rownum                  number,
...
create or replace type bds_bom_hierarchy as table of bds_bom_hierarchy_object;
/
