...
sub ProcessCreate()
  ...
  strStatement = "hermes_post.create_claim('" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "','" & strUser & "','" & objSecurity.FixString(objForm.Fields().Item("DTA_UserSec")) & "')"
...
sub ProcessSend()
  ...
  strStatement = "hermes_post.send_claim('" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "','" & strUser & "','" & objSecurity.FixString(objForm.Fields().Item("DTA_UserSec")) & "')"
