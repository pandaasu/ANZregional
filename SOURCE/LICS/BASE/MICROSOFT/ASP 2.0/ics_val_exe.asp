...
sub ProcessRequest
   ...
   if strMode = "VALIDATE" then
      ...
      '//
      strStatement = "lads_validation.execute_single("
      strStatement = strStatement & "'" & objForm.Fields().Item("DTA_Class") & "',"
      strStatement = strStatement & "'" & objForm.Fields().Item("DTA_Code") & "')"
      ...
      strQuery = strQuery & " from sap_val_mes t01"
      strQuery = strQuery & " where t01.vam_execution = '*SINGLE'"
      strQuery = strQuery & " and t01.vam_code = '" & objForm.Fields().Item("DTA_Code") & "'"
      strQuery = strQuery & " and t01.vam_class = '" & objForm.Fields().Item("DTA_Class") & "'"
