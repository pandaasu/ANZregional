...
sub ProcessDisplay()
   ...
   strQuery = strQuery & " t01.tpc_com_code, "
	...
	strQuery = strQuery & " WHERE t01.tpc_com_code = '" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "' "
...
sub ProcessClose()
   ...
   objFunction.Security(objSecurity)
	...
	strStatement = "hermes_com_info.close_curr_prd('" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "') "	
