...
sub ProcessSelect()
   ...
   strQuery = strQuery & " and t01.tpa_com_code = '" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "'"
...
'	  strStatement = strStatement & "hehe"
      strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "',"
      strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaSapDocType" & i)) & "',"
      strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaSapDocNo" & i)) & "',"
      strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaSapDocLn" & i)) & "',"
      strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaTpId" & i)) & "'"
