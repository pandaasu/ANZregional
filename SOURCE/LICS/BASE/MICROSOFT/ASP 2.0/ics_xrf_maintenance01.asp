...
'// Script  : ics_xrf_maintenance01.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : February 2004                                      //
'// Text    : This script implements the cross reference         //
'//           maintenance functionality (MFA_VENDOR)             //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_xrf_maintenance01.asp"
   ...
   '//
   strReturn = GetSecurityCheck("XRF_MFANZ_VENDOR")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.xrf_code = 'MFA_VENDOR'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_xrf_maintenance01_select.inc"-->
<%end sub
...
'//////////////////////////
sub PaintInsert()%>
<!--#include file="ics_xrf_maintenance01_insert.inc"-->
<%end sub
...
'//////////////////////////
sub PaintUpdate()%>
<!--#include file="ics_xrf_maintenance01_update.inc"-->
<%end sub
...
'//////////////////////////
sub PaintDelete()%>
<!--#include file="ics_xrf_maintenance01_delete.inc"-->
<%end sub%>
