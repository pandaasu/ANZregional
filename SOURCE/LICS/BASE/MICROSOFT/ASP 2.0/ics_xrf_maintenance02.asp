...
'// Script  : ics_xrf_maintenance02.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : February 2004                                      //
'// Text    : This script implements the cross reference         //
'//           maintenance functionality (MFA_CUSTOMER)           //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_xrf_maintenance02.asp"
   ...
   '//
   strReturn = GetSecurityCheck("XRF_MFANZ_CUSTOMER")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.xrf_code = 'MFA_CUSTOMER'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_xrf_maintenance02_select.inc"-->
<%end sub
...
'//////////////////////////
sub PaintInsert()%>
<!--#include file="ics_xrf_maintenance02_insert.inc"-->
<%end sub
...
'//////////////////////////
sub PaintUpdate()%>
<!--#include file="ics_xrf_maintenance02_update.inc"-->
<%end sub
...
'//////////////////////////
sub PaintDelete()%>
<!--#include file="ics_xrf_maintenance02_delete.inc"-->
<%end sub%>
