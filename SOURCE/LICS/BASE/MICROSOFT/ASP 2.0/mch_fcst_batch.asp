...
sub ProcessExecute()
   ...
   '//
   strStatement = objSecurity.FixString(objForm.Fields().Item("DTA_ExtractProcedure"))
   strStatement = strStatement & ".export('" & objSecurity.FixString(objForm.Fields().Item("DTA_ExtractFormat")) & "')"
