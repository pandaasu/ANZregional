...
sub ProcessSubmit()
   ...
   strStatement = strStatement & "''" & objSecurity.FixString(objForm.Fields().Item("SLT_User")) & "'',"
   strStatement = strStatement & "''" & objSecurity.FixString(objForm.Fields().Item("SLT_password")) & "'',"
