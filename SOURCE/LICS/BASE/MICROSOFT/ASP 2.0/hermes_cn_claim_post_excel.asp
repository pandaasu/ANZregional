...
sub ProcessRequest
   ...
   strQuery = strQuery & " and t01.tp_com_code = '" & objForm.Fields().Item("DTA_TpaComCode") & "'"
   ...
   strQuery = strQuery & " and t01.tp_user_sec = '" & objForm.Fields().Item("DTA_UserSec") & "'"
   ...
   Response.AddHeader "content-disposition", "attachment; filename=" & objForm.Fields().Item("DTA_UserSec") & ".xls"
