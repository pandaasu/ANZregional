...
sub ProcessCreate()
  ...
  strStatement = "hermes_post.create_accrual('" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "','" & strUser & "')"
...
sub ProcessSend()
  ...
  strStatement = "hermes_post.send_accrual('" & objSecurity.FixString(objForm.Fields().Item("DTA_TpaComCode")) & "','" & strUser & "')"
