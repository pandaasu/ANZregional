...
<body class="clsTable01" scroll="no">
   ...
   <iframe style="display:none;visibility:hidden" scrolling=no frameborder=no src="<%=strBase%>hermes_cn_claim_excel.asp?DTA_TpaComCode=<%=objForm.Fields().Item("DTA_TpaComCode")%>"></iframe>
</body>
</html>
<%end sub%>
