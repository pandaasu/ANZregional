...
sub ProcessSubmit()
   ...
   '//
   strStatement = "lics_trigger_submitter.execute('LADS Validation','lads_validation.execute(''" & objSecurity.FixString(objForm.Fields().Item("DTA_GROUP")) & "'')','LADS_VALIDATION')"
