...
<body class="clsBody01" scroll="auto"><%if clng(objSelection.ListCount("LIST")) <> 0 then%>
   <table class="clsGrid01" align=left valign=top cellpadding=0 cellspacing=0 cols=1>
      <%for i = clng(objSelection.ListLower("LIST")) to clng(objSelection.ListUpper("LIST"))%>
         <tr"><td class="clsLabelBN" align=left nowrap><nobr><%for j = 1 to clng(objSelection.ListValue01("LIST",i)) - 1%>
