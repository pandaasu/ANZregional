...
sub ProcessForm()
   ...
   '//
   if objForm.Fields().Item("Mode") = "STOP" then
   ...
   if objForm.Fields().Item("Mode") = "START" then
   ...
   if objForm.Fields().Item("Mode") = "SUSPEND" then
   ...
   if objForm.Fields().Item("Mode") = "RELEASE" then
