...
sub ProcessInsertLoad()
   ...
   '// Retrieve the types
   '//
   call RetrieveType(objForm.Fields().Item("DTA_VafGroup"))
...
sub ProcessInsertAccept()
   ...
   call objProcedure.Execute("lics_form.set_value('VAF_FILTER','" & objSecurity.FixString(objForm.Fields().Item("DTA_VafFilter")) & "')")
   call objProcedure.Execute("lics_form.set_value('VAF_DESCRIPTION','" & objSecurity.FixString(objForm.Fields().Item("DTA_VafDescription")) & "')")
   call objProcedure.Execute("lics_form.set_value('VAF_GROUP','" & objSecurity.FixString(objForm.Fields().Item("DTA_VafGroup")) & "')")
   call objProcedure.Execute("lics_form.set_value('VAF_TYPE','" & objSecurity.FixString(objForm.Fields().Item("DTA_VafType")) & "')")
...
sub ProcessDetailAccept()
   ...
   for i = 1 to lngCount
      call objProcedure.Execute("lics_form.set_value('VFD_CODE','" & objSecurity.FixString(objForm.Fields().Item("FileLine" & i)) & "')")
   next
