...
sub ProcessInsertAccept()
   ...
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntInterface")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntDescription")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntType")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntGroup")) & "',"
   strStatement = strStatement & objForm.Fields().Item("DTA_IntPriority") & ","
   strStatement = strStatement & objForm.Fields().Item("DTA_IntHdrHistory") & ","
   strStatement = strStatement & objForm.Fields().Item("DTA_IntDtaHistory") & ","
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntFilPath")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntFilPrefix")) & "',"
   strStatement = strStatement & objForm.Fields().Item("DTA_IntFilSequence") & ","
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntFilExtension")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntOprAlert")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntEmaGroup")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntSearch")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntProcedure")) & "',"
   strStatement = strStatement & "'" & objForm.Fields().Item("DTA_IntStatus") & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntUsrInvocation")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntUsrValidation")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().Item("DTA_IntUsrMessage")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().item("DTA_IntLodType")) & "',"
   strStatement = strStatement & "'" & objSecurity.FixString(objForm.Fields().item("DTA_IntLodGroup")) & "'"
...
sub ProcessUpdateLoad()
   ...
   strQuery = strQuery & " from lics_interface t01"
   strQuery = strQuery & " where t01.int_interface = '" & objForm.Fields().Item("DTA_IntInterface") & "'"
   strReturn = objSelection.Execute("LIST", strQuery, lngSize)
   if strReturn <> "*OK" then
      strMode = "SELECT"
      strReturn = FormatError(strReturn)
