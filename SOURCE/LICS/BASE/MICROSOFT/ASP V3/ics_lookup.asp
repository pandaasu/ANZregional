...
sub ProcessGrouping()
   ...
   if objForm.Fields().Item("QRY_Grouping") = "" then
      ...
      strQuery = strQuery & " and t01.gri_group = '" & objForm.Fields().Item("QRY_Grouping") & "'"
   ...
   if strReturn = "*OK" then
      ...
      Response.AddHeader "Cache-Control", "no-cache"
      Response.Write(strReturn)
      for intIndex = 0 to clng(objSelection.ListCount("INTERFACE")) - 1
...
sub ProcessReference()
   ...
   strQuery = strQuery & " where t01.inr_interface = '" & objForm.Fields().Item("QRY_Interface") & "'"
   ...
   if strReturn = "*OK" then
      ...
      Response.AddHeader "Cache-Control", "no-cache"
      Response.Write(strReturn)
      for intIndex = 0 to clng(objSelection.ListCount("REFERENCE")) - 1
