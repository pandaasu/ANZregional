...
sub ProcessRequest()
   ...
   '//
   strStatement = "select xml_text from table(ps_app.psa_schedule_report.select_data)"
   ...
   '//
   strStatement = "select xml_text from table(ps_app.psa_gen_function.get_mesg_data)"
