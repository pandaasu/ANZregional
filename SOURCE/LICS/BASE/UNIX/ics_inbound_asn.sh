...
process_inbound $ASN 0      # Function: Get and process the file in the queue
...
#                                   beginning of the script to ensure no tight 
#                                   loop. Changed triggerQueue so if trigger 
...
# 2.1     10-MAR-2005 Linden Glen   Fixed error output from 2<&1 to 2>&1
