#!/bin/ksh
# ---------------------------------------------------------------------------
# SCRIPT  : ics_outbound_mqif_pdb.sh
...
setup_config()
{
    ...
    export MQSERVER='WODV01.QMGR.MQIF/TCP/wodv01.wod.ap.mars(1414)'
...
process_outbound "${Q_FILE}" $MQIF_LITE  # Function: Handle file processing
...
# 3.3	  15-DEC-2011 B. Halicki    Added options for calling MQ executable directly for ANZ Plant Databases
# ---------------------------------------------------------------------------
