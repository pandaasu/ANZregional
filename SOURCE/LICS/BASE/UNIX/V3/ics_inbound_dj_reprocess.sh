...
. ${SCRIPT_PATH}/ics_utils_messaging_new.sh
...
{
    if [[ -z $Q_FILE ]] ; then
        error_exit "ERROR: [check_params] File Parameter not specified"
...
Q_FILE=$1               # Variable: File to process
...
reprocess_inbound_dj        # Function: Get file from Queue
