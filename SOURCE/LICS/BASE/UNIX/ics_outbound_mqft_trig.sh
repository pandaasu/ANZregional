#!/bin/sh
# ---------------------------------------------------------------------------
# SCRIPT  : ics_outbound_mqft_trig.sh
# AUTHOR  : Linden Glen
# DATE    : 17-MAY-2005
...
#           5 - DEST_DIR       # Destination file directory on target machin
#           6 - T_PROCESS      # Process to execute at target
#
# ---------------------------------------------------------------------------
...
check_params()
{
    ...
    elif [[ -z $T_PROCESS ]] ; then
        error_exit "ERROR: [check_params] Target Trigger Process Parameter not specified"
    else
