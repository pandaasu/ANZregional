#!/bin/sh
# ---------------------------------------------------------------------------
# SCRIPT  : ics_outbound_mqft_bin.sh
# AUTHOR  : Steve Gregan
# DATE    : 13-AUG-2007
...
log_file "INFO: [main] Initialized script for mqft to [${T_QMGR}]" "HARMLESS"
log_file "INFO: [main] Log file location : [${TMP_OUT}]" "HARMLESS"

check_params        # Function: Check passed parameters have values
process_outbound "${S_FILE_NAME}" $MQFT_BIN # Function: Handle file processing
...
# ------- ----------- ------------- --------------------------
# 1.0     13-AUG-2007 S. Gregan     Original
