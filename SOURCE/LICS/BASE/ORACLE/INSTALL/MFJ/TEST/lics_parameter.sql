...
create or replace package lics_parameter as
   ...
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/lad/test/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/lad/test/bin/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/lad/test/bin/';
   restore_script constant varchar2(128) := '/ics/lad/test/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/lad/test/bin/ics_inbound_sap.sh';
