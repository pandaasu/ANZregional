...
create or replace package lics_parameter as
   ...
   system_environment constant varchar2(20) := 'PMX_TEST';
   system_url constant varchar2(128) := 'http://webappdev4.ap.mars/';
   system_startup constant varchar2(128) := '/ics/pmx/test/bin/restart_jobs.sh';
   ...
   fatal_ema_group constant varchar2(64) := 'mfanz.promax.support.test@esosn1';

   /*-*/
   /* Public operator parameters
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/pmx/test/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/pmx/test/bin/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/pmx/test/bin/';
   restore_script constant varchar2(128) := '/ics/pmx/test/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/pmx/test/bin/ics_inbound_sap.sh';
