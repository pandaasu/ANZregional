...
/**
 ...
 2010/05   Ben Halicki    Modified for Pak Chong, Thailand Installation
...
create or replace package lics_parameter as
   ...
   system_unit constant varchar2(10) := 'PCH';
   system_environment constant varchar2(20) := 'PAK_CHONG_TEST';
   system_url constant varchar2(128) := 'http://plant.pch.ap.mars/';
   system_startup constant varchar2(128) := '/ics/pch/test/restart_jobs.sh';
   ...
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/pch/test/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/pch/test/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/pch/test/';
   restore_script constant varchar2(128) := '/ics/pch/test/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/pch/test/ics_inbound_sap.sh';
