   ...
   1.2. The DBA needs to connect as SYS when executing the following commands.
        ...
        1.2.1. Add the following to the WO...
	       ...
	       execute dbms_java.grant_permission('LICS_APP','java.io.FilePermission','/ics/cuc/prod/inbound/*','write');
               ...
               create directory ics_archive as '/ics/cuc/prod/archive';
...
4. Check that the database has been updated as requested...
   ...
   4.3. Check the oracle directories have been created using the statement ==> select * from all_directories;
	   ...
	   ICS_ARCHIVE   /ics/cuc/prod/archive
	   ICS_CONFIG    /ics/cuc/prod/config
	   ICS_BIN       /ics/cuc/prod/bin

5. Load the ICS java classes into the LICS_APP schema using the following commands...

      loadjava -f -v -r -u lics_app/licskyte@DB1344P.AP.MARS D:\Vivian\LADS\SourceRepository\SOURCE\LICS\BASE\JAVA\ICS_General\build\classes\com\isi\ics\cExternalProcess.class
      loadjava -f -v -r -u lics_app/licskyte@DB1344P.AP.MARS D:\Vivian\LADS\SourceRepository\SOURCE\LICS\BASE\JAVA\ICS_General\build\classes\com\isi\ics\cFileSystem.class
...
10. Recompile the LICS_APP schema objects using the script ==> @D:\Vivian\LADS\SourceRepository\SOURCE\LICS\BASE\ORACLE\INSTALL\ISC_CARE\PROD\_lics_app_build.sql
