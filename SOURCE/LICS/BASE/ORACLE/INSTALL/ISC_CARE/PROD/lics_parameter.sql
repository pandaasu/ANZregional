...
/*-*/
   ...
   /* Public parameters
   /*-*/
   system_code constant varchar2(10) := 'CARE';
   system_unit constant varchar2(10) := 'ISC_CARE';
   ...
   log_database constant varchar2(128) := 'DB1344P.AP.MARS';
   ics_path constant varchar2(128) := '/ics/cuc/prod/';
   ami_path constant varchar2(128) := '/opt/apps/mqft_light/prod/shell/';
