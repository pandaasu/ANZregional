...
/*  B. Scan for <DATABASE> and replace with the database name (eg. DB1314T.AP.MARS)
...
define spl_path = D:\Vivian\LADS\SourceRepository\SOURCE\LICS\BASE\ORACLE\INSTALL\ISC_CARE\TEST
define database = db1314t.ap.mars
define codeuser = LICS_APP
define code_password = culics
...
/*-*/
@D:\Vivian\LADS\SourceRepository\SOURCE\LICS\BASE\ORACLE\INSTALL\ISC_CARE\TEST\lics_parameter.sql;
