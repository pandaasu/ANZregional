...
create or replace package lics_parameter as
   ...
   system_environment constant varchar2(20) := 'CUC_TEST';
   system_url constant varchar2(128) := 'http://webappdev11.ap.mars/cuc/';
   system_startup constant varchar2(128) := '/ics/cuc/test/bin/restart_jobs.sh';
   ...
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/cuc/test/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/cuc/test/bin/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/cuc/test/bin/';
   restore_script constant varchar2(128) := '/ics/cuc/test/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/cuc/test/bin/ics_inbound_sap.sh';
