...
/**/
define database = db0837t.ap.mars
define datauser = lics_app
define data_password = culics
...
insert into lics_job values('INBOUND_NORMAL01','Inbound Interfaces (Normal Priority) #01',null,20,null,'"ISI ICS Test Group"@esosn1','*INBOUND','IB_NORM#01',null,'sysdate',null,'1');
insert into lics_job values('INBOUND_NORMAL02','Inbound Interfaces (Normal Priority) #02',null,20,null,'"ISI ICS Test Group"@esosn1','*INBOUND','IB_NORM#02',null,'sysdate',null,'1');
insert into lics_job values('OUTBOUND_NORMAL01','Outbound Interfaces (Normal Priority)',null,20,null,'"ISI ICS Test Group"@esosn1','*OUTBOUND','OB_NORM#01',null,'sysdate',null,'1');
insert into lics_job values('OUTBOUND_NORMAL02','Outbound Interfaces (Normal Priority)',null,20,null,'"ISI ICS Test Group"@esosn1','*OUTBOUND','OB_NORM#02',null,'sysdate',null,'1');
...
insert into lics_sec_user values('ZHANGDAV','David Zhang','ICS_ADMIN','1');
