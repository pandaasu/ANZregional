...
/**/
define database = ap0064p.ap.mars
define datauser = lics_app
define data_password = monkey12
...
insert into lics_job values('INBOUND_TRN03','Inbound Transactional Interfaces (Processor 03)',null,20,null,'"Global ISI ICS-LADS Application Support"@esosn1','*INBOUND','IB_TRN#03',null,'sysdate',null,'1');
insert into lics_job values('INBOUND_TRN04','Inbound Transactional Interfaces (Processor 04)',null,20,null,'"Global ISI ICS-LADS Application Support"@esosn1','*INBOUND','IB_TRN#04',null,'sysdate',null,'1');
