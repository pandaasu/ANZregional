...
insert into lics_interface values('LADPDB01.4','LADS to BTH Plant Database - Process Orders','*INBOUND','IB_TRN',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb01_loader','1');
insert into lics_interface values('LADPDB02.4','LADS to BTH Plant Database - Material Data','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb02_loader','1');
insert into lics_interface values('LADPDB03.4','LADS to BTH Plant Database - Customer Address','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb03_loader','1');
insert into lics_interface values('LADPDB04.4','LADS to BTH Plant Database - BOM Detail','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb04_loader','1');
insert into lics_interface values('LADPDB05.4','LADS to BTH Plant Database - BOM Alternative','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb05_loader','1');
insert into lics_interface values('LADPDB06.4','LADS to BTH Plant Database - Production Resources','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb06_loader','1');
insert into lics_interface values('LADPDB07.4','LADS to BTH Plant Database - Reference Characteristics','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb07_loader','1');
insert into lics_interface values('LADPDB08.4','LADS to BTH Plant Database - Reference Data','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb08_loader','1');
insert into lics_interface values('LADPDB09.4','LADS to BTH Plant Database - Reference Purchasing Source','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb09_loader','1');
insert into lics_interface values('LADPDB10.4','LADS to BTH Plant Database - Customer Sales Area','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb10_loader','1');
insert into lics_interface values('LADPDB11.4','LADS to BTH Plant Database - Material Classifications','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb11_loader','1');
insert into lics_interface values('LADPDB12.4','LADS to BTH Plant Database - Vendor Company','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb12_loader','1');
insert into lics_interface values('LADPDB13.4','LADS to BTH Plant Database - Material BOM','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb13_loader','1');
insert into lics_interface values('LADPDB14.4','LADS to BTH Plant Database - Stock Balance','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb14_loader','1');
insert into lics_interface values('LADPDB15.4','LADS to BTH Plant Database - In Transit','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb15_loader','1');
insert into lics_interface values('LADPDB16.4','LADS to BTH Plant Database - Characteristic Values','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@smtp.ap.mars',null,'bds_app.ladpdb16_loader','1');
commit;
