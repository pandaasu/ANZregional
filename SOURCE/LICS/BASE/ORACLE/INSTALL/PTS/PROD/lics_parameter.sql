...
create or replace package lics_parameter as
   ...
   system_environment constant varchar2(20) := 'PTS_PROD';
   system_url constant varchar2(128) := 'http://www.pts.ap.mars/';
   system_startup constant varchar2(128) := '/ics/pts/prod/bin/restart_jobs.sh';
   ...
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/pts/prod/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/pts/prod/bin/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/pts/prod/bin/';
   restore_script constant varchar2(128) := '/ics/pts/prod/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/pts/prod/bin/ics_inbound_sap.sh';
