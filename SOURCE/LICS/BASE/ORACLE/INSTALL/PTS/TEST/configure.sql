...
/**/
define database = db0762d.ap.mars
define datauser = lics_app
define data_password = licsapppt
...
insert into lics_job values('INBOUND01','Inbound Interfaces (Processor 01)',null,20,null,'"ISI ICS Test Group"@esosn1','*INBOUND','IB#01',null,'sysdate',null,'1');
insert into lics_job values('INBOUND02','Inbound Interfaces (Processor 02)',null,20,null,'"ISI ICS Test Group"@esosn1','*INBOUND','IB#02',null,'sysdate',null,'1');
insert into lics_job values('INBOUND03','Inbound Interfaces (Processor 03)',null,20,null,'"ISI ICS Test Group"@esosn1','*INBOUND','IB#03',null,'sysdate',null,'1');
insert into lics_job values('INBOUND04','Inbound Interfaces (Processor 04)',null,20,null,'"ISI ICS Test Group"@esosn1','*INBOUND','IB#04',null,'sysdate',null,'1');
