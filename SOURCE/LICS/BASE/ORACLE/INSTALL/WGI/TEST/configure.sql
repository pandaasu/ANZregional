...
/**/
define database = ap0068t.ap.mars
...
insert into lics_job values('BDS_PURGING','BDS Purging - DAILY 2:30',null,20,null,'"ISI ICS Test Group"@esosn1','*PROCEDURE',null,'bds_purging.execute','lics_time.schedule_next(''*ALL'',2.2)','lics_time.schedule_next(''*ALL'',2.2)','1');
commit;

prompt CREATING INBOUND INTERFACE CONFIGURATION ...

insert into lics_interface values('LADPDB01.2','LADS to WGI Plant Database - Process Orders','*INBOUND','IB_TRN',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb01_loader','1');
insert into lics_interface values('LADPDB02.2','LADS to WGI Plant Database - Material Data','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb02_loader','1');
insert into lics_interface values('LADPDB03.2','LADS to WGI Plant Database - Customer Address','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb03_loader','1');
insert into lics_interface values('LADPDB04.2','LADS to WGI Plant Database - BOM Detail','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb04_loader','1');
insert into lics_interface values('LADPDB05.2','LADS to WGI Plant Database - BOM Alternative','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb05_loader','1');
insert into lics_interface values('LADPDB06.2','LADS to WGI Plant Database - Production Resources','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb06_loader','1');
insert into lics_interface values('LADPDB07.2','LADS to WGI Plant Database - Reference Characteristics','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb07_loader','1');
insert into lics_interface values('LADPDB08.2','LADS to WGI Plant Database - Reference Data','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb08_loader','1');
insert into lics_interface values('LADPDB09.2','LADS to WGI Plant Database - Reference Purchasing Source','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb09_loader','1');
insert into lics_interface values('LADPDB10.2','LADS to WGI Plant Database - Customer Sales Area','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb10_loader','1');
insert into lics_interface values('LADPDB11.2','LADS to WGI Plant Database - Material Classifications','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb11_loader','1');
insert into lics_interface values('LADPDB12.2','LADS to WGI Plant Database - Vendor Company','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb12_loader','1');
insert into lics_interface values('LADPDB13.2','LADS to WGI Plant Database - Material BOM','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb13_loader','1');
insert into lics_interface values('LADPDB14.2','LADS to WGI Plant Database - Stock Balance','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb14_loader','1');
insert into lics_interface values('LADPDB15.2','LADS to WGI Plant Database - In Transit','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb15_loader','1');
insert into lics_interface values('LADPDB16.2','LADS to WGI Plant Database - Characteristic Values','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"ISI ICS Test Group"@esosn1',null,'bds_app.ladpdb16_loader','1');
commit;
