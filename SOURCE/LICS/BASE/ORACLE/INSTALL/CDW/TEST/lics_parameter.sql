...
create or replace package lics_parameter as
   ...
   system_environment constant varchar2(20) := 'CDW_TEST';
   system_url constant varchar2(128) := 'http://webappdev31.ap.mars/';
   system_startup constant varchar2(128) := '/ics/cdw/test/bin/restart_jobs.sh';
   ...
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/cdw/test/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/cdw/test/bin/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/cdw/test/bin/';
   restore_script constant varchar2(128) := '/ics/cdw/test/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/cdw/test/bin/ics_inbound_sap.sh';
