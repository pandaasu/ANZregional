...
/**/
define database = db0720p.ap.mars
...
insert into lics_interface values('LADPDB01.6','LADS to SCO Plant Database - Process Orders','*INBOUND','IB_TRN',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb01_loader','1');
insert into lics_interface values('LADPDB02.6','LADS to SCO Plant Database - Material Data','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb02_loader','1');
insert into lics_interface values('LADPDB03.6','LADS to SCO Plant Database - Customer Address','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb03_loader','1');
insert into lics_interface values('LADPDB04.6','LADS to SCO Plant Database - BOM Detail','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb04_loader','1');
insert into lics_interface values('LADPDB05.6','LADS to SCO Plant Database - BOM Alternative','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb05_loader','1');
insert into lics_interface values('LADPDB06.6','LADS to SCO Plant Database - Production Resources','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb06_loader','1');
insert into lics_interface values('LADPDB07.6','LADS to SCO Plant Database - Reference Characteristics','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb07_loader','1');
insert into lics_interface values('LADPDB08.6','LADS to SCO Plant Database - Reference Data','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb08_loader','1');
insert into lics_interface values('LADPDB09.6','LADS to SCO Plant Database - Reference Purchasing Source','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb09_loader','1');
insert into lics_interface values('LADPDB10.6','LADS to SCO Plant Database - Customer Sales Area','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb10_loader','1');
insert into lics_interface values('LADPDB11.6','LADS to SCO Plant Database - Material Classifications','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb11_loader','1');
insert into lics_interface values('LADPDB12.6','LADS to SCO Plant Database - Vendor Company','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb12_loader','1');
insert into lics_interface values('LADPDB13.6','LADS to SCO Plant Database - Material BOM','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb13_loader','1');
insert into lics_interface values('LADPDB14.6','LADS to SCO Plant Database - Stock Balance','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb14_loader','1');
insert into lics_interface values('LADPDB15.6','LADS to SCO Plant Database - In Transit','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb15_loader','1');
insert into lics_interface values('LADPDB16.6','LADS to SCO Plant Database - Characteristic Values','*INBOUND','IB_REF',1,5,5,'ICS_INBOUND',null,0,null,null,'"2005 Site Team"@smtp.ap.mars',null,'bds_app.ladpdb16_loader','1');
commit;
