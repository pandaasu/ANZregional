...
create or replace package lics_parameter as
   ...
   /**
    ...
    2011/09   Vivian Huang   Change parameter for CAD
...
/*-*/
   ...
   system_url constant varchar2(128) := 'test.CAD.hua.ap.mars';
   ...
   fatal_ema_group constant varchar2(64) := '"lee.plus"@smtp.ap.mars';
