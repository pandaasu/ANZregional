...
'// Script  : ics_xrf_maintenance05.asp                          //
'// Author  : Linden Glen                                        //
'// Date    : February 2005                                      //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_xrf_maintenance05.asp"
   ...
   '//
   strReturn = GetSecurityCheck("XRF_NZ_TRANSPORT")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.xrf_code = 'NZ_CUST_TZONE_TO_REGION'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_xrf_maintenance05_select.inc"-->
<%end sub
...
'//////////////////////////
sub PaintInsert()%>
<!--#include file="ics_xrf_maintenance05_insert.inc"-->
<%end sub
...
'//////////////////////////
sub PaintUpdate()%>
<!--#include file="ics_xrf_maintenance05_update.inc"-->
<%end sub
...
'//////////////////////////
sub PaintDelete()%>
<!--#include file="ics_xrf_maintenance05_delete.inc"-->
<%end sub%>
