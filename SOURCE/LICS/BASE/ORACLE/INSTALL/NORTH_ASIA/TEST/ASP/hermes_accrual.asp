...
sub ProcessCreate()
   ...
   set objFunction.Security = objSecurity
	...
	strStatement = "hermes_tp_accrual.create_accr('" & objSecurity.FixString(objForm.Fields("DTA_TpaComCode").Value) & "') "	
...
sub ProcessSend()
    ...
    strStatement = "hermes_tp_accrual.send_accr('" & objSecurity.FixString(objForm.Fields("DTA_TpaComCode").Value) & "') "
