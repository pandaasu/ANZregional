...
sub ProcessSubmit()
   ...
   '//
   strStatement = "lics_trigger_submitter.execute('LADS Statistics','lads_validation.statistics(''" & objSecurity.FixString(objForm.Fields("DTA_GROUP").Value) & "'')','LADS_VALIDATION')"
