...
<body class="clsTable01" scroll="no">
   ...
   <iframe style="display:none;visibility:hidden" scrolling=no frameborder=no src="<%=strBase%>hermes_cn_claim_adm_excel.asp?DTA_TpaComCode=<%=objForm.Fields("DTA_TpaComCode").Value%>"></iframe>
</body>
</html>
<%end sub%>
