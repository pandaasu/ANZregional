...
create or replace package lics_parameter as
   ...
   system_environment constant varchar2(20) := 'PMX_DEVELOPMENT';
   system_url constant varchar2(128) := 'http://xxxxxx/';
   system_startup constant varchar2(128) := '/ics/pmx/dev/bin/restart_jobs.sh';
   ...
   fatal_ema_group constant varchar2(64) := 'paul.berude@esosn1';

   /*-*/
   /* Public operator parameters
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/pmx/dev/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/pmx/dev/bin/ics_cleanup.sh';

   /*-*/
   /* Public script parameters
   /*-*/
   restore_script constant varchar2(128) := '/ics/pmx/dev/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/pmx/dev/bin/ics_inbound_sap.sh';
