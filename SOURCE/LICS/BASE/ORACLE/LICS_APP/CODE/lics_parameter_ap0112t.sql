...
create or replace package lics_parameter as
   ...
   system_unit constant varchar2(10) := 'CHINA_HK';
   system_environment constant varchar2(20) := 'TEST';
   system_url constant varchar2(128) := 'http://test.clio.ap.mars/';
   system_startup constant varchar2(128) := '/ics/lad/hk/test/bin/restart_jobs.sh';
   ...
   /*-*/
   operator_alert_script constant varchar2(64) := '/ics/lad/hk/test/bin/ics_tivoli_alert.sh';
   ...
   purge_file_script constant varchar2(128) := '/ics/lad/hk/test/bin/ics_cleanup.sh';

   /*-*/
   /* Public restore parameters
   /*-*/
   script_directory constant varchar2(128) := '/ics/lad/hk/test/bin/';
   restore_script constant varchar2(128) := '/ics/lad/hk/test/bin/ics_restore.sh';
   inbound_sap_script constant varchar2(128) := '/ics/lad/hk/test/bin/ics_inbound_sap.sh';
