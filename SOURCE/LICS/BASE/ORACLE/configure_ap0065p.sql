...
insert into lics_interface values('LADPDB01.2','LADS to Wanganui Plant Database - Process Orders','*INBOUND','IB_TRN',1,5,5,'ICS_INBOUND',null,0,null,null,'jeff.phillipson@esosn1',null,'bds_app.recipe_loader','1');
commit;
