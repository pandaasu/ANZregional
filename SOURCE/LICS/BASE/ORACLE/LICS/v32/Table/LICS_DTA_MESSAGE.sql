...
--------------------------------------------------------
  ...
  GRANT SELECT ON "LICS"."LICS_DTA_MESSAGE" TO "FFLU_APP";
  GRANT UPDATE ON "LICS"."LICS_DTA_MESSAGE" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_DTA_MESSAGE" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_DTA_MESSAGE" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_DTA_MESSAGE" TO "LICS_APP";
