...
--------------------------------------------------------
  ...
  GRANT SELECT ON "LICS"."LICS_STR_EXE_TASK" TO "LICS_EXEC";
  GRANT UPDATE ON "LICS"."LICS_STR_EXE_TASK" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_STR_EXE_TASK" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_STR_EXE_TASK" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_STR_EXE_TASK" TO "LICS_APP";
