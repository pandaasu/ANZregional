...
--------------------------------------------------------
  ...
  GRANT SELECT ON "LICS"."LICS_SEC_USER" TO "FFLU_APP";
  GRANT UPDATE ON "LICS"."LICS_SEC_USER" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_SEC_USER" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_SEC_USER" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_SEC_USER" TO "LICS_APP";
