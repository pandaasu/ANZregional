...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "LICS"."LICS_DAS_SYSTEM" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_DAS_SYSTEM" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_DAS_SYSTEM" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_DAS_SYSTEM" TO "LICS_APP";
