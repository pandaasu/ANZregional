...
--------------------------------------------------------
  ...
  GRANT SELECT ON "LICS"."LICS_INTERFACE" TO "APPSUPPORT";
  GRANT SELECT ON "LICS"."LICS_INTERFACE" TO "FFLU_APP";
  GRANT UPDATE ON "LICS"."LICS_INTERFACE" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_INTERFACE" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_INTERFACE" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_INTERFACE" TO "LICS_APP";
