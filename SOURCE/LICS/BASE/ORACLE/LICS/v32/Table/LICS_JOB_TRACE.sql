...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "LICS"."LICS_JOB_TRACE" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_JOB_TRACE" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_JOB_TRACE" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_JOB_TRACE" TO "LICS_APP";
