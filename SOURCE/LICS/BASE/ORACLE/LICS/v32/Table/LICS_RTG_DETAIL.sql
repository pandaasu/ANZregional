...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "LICS"."LICS_RTG_DETAIL" TO "LICS_APP";
  GRANT SELECT ON "LICS"."LICS_RTG_DETAIL" TO "LICS_APP";
  GRANT INSERT ON "LICS"."LICS_RTG_DETAIL" TO "LICS_APP";
  GRANT DELETE ON "LICS"."LICS_RTG_DETAIL" TO "LICS_APP";
