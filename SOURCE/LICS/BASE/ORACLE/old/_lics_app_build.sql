...
/******************************************************************/
/* 
- Replace <SVN> with your svn folder.
- Replace <LOG_FOLDER> with your log folder.
- Replace <DATABASE> with your DB name.
- Replace <PASSWORD> with your pwd.
*/
...
/**/
define pro_path = <SVN>\SOURCE\LICS\BASE\ORACLE\LICS_APP
define spl_path = <LOG_FOLDER>
define database = <DATABASE>.ap.mars
define codeuser = lics_app
define code_password = <PASSWORD>
