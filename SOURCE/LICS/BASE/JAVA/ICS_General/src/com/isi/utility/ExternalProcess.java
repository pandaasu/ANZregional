...
/**
 * This class implements the external process facility.
...
public final class ExternalProcess {
   ...
   public static void executeProcedure(String objCommand) throws Exception {
      ExternalProcess objExternalProcess;
      String objReturn;
      try {
         objExternalProcess = new ExternalProcess();
         objReturn = objExternalProcess.execute(objCommand);
      } finally {
