...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strReturn = GetSecurityCheck("XRF_NZ_VENDOR")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.xrf_code = 'NZ_CUSTOMER'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_xrf_maintenance06_select.inc"-->
<%end sub
...
'//////////////////////////
sub PaintInsert()%>
<!--#include file="ics_xrf_maintenance06_insert.inc"-->
<%end sub
...
'//////////////////////////
sub PaintUpdate()%>
<!--#include file="ics_xrf_maintenance06_update.inc"-->
<%end sub
...
'//////////////////////////
sub PaintDelete()%>
<!--#include file="ics_xrf_maintenance06_delete.inc"-->
<%end sub%>
