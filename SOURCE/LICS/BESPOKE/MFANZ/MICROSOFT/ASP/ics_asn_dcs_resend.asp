...
'// Script  : ics_asn_dcs_resend.asp                             //
'// Author  : Steve Gregan                                       //
'// Date    : December 2005                                      //
'// Text    : This script implements the ASN DCS resend          //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_asn_dcs_resend.asp"
   strHeading = "Advanced Shipping Notice - Distribution Centre - Resend"
   ...
   '//
   strReturn = GetSecurityCheck("ASN_DCS_RESEND")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " to_char(t01.dch_smsg_cnt)"
   ...
   strQuery = strQuery & " order by t01.dch_smsg_nbr " & strOrder
...
sub ProcessUpdate()
   ...
   '//
   strStatement = "asn_dcs_processor.send_message("
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_asn_dcs_resend.inc"-->
<%end sub%>
