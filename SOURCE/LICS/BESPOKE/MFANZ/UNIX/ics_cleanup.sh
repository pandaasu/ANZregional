...
# 11-NOV-2004   J. Eitel    Added webview directory to log_cleanup
...
# temp files ...
log_cleanup "${SCRIPT_PATH}/../work"                "1"         "*.sql"
log_cleanup "${SCRIPT_PATH}/../work"                "1"         "*.tmp"
log_cleanup "${SCRIPT_PATH}/../webview"             "1"         "*.*"
log_cleanup "${SCRIPT_PATH}/../work"                "1"         "*.log"

# archived log files ...
log_cleanup "${SCRIPT_PATH}/../log/archive"         "90"        "*.arc"
log_cleanup "${SCRIPT_PATH}/../log/archive"         "90"        "*.Z"

# archived inbound and outbound files
log_cleanup "${SCRIPT_PATH}/../archive"             "14"        "*.Z"
log_cleanup "${SCRIPT_PATH}/../archive"             "14"        "*.gz"
log_cleanup "${SCRIPT_PATH}/../archive"             "14"        "*.DAT"
log_cleanup "${SCRIPT_PATH}/../archive"             "14"        "*.txt"

# inbound and outbound files
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.DAT"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.txt"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.xml"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.csv"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.TXT"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.dat"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "*.INT"
log_cleanup "${SCRIPT_PATH}/../inbound"             "14"        "APLICS*"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.DAT"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.xml"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.csv"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.TXT"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.txt"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.dat"
log_cleanup "${SCRIPT_PATH}/../outbound"            "30"        "*.INT"

# backup directory (used for period end backup)
log_cleanup "${SCRIPT_PATH}/../backup"              "30"        "*.*"
