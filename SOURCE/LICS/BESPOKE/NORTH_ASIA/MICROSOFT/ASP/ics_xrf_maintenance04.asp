...
'// Script  : ics_xrf_maintenance04.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : February 2004                                      //
'// Text    : This script implements the cross reference         //
'//           maintenance functionality (ATLAS_MFGPRO_TERMS)     //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_xrf_maintenance04.asp"
   ...
   '//
   strReturn = GetSecurityCheck("XRF_MFGPRO_CREDIT")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.xrf_code = 'ATLAS_MFGPRO_TERMS'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_xrf_maintenance04_select.inc"-->
<%end sub
...
'//////////////////////////
sub PaintInsert()%>
<!--#include file="ics_xrf_maintenance04_insert.inc"-->
<%end sub
...
'//////////////////////////
sub PaintUpdate()%>
<!--#include file="ics_xrf_maintenance04_update.inc"-->
<%end sub
...
'//////////////////////////
sub PaintDelete()%>
<!--#include file="ics_xrf_maintenance04_delete.inc"-->
<%end sub%>
