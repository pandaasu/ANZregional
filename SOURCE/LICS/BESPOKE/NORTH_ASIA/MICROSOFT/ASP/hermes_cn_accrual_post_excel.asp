...
sub ProcessRequest
   ...
   '//strQuery = strQuery & " order by t01.tp_id asc "
	...
	strQuery = strQuery & "  where numofrow between (50000 * to_number('" & objSecurity.FixString(objForm.Fields("DTA_FILENUM").Value) & "') + 1) and (50000 * (to_number('" & objSecurity.FixString(objForm.Fields("DTA_FILENUM").Value) & "') + 1)) "
