...
sub ProcessRequest
   ...
   set objSelection.Security = objSecurity
	...
	strQuery = strQuery & " where t01.tph_com_code = '" & objSecurity.FixString(objForm.Fields("DTA_TpaComCode").Value) & "'"
	strQuery = strQuery & "		and t01.tph_period = '" & objSecurity.FixString(objForm.Fields("DTA_TpaCurrPrd").Value) & "'"
