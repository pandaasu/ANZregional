...
'//////////////////////////////////////////////////////////////////
'// System  : Hermes                                             //
'// Script  : hermes_cn_claim_post.asp                           //
'// Author  : ISI China                                          //
'// Date    : July 2007                                          //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "hermes_cn_claim_post.asp"
   strHeading = "TP Claim Calculation and Posting"
...
sub ProcessCreate()
  ...
  strStatement = "hermes_post.create_claim('" & objSecurity.FixString(objForm.Fields("DTA_TpaComCode").Value) & "','" & strUser & "','" & objSecurity.FixString(objForm.Fields("DTA_UserSec").Value) & "')"
...
sub ProcessSend()
  ...
  strStatement = "hermes_post.send_claim('" & objSecurity.FixString(objForm.Fields("DTA_TpaComCode").Value) & "','" & strUser & "','" & objSecurity.FixString(objForm.Fields("DTA_UserSec").Value) & "')"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="hermes_cn_claim_post.inc"-->
<%end sub%>
