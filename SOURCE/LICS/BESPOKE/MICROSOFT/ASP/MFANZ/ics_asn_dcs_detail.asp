...
sub ProcessForm()
   ...
   strQuery = strQuery & " dch_whs_file_ide,"
   strQuery = strQuery & " dch_whs_pick_nbr,"
   strQuery = strQuery & " dch_whs_ship_frm,"
   strQuery = strQuery & " dch_whs_send_dte,"
   strQuery = strQuery & " dch_whs_desp_dte,"
   strQuery = strQuery & " dch_whs_palt_num,"
   strQuery = strQuery & " dch_whs_palt_spc,"
   strQuery = strQuery & " dch_whs_csgn_nbr,"
   strQuery = strQuery & " dch_whs_ship_tar"
   ...
   '//
   strQuery = "select"
   strQuery = strQuery & " dch_trn_pick_nbr,"
   strQuery = strQuery & " dch_trn_sord_nbr,"
   strQuery = strQuery & " dch_trn_ship_nbr,"
   strQuery = strQuery & " dch_trn_invc_nbr,"
   strQuery = strQuery & " dch_trn_mars_iid,"
   strQuery = strQuery & " dch_trn_cust_iid,"
   strQuery = strQuery & " dch_trn_cust_pon,"
   strQuery = strQuery & " dch_trn_agrd_dte,"
   strQuery = strQuery & " dch_trn_invc_dte,"
   strQuery = strQuery & " dch_trn_splt_shp,"
   strQuery = strQuery & " dch_trn_invc_val,"
   strQuery = strQuery & " dch_trn_invc_gst,"
   strQuery = strQuery & " dch_trn_crcy_cde,"
   strQuery = strQuery & " dch_trn_ship_iid,"
   strQuery = strQuery & " dch_trn_ship_nam,"
   strQuery = strQuery & " dch_trn_dock_nbr,"
   strQuery = strQuery & " dch_trn_byer_ide"
   strQuery = strQuery & " from asn_dcs_hdr t01"
   strQuery = strQuery & " where t01.dch_mars_cde = '" & objForm.Fields("QRY_MarsCode").Value & "'"
   strQuery = strQuery & " and t01.dch_pick_nbr = '" & objForm.Fields("QRY_PickNumber").Value & "'"
   ...
   '//
   strQuery = "select"
   strQuery = strQuery & " dcd_whs_sscc_nbr,"
   strQuery = strQuery & " dcd_whs_iden_typ,"
   strQuery = strQuery & " dcd_whs_pack_typ,"
   strQuery = strQuery & " dcd_whs_eqpt_typ,"
   strQuery = strQuery & " dcd_whs_gtin,"
   strQuery = strQuery & " dcd_whs_btch,"
   strQuery = strQuery & " dcd_whs_bbdt,"
   strQuery = strQuery & " dcd_whs_palt_qty,"
   strQuery = strQuery & " dcd_whs_palt_lay,"
   strQuery = strQuery & " dcd_whs_layr_unt"
