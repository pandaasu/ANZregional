...
'// Script  : ics_asn_dts_cancel.asp                             //
'// Author  : Steve Gregan                                       //
'// Date    : December 2005                                      //
'// Text    : This script implements the ASN DTS cancel          //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_asn_dts_cancel.asp"
   strHeading = "Advanced Shipping Notice - Direct To Store - Cancel"
   ...
   '//
   strReturn = GetSecurityCheck("ASN_DTS_CANCEL")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.dth_stat_cde != '*COMPLETE' and t01.dth_stat_cde != '*CANCELLED'"
   if strWhere <> "" then
...
sub ProcessUpdate()
   ...
   '//
   strStatement = "asn_dts_processor.cancel("
   strStatement = strStatement & "'" & objForm.Fields("DTA_MarsCode").Value & "',"
   strStatement = strStatement & "'" & objForm.Fields("DTA_LoadNumber").Value & "'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_asn_dts_cancel.inc"-->
<%end sub%>
