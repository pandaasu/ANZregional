...
'// Script  : ics_xrf_maintenance03.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : February 2004                                      //
'// Text    : This script implements the cross reference         //
'//           maintenance functionality (MFGPRO_ACCOUNT)         //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "ics_xrf_maintenance03.asp"
   ...
   '//
   strReturn = GetSecurityCheck("XRF_MFGPRO_ACCOUNT")
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " where t01.xrf_code = 'MFGPRO_ACCOUNT'"
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="ics_xrf_maintenance03_select.inc"-->
<%end sub
...
'//////////////////////////
sub PaintInsert()%>
<!--#include file="ics_xrf_maintenance03_insert.inc"-->
<%end sub
...
'//////////////////////////
sub PaintUpdate()%>
<!--#include file="ics_xrf_maintenance03_update.inc"-->
<%end sub
...
'//////////////////////////
sub PaintDelete()%>
<!--#include file="ics_xrf_maintenance03_delete.inc"-->
<%end sub%>
