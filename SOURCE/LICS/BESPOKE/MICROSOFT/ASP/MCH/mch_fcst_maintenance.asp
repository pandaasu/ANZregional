...
sub ProcessSelect()
   ...
   strQuery = strQuery & " t01.sales_org_code,"
   strQuery = strQuery & " t01.distbn_chnl_code,"
   strQuery = strQuery & " t01.division_code,"
...
sub ProcessCreate()
   ...
   if objForm.Fields("DTA_LoadDataType").Value = "*QTY_ONLY" or objForm.Fields("DTA_LoadDataType").Value = "*QTY_GSV" then
      lngIndex = 1
