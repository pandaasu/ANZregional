...
comment on column lics_str_parameter.stp_str_code is 'Stream parameter - stream code';
...
alter table lics_str_parameter
   add constraint lics_str_parameter_pk primary key (stp_str_code, stp_par_code);
