   ...
   begin
      ...
      loop
         ...
         lics_outbound_loader.append_data('HDR' ||
                                          nvl(rcd_std_hierarchy.sap_cust_code_level_1,' ')||rpad(' ',10-length(nvl(rcd_std_hierarchy.sap_cust_code_level_1,' ')),' ') ||
                                          nvl(rcd_std_hierarchy.sap_cust_code_level_2,' ')||rpad(' ',10-length(nvl(rcd_std_hierarchy.sap_cust_code_level_2,' ')),' ') ||
                                          nvl(rcd_std_hierarchy.sap_cust_code_level_3,' ')||rpad(' ',10-length(nvl(rcd_std_hierarchy.sap_cust_code_level_3,' ')),' ') ||
                                          nvl(rcd_std_hierarchy.sap_cust_code_level_4,' ')||rpad(' ',10-length(nvl(rcd_std_hierarchy.sap_cust_code_level_4,' ')),' ') ||
