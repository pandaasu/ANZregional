...
create or replace package site_app.ladwgb04_extract as
   ...
   /**
    ...
    Description
    -----------
    China Customer Hierarchy - Sales Force Geography Data - LADS to WGB

    This package extracts the LADS customer hierarchy - sales force geography that have been modified within the last
...
create or replace package body site_app.ladwgb04_extract as
   ...
   procedure execute is
      ...
      /* Local cursors
      /*-*/
      cursor csr_customer_hierarchy_sales_force_geography is
      ...
      rcd_customer_hierarchy_sales_force_geography csr_customer_hierarchy_sales_force_geography%rowtype;
   ...
   begin
      ...
      /*-*/
      open csr_customer_hierarchy_sales_force_geography;
      loop
         fetch csr_customer_hierarchy_sales_force_geography into rcd_customer_hierarchy_sales_force_geography;
         if csr_customer)hierarchy_sales_force_geography%notfound then
            exit;
         end if;
         ...
         /*-*/
         if (var_start) then
            var_instance := lics_outbound_loader.create_interface('LADWGB04',null,'MARS_GB_01_GEOH'||to_char(sysdate,'yyyymmddhh24miss')||'.txt');
            var_start := false;
         end if;
         ...
         /* Append data lines
         /*-*/
         lics_outbound_loader.append_data(rcd_customer_hierarchy_sales_force_geography.sap_hier_cust_code ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_sales_org_code ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_distbn_chnl_code ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_division_code ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_cust_code_level_1 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_name_en_level_1 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_sales_org_code_level_1 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_distbn_chnl_code_level_1 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_division_code_level_1 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_hier_sort_level_1 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_cust_code_level_2 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_name_en_level_2 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_sales_org_code_level_2 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_distbn_chnl_code_level_2 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_division_code_level_2 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_hier_sort_level_2 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_cust_code_level_3 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_name_en_level_3 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_sales_org_code_level_3 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_distbn_chnl_code_level_3 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_division_code_level_3 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_hier_sort_level_3 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_cust_code_level_4 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_name_en_level_4 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_sales_org_code_level_4 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_distbn_chnl_code_level_4 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_division_code_level_4 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_hier_sort_level_4 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_cust_code_level_5 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_name_en_level_5 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_sales_org_code_level_5 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_distbn_chnl_code_level_5 ||
                                          rcd_customer_hierarchy_sales_force_geography.sap_division_code_level_5 ||
                                          rcd_customer_hierarchy_sales_force_geography.cust_hier_sort_level_5);

      end loop;
      close csr_customer_hierarchy_sales_force_geography;
