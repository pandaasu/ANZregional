/******************************************************************************/
/*  NAME:       EFEX_ITEM_HK_VIEW                                             */
/*  PURPOSE:    Hong Kong EFEX Item view                                      */
/*  REVISIONS:                                                                */
/*  Ver    Date        Author           Description                           */
/*  -----  ----------  ---------------  ------------------------------------  */
/*  1.0    07-08-2006  Steve Gregan     Created view for HK                   */
/*  1.1    11-12-2006  Steve Gregan     Changed source of material desc       */
/*                                      Changed pricing to pricing UOM        */
/******************************************************************************/

create or replace force view ics_app.efex_item_hk_view
   (item_code,
    item_name,
    item_zrep_code,
    rsu_ean_code,
...
/* Authority
/*-*/
grant select on ics_app.efex_item_hk_view to ics_reader;

/*-*/
/* Synonym
/*-*/
create or replace public synonym efex_item_hk_view for ics_app.efex_item_hk_view;