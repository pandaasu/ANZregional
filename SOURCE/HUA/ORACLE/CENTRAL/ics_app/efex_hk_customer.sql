/******************************************************************************/
/*  NAME:       EFEX_HK_CUSTOMER                                              */
/*  PURPOSE:    Hong Kong EFEX Item view                                      */
/*  REVISIONS:                                                                */
/*  Ver    Date        Author           Description                           */
/*  -----  ----------  ---------------  ------------------------------------  */
/*  1.0    20-06-2006  Toui Lepkhammany  Created View
/*  1.1    03-08-2006  Toui Lepkhammany  Modified view so that name include name_2 field
/*  1.2    28-08-2006  Toui Lepkhammany  Removed the cust.loevm IS NULL condition.
/******************************************************************************/

create or replace force view ics_app.efex_hk_customer
   (cust_code,
    name,
    address_1,
    city,
...
/* Authority
/*-*/
grant select on ics_app.efex_hk_customer to ics_reader;

/*-*/
/* Synonym
/*-*/
create or replace public synonym efex_hk_customer for ics_app.efex_hk_customer;
