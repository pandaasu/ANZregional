...
comment on column pts.pts_sel_tem_group.stg_stm_code is 'Selection template code';
...
alter table pts.pts_sel_tem_group
   add constraint pts_sel_tem_group_pk primary key (stg_stm_code, stg_sel_group);
