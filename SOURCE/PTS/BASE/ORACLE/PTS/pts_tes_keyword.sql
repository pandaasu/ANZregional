...
comment on column pts.pts_tes_keyword.tke_key_code is 'Test keyword code';

/**/
/* Primary Key Constraint
/**/
alter table pts.pts_tes_keyword
   add constraint pts_tes_keyword_pk primary key (tke_tes_code, tke_key_code);
