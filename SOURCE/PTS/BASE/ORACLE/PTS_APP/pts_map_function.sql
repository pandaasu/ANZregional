   ...
   procedure execute_extract is
      ...
      cursor csr_detail is
         select t01.tpa_tes_code,
                ...
                (select sva_val_text from pts_sys_value where sva_tab_code = '*PET_CLA' and sva_fld_code = 26 and sva_val_code = (select tcl_val_code from pts_tes_classification where tcl_tab_code = '*PET_CLA' and tcl_fld_code = 26 and tcl_tes_code = t01.tpa_tes_code and tcl_pan_code = t01.tpa_pan_code)) as pet_envir_text,
