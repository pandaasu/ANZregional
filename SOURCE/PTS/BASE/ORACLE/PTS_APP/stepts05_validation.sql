...
/******************/
create or replace
PACKAGE         STEPTS05_VALIDATION as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : STEPTS05_VALIDATION
    Owner   : PTS_APP
    Author  : Peter Tylee
...
/****************/
create or replace
PACKAGE BODY         STEPTS05_VALIDATION as
   ...
   begin
     ...
     if upper(substr(var_tokens(1),1,4)) = 'TEST' then
        return var_message;
     end if;
     
     var_tes_code := pts_to_number(var_tokens(1));
     var_day_code := pts_to_number(var_tokens(2));
...
/**************************/
grant execute on pts_app.stepts05_validation to public;
