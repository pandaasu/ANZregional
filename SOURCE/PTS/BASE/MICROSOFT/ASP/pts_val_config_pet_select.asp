...
'// Script  : pts_val_config_pet_select.asp                      //
'// Author  : Peter Tylee                                        //
'// Date    : November 2011                                      //
'// Text    : This script implements the validation pet select   //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the validation pet selection
   '//
   strStatement = "select xml_text from table(pts_app.pts_val_function.select_pet)"
