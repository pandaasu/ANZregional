...
'// Script  : pts_que_config_retrieve.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the question definition     //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the question definition
   '//
   strStatement = "select xml_text from table(pts_app.pts_que_function.retrieve_data)"
