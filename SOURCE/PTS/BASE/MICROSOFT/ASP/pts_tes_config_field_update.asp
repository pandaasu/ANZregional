...
'// Script  : pts_tes_config_field_update.asp                    //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test field update       //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test field update
   '//
   call objProcedure.Execute("pts_app.pts_gen_function.set_field_data")
   if strReturn <> "*OK" then
      exit sub
   end if
