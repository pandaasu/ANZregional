...
'// Script  : pts_pet_restore_retrieve.asp                       //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the pet restore             //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strReturn = GetSecurityCheck("PTS_PET_RESTORE")
...
sub ProcessRequest()
   ...
   '//
   strStatement = "select xml_text from table(pts_app.pts_pet_function.retrieve_restore)"
