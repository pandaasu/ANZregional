...
'// Script  : pts_tes_config_panel_template.asp                  //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test panel template     //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the test panel template
   '//
   strStatement = "select xml_text from table(pts_app.pts_tes_function.retrieve_template)"
