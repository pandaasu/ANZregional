...
'// Script  : pts_tes_config_pet_retrieve.asp                    //
'// Author  : Peter Tylee                                        //
'// Date    : November 2011                                      //
'// Text    : This script implements the val. pet retrieve       //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the validation pet data
   '//
   strStatement = "select xml_text from table(pts_app.pts_val_function.retrieve_pet)"
