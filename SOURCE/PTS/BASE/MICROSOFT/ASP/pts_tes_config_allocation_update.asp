...
'// Script  : pts_tes_config_allocation_update.asp               //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test allocation update  //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test allocation update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_allocation('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
