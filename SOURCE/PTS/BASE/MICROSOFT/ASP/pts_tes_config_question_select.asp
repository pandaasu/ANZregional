...
'// Script  : pts_tes_config_question_select.asp                 //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test question select    //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the test question selection
   '//
   strStatement = "select xml_text from table(pts_app.pts_tes_function.select_question)"
