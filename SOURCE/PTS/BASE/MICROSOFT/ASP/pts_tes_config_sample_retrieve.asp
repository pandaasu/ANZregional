...
'// Script  : pts_tes_config_sample_retrieve.asp                 //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test sample retrieve    //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the test sample data
   '//
   strStatement = "select xml_text from table(pts_app.pts_tes_function.retrieve_sample)"
