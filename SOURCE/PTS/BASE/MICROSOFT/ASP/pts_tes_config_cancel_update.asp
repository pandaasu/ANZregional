...
'// Script  : pts_tes_config_cancel_update.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test cancel update      //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test cancel update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_cancel('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
