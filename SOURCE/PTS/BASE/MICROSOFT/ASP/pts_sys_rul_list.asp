...
'// Script  : pts_sys_rul_list.asp                               //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the system rule list        //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the system rule list
   '//
   strStatement = "select xml_text from table(pts_app.pts_gen_function.list_rul_data)"
