...
'// Script  : pts_tes_config_keyword_update.asp                  //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test keyword update     //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test keyword update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_keyword('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
