...
'// Script  : pts_val_config_allocation_retrieve.asp             //
'// Author  : Peter Tylee                                        //
'// Date    : November 2011                                      //
'// Text    : This script implements the val. allocation         //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the validation allocation data
   '//
   strStatement = "select xml_text from table(pts_app.pts_val_function.retrieve_allocation)"
