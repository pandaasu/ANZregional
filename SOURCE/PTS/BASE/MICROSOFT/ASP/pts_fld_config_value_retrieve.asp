...
'// Script  : pts_fld_config_value_retrieve.asp                  //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the system field value      //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the system field value retrieve
   '//
   strStatement = "select xml_text from table(pts_app.pts_sys_function.retrieve_value)"
