...
'// Script  : pts_tes_config_allocation_retrieve.asp             //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test allocation         //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the test allocation data
   '//
   strStatement = "select xml_text from table(pts_app.pts_tes_function.retrieve_allocation)"
