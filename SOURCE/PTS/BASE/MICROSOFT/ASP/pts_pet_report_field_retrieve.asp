...
'// Script  : pts_pet_report_field_retrieve.asp                  //
'// Author  : Peter Tylee                                        //
'// Date    : August 2014                                        //
'// Text    : This script implements the pet field retrieve      //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the report field data
   '//
   strStatement = "select xml_text from table(pts_app.pts_pet_function.retrieve_report_fields)"
