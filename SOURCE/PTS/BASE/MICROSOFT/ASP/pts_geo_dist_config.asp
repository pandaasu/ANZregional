...
'// Script  : pts_geo_dist_config.asp                            //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "pts_geo_dist_config.asp"
   strHeading = "District Maintenance"
   ...
   '//
   strReturn = GetSecurityCheck("PTS_GEO_DIST_CONFIG")
...
<!--
   ...
   function loadFunction() {
      ...
      cobjScreens[0].hedtxt = 'District Prompt';
      cobjScreens[1].hedtxt = 'District Maintenance';
      cobjScreens[2].hedtxt = 'District List';
   ...
   function doPromptUpdate() {
      ...
      if (document.getElementById('PRO_GeoZone').value == '') {
         ...
         strMessage = strMessage + 'District code must be entered for update';
      }
      if (strMessage != '') {
         alert(strMessage);
         return;
   ...
   function doPromptCopy() {
      ...
      if (document.getElementById('PRO_GeoZone').value == '') {
         if (strMessage != '') {strMessage = strMessage + '\r\n';}
         strMessage = strMessage + 'District code must be entered for copy';
      }
      if (strMessage != '') {
         alert(strMessage);
         return;
   ...
   function requestDefineUpdate(strCode) {
      ...
      doPostRequest('<%=strBase%>pts_geo_dist_config_retrieve.asp',function(strResponse) {checkDefineLoad(strResponse);},false,streamXML(strXML));
   }
   ...
   function checkDefineLoad(strResponse) {
      ...
      if (strResponse.substring(0,3) != '*OK') {
         ...
         if (cstrDefineMode == '*UPD') {
            cobjScreens[1].hedtxt = 'Update District ('+cstrDefineCode+')';
            document.getElementById('codDefine').style.display = 'none';
         } else {
            cobjScreens[1].hedtxt = 'Create District (*NEW)';
   ...
   function requestDefineAccept(strXML) {
      doPostRequest('<%=strBase%>pts_geo_dist_config_update.asp',function(strResponse) {checkDefineAccept(strResponse);},false,streamXML(strXML));
   }
   ...
   function requestList() {
      doPostRequest('<%=strBase%>pts_geo_dist_list.asp',function(strResponse) {checkList(strResponse);},false,'<?xml version="1.0" encoding="UTF-8"?><PTS_REQUEST ACTION="*LSTGEO"/>');
   }
...
<body class="clsBody02" scroll="auto" onLoad="parent.setStatus('<%=strStatus%>');parent.setHelp('pts_geo_dist_config_help.htm');parent.setHeading('<%=strHeading%>');parent.showContent();loadFunction();">
   <table id="dspPrompt" class="clsGrid02" style="display:block;visibility:visible" width=100% align=center valign=top cols=2 cellpadding=1 cellspacing=0 onKeyPress="if (event.keyCode == 13) {doPromptEnter();}">
      ...
      <tr>
         <td id="hedPrompt" class="clsFunction" align=center colspan=2 nowrap><nobr>District Prompt</nobr></td>
      </tr>
      <tr>
         <td class="clsLabelBB" align=center colspan=2 nowrap><nobr>&nbsp;</nobr></td>
      </tr>
      <tr>
         <td class="clsLabelBB" align=right valign=center colspan=1 nowrap><nobr>&nbsp;District Code:&nbsp;</nobr></td>
   ...
   <table id="dspDefine" class="clsGrid02" style="display:none;visibility:visible" width=100% align=center valign=top cols=2 cellpadding=1 cellspacing=0 onKeyPress="if (event.keyCode == 13) {doDefineAccept();}">
      <tr><td align=center colspan=2 nowrap><nobr><table class="clsPanel" align=center cols=2 cellpadding="0" cellspacing="0">
      <tr>
         <td id="hedDefine" class="clsFunction" align=center valign=center colspan=2 nowrap><nobr>District Maintenance</nobr></td>
      ...
      <tr>
         <td class="clsLabelBB" align=right valign=center colspan=1 nowrap><nobr>&nbsp;Location:&nbsp;</nobr></td>
         <td class="clsLabelBN" align=left valign=center colspan=1 nowrap><nobr>
   ...
   <table id="dspList" class="clsGrid02" style="display:none;visibility:visible" height=100% width=100% align=center valign=top cols=2 cellpadding=1 cellspacing=0>
      <tr><td align=center colspan=2 nowrap><nobr><table class="clsPanel" align=center cols=2 cellpadding="0" cellspacing="0">
      <tr>
         <td id="hedList" class="clsFunction" align=center colspan=2 nowrap><nobr>District List</nobr></td>
      </tr>
      <tr>
         <td class="clsLabelBB" align=center colspan=2 nowrap><nobr>&nbsp;</nobr></td>
      </tr>
