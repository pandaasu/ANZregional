...
'// Script  : pts_val_config_pet_update.asp                      //
'// Author  : Peter Tylee                                        //
'// Date    : November 2011                                      //
'// Text    : This script implements the validation pet update   //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the validation pet update
   '//
   call objProcedure.Execute("pts_app.pts_val_function.update_pet('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
