...
'// Script  : pts_tes_release_close_update.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test release update     //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test release update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_release('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
