...
'// Script  : pts_tes_config_sample_update.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test sample update      //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test sample update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_sample('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
