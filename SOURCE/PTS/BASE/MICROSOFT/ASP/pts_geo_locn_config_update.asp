...
'// Script  : pts_geo_locn_config_update.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
...
sub ProcessRequest()
   ...
   '//
   '// Perform the geographic location update
   '//
   call objProcedure.Execute("pts_app.pts_geo_function.update_locn_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
