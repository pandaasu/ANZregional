...
'// Script  : pts_que_search.asp                                 //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the question search         //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   strStatement = "select xml_text from table(pts_app.pts_que_function.retrieve_list)"
