...
'// Script  : pts_int_list.asp                                   //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the interviewer listing     //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the interviewer list
   '//
   strStatement = "select xml_text from table(pts_app.pts_int_function.retrieve_list)"
