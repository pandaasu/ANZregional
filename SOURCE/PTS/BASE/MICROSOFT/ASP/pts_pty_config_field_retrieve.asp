...
'// Script  : pts_pty_config_field_retrieve.asp                  //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the pet type field          //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the pet type field retrieve
   '//
   strStatement = "select xml_text from table(pts_app.pts_pty_function.retrieve_field)"
