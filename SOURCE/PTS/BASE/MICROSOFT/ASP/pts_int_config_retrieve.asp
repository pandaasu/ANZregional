...
'// Script  : pts_int_config_retrieve.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the interviewer definition  //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the interviewer definition
   '//
   strStatement = "select xml_text from table(pts_app.pts_int_function.retrieve_data)"
