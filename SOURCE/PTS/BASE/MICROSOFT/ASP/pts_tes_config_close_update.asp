...
'// Script  : pts_tes_config_close_update.asp                    //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test close update       //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test close update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_close('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
