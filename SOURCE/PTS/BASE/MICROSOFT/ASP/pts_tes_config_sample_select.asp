...
'// Script  : pts_tes_config_sample_select.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test sample select      //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the test sample selection
   '//
   strStatement = "select xml_text from table(pts_app.pts_tes_function.select_sample)"
