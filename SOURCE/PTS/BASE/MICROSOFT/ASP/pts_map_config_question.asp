...
'// Script  : pts_map_config_question.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the map question            //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the map question selection
   '//
   strStatement = "select xml_text from table(pts_app.pts_map_function.select_question)"
