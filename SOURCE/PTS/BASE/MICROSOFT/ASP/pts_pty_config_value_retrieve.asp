...
'// Script  : pts_pty_config_value_retrieve.asp                  //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the pet type value          //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the pet type value retrieve
   '//
   strStatement = "select xml_text from table(pts_app.pts_pty_function.retrieve_value)"
