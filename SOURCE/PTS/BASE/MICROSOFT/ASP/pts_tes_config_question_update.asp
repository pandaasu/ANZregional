...
'// Script  : pts_tes_config_question_update.asp                 //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test question update    //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test question update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_question('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
