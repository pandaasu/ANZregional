...
'// Script  : pts_geo_dist_config_update.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
...
sub ProcessRequest()
   ...
   '//
   '// Perform the geographic district update
   '//
   call objProcedure.Execute("pts_app.pts_geo_function.update_dist_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
