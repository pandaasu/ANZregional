...
'// Script  : pts_geo_dist_config_retrieve.asp                   //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the geographic district definition
   '//
   strStatement = "select xml_text from table(pts_app.pts_geo_function.retrieve_dist_data)"
