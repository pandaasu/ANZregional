...
'// Script  : pts_fld_config_field_retrieve.asp                  //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the system field retrieve
   '//
   strStatement = "select xml_text from table(pts_app.pts_sys_function.retrieve_field)"
