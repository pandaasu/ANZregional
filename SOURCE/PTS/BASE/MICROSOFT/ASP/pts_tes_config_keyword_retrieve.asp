...
'// Script  : pts_tes_config_keyword_retrieve.asp                //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test keyword retrieve   //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the test keyword data
   '//
   strStatement = "select xml_text from table(pts_app.pts_tes_function.retrieve_keyword)"
