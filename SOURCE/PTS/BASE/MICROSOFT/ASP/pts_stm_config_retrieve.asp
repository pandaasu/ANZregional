...
'// Script  : pts_stm_config_retrieve.asp                        //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the selection template definition
   '//
   strStatement = "select xml_text from table(pts_app.pts_stm_function.retrieve_data)"
