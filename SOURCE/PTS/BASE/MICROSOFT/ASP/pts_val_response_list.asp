...
'// Script  : pts_tes_response_list.asp                          //
'// Author  : Peter Tylee                                        //
'// Date    : October 2011                                       //
'// Text    : This script implements the test response list      //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Load the test response list
   '//
   strStatement = "select xml_text from table(pts_app.pts_val_function.response_list)"
