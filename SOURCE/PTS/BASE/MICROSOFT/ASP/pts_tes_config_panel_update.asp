...
'// Script  : pts_tes_config_panel_update.asp                    //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the test panel update       //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the test panel update
   '//
   call objProcedure.Execute("pts_app.pts_tes_function.update_panel('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
