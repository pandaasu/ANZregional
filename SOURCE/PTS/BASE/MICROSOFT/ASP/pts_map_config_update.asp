...
'// Script  : pts_map_config_update.asp                          //
'// Author  : Steve Gregan                                       //
'// Date    : May 2009                                           //
'// Text    : This script implements the mapping definition      //
...
sub ProcessRequest()
   ...
   '//
   '// Perform the mapping update
   '//
   call objProcedure.Execute("pts_app.pts_map_function.update_data('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
