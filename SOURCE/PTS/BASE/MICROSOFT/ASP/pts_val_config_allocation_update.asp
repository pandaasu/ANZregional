...
'// Script  : pts_val_config_allocation_update.asp               //
'// Author  : Peter Tylee                                        //
'// Date    : November 2011                                      //
'// Text    : This script implements the val. allocation update  //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Perform the validation allocation update
   '//
   call objProcedure.Execute("pts_app.pts_val_function.update_allocation('" & GetUser() & "')")
   if strReturn <> "*OK" then
      exit sub
   end if
