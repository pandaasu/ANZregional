...
'// Script  : pts_tes_config_test_retrieve.asp                   //
'// Author  : Peter Tylee                                        //
'// Date    : November 2011                                      //
'// Text    : This script implements the val. test retrieve      //
'//           functionality                                      //
'//////////////////////////////////////////////////////////////////
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the validation test data
   '//
   strStatement = "select xml_text from table(pts_app.pts_val_function.retrieve_test)"
