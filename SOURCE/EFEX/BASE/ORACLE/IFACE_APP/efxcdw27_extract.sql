   ...
   function execute(par_market in number, par_timestamp in varchar2, par_history in number default 0) return number is
      ...
      cursor csr_extract is
         select to_char(t01.mrq_task_id) as mrq_task_id,
                ...
                replace(replace(t01.compliance_result,chr(10),chr(14)),chr(13),chr(15)) as compliance_result,
                replace(replace(t01.mrq_pricing,chr(10),chr(14)),chr(13),chr(15)) as mrq_pricing,
                replace(replace(t01.mrq_task_notes,chr(10),chr(14)),chr(13),chr(15)) as mrq_task_notes,
                t01.status
           from mrq_task t01,
                deal t02,
                segment t03,
