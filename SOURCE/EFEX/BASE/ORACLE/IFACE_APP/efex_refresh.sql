...
PROCEDURE REFRESH_NZ_ITEM(p_MarketID IN NUMBER);
PROCEDURE REFRESH_NZ_CUSTOMER(p_MarketID IN NUMBER);
...
EXCEPTION
  WHEN OTHERS THEN
    Send_Mail(v_error_email, 'eFEX Refresh Interface Error', 'Error in EFEX_REFRESH.REFRESH_AU_SNACK_ITEM'||chr(13)
...
/******************************************************************************
*  NAME:       REFRESH_NZ_ITEM
*  PURPOSE:    EFEX New Zealand Item REFESH PROCEDURE
*  REVISIONS:
*  Ver    Date        Author           Description
*  -----  ----------  ---------------  ------------------------------------
*  1.0    09-11-2008  Steve Gregan     Created from REFRESH_NZ_ITEM 
******************************************************************************/
PROCEDURE REFRESH_NZ_ITEM(p_MarketID IN NUMBER) IS
...
EXCEPTION
  WHEN OTHERS THEN
    Send_Mail(v_error_email, 'eFEX Refresh Interface Error', 'Error in EFEX_REFRESH.REFRESH_NZ_ITEM'||chr(13)

||SQLERRM,NULL);
END REFRESH_NZ_ITEM;

/******************************************************************************
*  NAME:       REFRESH_NZ_CUSTOMER
*  PURPOSE:    EFEX New Zealand Customer REFESH PROCEDURE
*  REVISIONS:
*  Ver    Date        Author           Description
*  -----  ----------  ---------------  ------------------------------------
*  1.0    09-11-2009  Steve Gregan     Created from REFRESH_NZ_CUSTOMER
******************************************************************************/
PROCEDURE REFRESH_NZ_CUSTOMER(p_MarketID IN NUMBER) IS
...
EXCEPTION
  WHEN OTHERS THEN
    Send_Mail(v_error_email, 'eFEX Refresh Interface Error', 'Error in EFEX_REFRESH.REFRESH_NZ_CUSTOMER'||chr(13)||SQLERRM,NULL);
END REFRESH_NZ_CUSTOMER;
