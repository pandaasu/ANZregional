...
'// Date    : September 2003                                     //
'// Text    : This script paints the forecast accuracy source    //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "mfjpln_for_accuracy_sourceunit.asp"
   strHeading = "FORECAST ACCURACY SOURCE UNIT REPORT"
...
sub ProcessReport()
   ...
   '//
   strProcedure = "mfjpln_for_format02_excel04.main"
...
'//////////////////////////
sub PaintPrompt()%>
<!--#include file="mfjpln_for_accuracy_sourceunit_prompt.inc"-->
<%end sub
