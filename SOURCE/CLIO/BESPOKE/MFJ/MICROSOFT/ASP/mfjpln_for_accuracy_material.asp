...
'// Date    : September 2003                                     //
'// Text    : This script paints the forecast accuracy material  //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "mfjpln_for_accuracy_material.asp"
   strHeading = "FORECAST ACCURACY MATERIAL REPORT"
...
sub ProcessSelect()
   ...
   strQuery = strQuery & " pld_for_format0201 t02"
   strQuery = strQuery & " where t01.material_code = t02.material_code"
   ...
   if objForm.Fields("PlanningCategory").Value <> "" then
      strQuery = strQuery & "and t02.planning_category = '" & objForm.Fields("PlanningCategory").Value & "'"
   end if
   strQuery = strQuery & " order by description asc"
...
sub ProcessReport()
   ...
   if objForm.Fields("PlanningCategory").Value <> "" then
      call objVariable.SetVariable("PLANNING_CATEGORY", objForm.Fields("PlanningCategory").Value)
   end if
   ...
   '//
   strProcedure = "mfjpln_for_format02_excel02.main"
   ...
   strSaved = strSaved & "<input type=""hidden"" name=""PlanningCategoryText"" value=""" & objForm.Fields("PlanningCategoryText").Value & """>"
...
'//////////////////////////
sub PaintPrompt()%>
<!--#include file="mfjpln_for_accuracy_material_prompt.inc"-->
<%end sub
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="mfjpln_for_accuracy_material_select.inc"-->
<%end sub
