...
'// Script  : mfjpln_for_variant_brand.asp                       //
'// Author  : Softstep Pty Ltd                                   //
'// Date    : September 2003                                     //
'// Text    : This script paints the forecast variant brand      //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "mfjpln_for_variant_brand.asp"
   strHeading = "FORECAST VARIANT BRAND REPORT"
...
sub ProcessReport()
   ...
   '//
   strProcedure = "mfjpln_for_format02_excel05.main"
...
'//////////////////////////
sub PaintPrompt()%>
<!--#include file="mfjpln_for_variant_brand_prompt.inc"-->
<%end sub
