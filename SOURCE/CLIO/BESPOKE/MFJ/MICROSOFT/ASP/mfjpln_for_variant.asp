...
'// Script  : mfjpln_for_variant.asp                             //
'// Author  : Softstep Pty Ltd                                   //
'// Date    : September 2003                                     //
'// Text    : This script paints the forecast variant report     //
'//           selection interface                                //
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strTarget = "mfjpln_for_variant.asp"
   strHeading = "FORECAST VARIANT REPORT"
...
sub ProcessReport()
   ...
   '//
   strProcedure = "mfjpln_for_format02_excel01.main"
...
'//////////////////////////
sub PaintPrompt()%>
<!--#include file="mfjpln_for_variant_prompt.inc"-->
<%end sub
...
'//////////////////////////
sub PaintSelect()%>
<!--#include file="mfjpln_for_variant_select.inc"-->
<%end sub
