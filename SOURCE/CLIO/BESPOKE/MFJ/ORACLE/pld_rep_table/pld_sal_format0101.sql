...
comment on column pld_sal_format0101.prd_le_qty is 'Period latest estimate quantity';
comment on column pld_sal_format0101.prd_le_gsv is 'Period latest extimate gross sales value';
...
comment on column pld_sal_format0101.mth_le_qty is 'Month latest estimate quantity';
comment on column pld_sal_format0101.mth_le_gsv is 'Month latest extimate gross sales value';
