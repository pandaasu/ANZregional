...
/* View creation
/*-*/
create or replace force view material_list_price_view
   (SAP_MATERIAL_CODE,
    SAP_CNDTN_TYPE_CODE,
    SAP_SALES_ORG_CODE,
   ...
   SELECT SAP_MATERIAL_CODE, 
    ...
    FROM (SELECT T1.SAP_MATERIAL_CODE, 
           ...
           WHERE T2.SAP_MATERIAL_CODE = DECODE(T1.SAP_REP_ITEM_CODE,NULL,T1.SAP_MATERIAL_CODE,T1.SAP_REP_ITEM_CODE) AND  
                 ...
                 T1.SAP_BUS_SGMNT_CODE IN ('01','02','05','03') AND 
...
/* Authority
/*-*/
grant select on dw_app.material_list_price_view to bo_user;

/*-*/
/* Synonym
/*-*/
create or replace public synonym material_list_price_view for dw_app.material_list_price_view;
