...
/******************************************************************************/
/**
 Object : cust_secondary_view
 Owner  : dw_app

 DESCRIPTION
 -----------
 Data Warehouse - Customer Secondary View
...
/* View creation
/*-*/
create or replace force view dw_app.cust_secondary_view
   (sap_sales_org_code,
    sales_org_desc,
    sap_division_code,
    division_desc,
   ...
   select t3.sap_sales_org_code, 
    ...
    where t1.sap_partner_funcn_code = 'Z5' 
...
/* Authority
/*-*/
grant select on dw_app.cust_secondary_view to bo_user;

/*-*/
/* Synonym
/*-*/
create public synonym cust_secondary_view for dw_app.cust_secondary_view;
