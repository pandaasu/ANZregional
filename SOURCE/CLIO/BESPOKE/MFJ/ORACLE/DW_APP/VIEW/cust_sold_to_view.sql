...
/******************************************************************************/
/**
 Object : cust_sold_to_view
 Owner  : dw_app

 DESCRIPTION
 -----------
 Data Warehouse - Customer Sold To View
...
/* View creation
/*-*/
create or replace force view dw_app.cust_sold_to_view
   (sap_sales_org_code,
    sales_org_desc,
    sap_division_code,
    division_desc,
   ...
   select t3.sap_sales_org_code, 
    ...
    where t1.sap_partner_funcn_code = 'AG' 
...
/* Authority
/*-*/
grant select on dw_app.cust_sold_to_view to bo_user;

/*-*/
/* Synonym
/*-*/
create public synonym cust_sold_to_view for dw_app.cust_sold_to_view;
