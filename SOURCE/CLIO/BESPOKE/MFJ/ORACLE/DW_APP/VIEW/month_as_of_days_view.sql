...
/* View creation
/*-*/
create or replace force view month_as_of_days_view
   (ASOFDAYS) AS 
...
/* Authority
/*-*/
grant select on dw_app.month_as_of_days_view to bo_user;

/*-*/
/* Synonym
/*-*/
create or replace public synonym month_as_of_days_view for dw_app.month_as_of_days_view;
