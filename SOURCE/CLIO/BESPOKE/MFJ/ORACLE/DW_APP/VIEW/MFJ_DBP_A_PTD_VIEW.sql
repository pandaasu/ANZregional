...
/* View creation
/*-*/
create or replace force view mfj_dbp_a_ptd_view
...
WHERE
  ...
  AND  ( DD.MARS_DATE_PERIOD_DIM.MARS_PERIOD  =  ANY (SELECT TRUNC((max(DD.SALES_FACT.BILLING_YYYYPPDD)/100)) FROM DD.SALES_FACT) )
...
/* Authority
/*-*/
grant select on dw_app.mfj_dbp_a_ptd_view to bo_user;

/*-*/
/* Synonym
/*-*/
create or replace public synonym mfj_dbp_a_ptd_view for dw_app.mfj_dbp_a_ptd_view;
