...
/******************************************************************************/
/**
 Object : kpi_invoice_summary_prd_view
 Owner  : dw_app
...
/* View creation
/*-*/
create or replace force view dw_app.kpi_invoice_summary_prd_view
   (BILLING_YYYYPP,
    SAP_SALES_ORG_CODE,
   ...
   SELECT MAIN.BILLING_YYYYPP, 
     ...
     FROM PLANT_DIM PT, 
          ...
          (SELECT BILLING_YYYYPP, 
             ...
             FROM (SELECT MD.MARS_PERIOD AS BILLING_YYYYPP, 
                   ...
                   SELECT BILLING_YYYYPP, 
                     ...
                     FROM (SELECT DISTINCT 
                                  MD.MARS_PERIOD AS BILLING_YYYYPP, 
                                  SF.SAP_SALES_DTL_SALES_ORG_CODE, 
                                  SF.SAP_SALES_DTL_DISTBN_CHNL_CODE, 
                                  SF.SAP_SALES_DTL_DIVISION_CODE, 
                                  SF.SAP_PLANT_CODE, 
...
/* Authority
/*-*/
grant select on dw_app.kpi_invoice_summary_prd_view to public;

/*-*/
/* Synonym
/*-*/
create or replace public synonym kpi_invoice_summary_prd_view for dw_app.kpi_invoice_summary_prd_view;