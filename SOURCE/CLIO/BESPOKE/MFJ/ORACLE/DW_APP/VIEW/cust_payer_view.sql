...
/******************************************************************************/
/**
 Object : cust_payer_view
 Owner  : dw_app

 DESCRIPTION
 -----------
 Data Warehouse - Customer Payer View
...
/* View creation
/*-*/
create or replace force view dw_app.cust_payer_view
   (sap_sales_org_code,
    sales_org_desc,
    sap_division_code,
    division_desc,
   ...
   select t3.sap_sales_org_code, 
    ...
    where t1.sap_partner_funcn_code = 'RG' 
...
/* Authority
/*-*/
grant select on dw_app.cust_payer_view to bo_user;

/*-*/
/* Synonym
/*-*/
create public synonym cust_payer_view for dw_app.cust_payer_view;
