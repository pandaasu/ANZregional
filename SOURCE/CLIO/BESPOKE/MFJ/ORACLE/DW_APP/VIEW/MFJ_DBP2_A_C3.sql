...
/* View creation
/*-*/
create or replace force view mfj_dbp2_a_c3
...
FROM
  ...
  DD.MATERIAL_DIM
WHERE
  ( DD.SALES_FACT.SAP_BILLING_DATE >= DW_APP.MAX_MIN_REQD_DLVRY_DATE.MIN_REQD_DLVRY_DATE AND
...
/* Authority
/*-*/
grant select on dw_app.mfj_dbp2_a_c3 to bo_user;

/*-*/
/* Synonym
/*-*/
create or replace public synonym mfj_dbp2_a_c3 for dw_app.mfj_dbp2_a_c3;
