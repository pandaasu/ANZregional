...
create or replace package body dw_forecast_aggregation as
   ...
   exception
      ...
      when others then
         ...
         /*-*/
         raise_application_error(-20000, 'FATAL ERROR - CLIO - DW_FORECAST_AGGREGATION - ' || substr(SQLERRM, 1, 1024));
      ...
      loop
         ...
         insert into fcst_month_01_fact
            ...
            select fcst_yyyymm,
                   ...
                   sum(le_base_price_value),
                   sum(le_gsv_value),
                   sum(decode(le_base_price_qty,0,le_gsv_qty,le_base_price_qty))
              from (select t01.fcst_yyyymm,
                           ...
                           0 as op_gsv_qty,
                           sum(nvl(decode(t01.fcst_price_type_code,1,decode(t01.fcst_type_code,5,t01.fcst_value)),0)) as le_base_price_value,
                           sum(nvl(decode(t01.fcst_price_type_code,2,decode(t01.fcst_type_code,5,t01.fcst_value)),0)) as le_gsv_value,
                           sum(nvl(decode(t01.fcst_price_type_code,1,decode(t01.fcst_type_code,5,t01.fcst_qty)),0)) as le_base_price_qty,
                           sum(nvl(decode(t01.fcst_price_type_code,2,decode(t01.fcst_type_code,5,t01.fcst_qty)),0)) as le_gsv_qty
                      from fcst_month t01,
                           fcst_type t02,
                           fcst_price_type t03
                    ...
                    select t01.fcst_yyyymm,
                           ...
                           0 as le_base_price_value,
                           0 as le_gsv_value,
                           0 as le_base_price_qty,
                           0 as le_gsv_qty
                      from fcst_month t01,
                           fcst_type t02,
                           fcst_price_type t03
         ...
         insert into fcst_period_01_fact
            ...
            select fcst_yyyypp,
              ...
              from (select t01.fcst_yyyypp,
                           ...
                           0 as op_base_price_qty,
                           0 as op_gsv_qty,
                           sum(nvl(decode(t01.fcst_price_type_code,1,decode(t01.fcst_type_code,6,t01.fcst_value)),0)) as le_base_price_value,
                           sum(nvl(decode(t01.fcst_price_type_code,2,decode(t01.fcst_type_code,6,t01.fcst_value)),0)) as le_gsv_value,
                           sum(nvl(decode(t01.fcst_price_type_code,1,decode(t01.fcst_type_code,6,t01.fcst_qty)),0)) as le_base_price_qty,
                           sum(nvl(decode(t01.fcst_price_type_code,2,decode(t01.fcst_type_code,6,t01.fcst_qty)),0)) as le_gsv_qty
                      from fcst_period t01,
                           fcst_type t02,
                           fcst_price_type t03
                     where t01.fcst_type_code = t02.fcst_type_code
