...
/* Package : mfjpln_sal_format13_excel01                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format13_excel01 as

/**DESCRIPTION**
 Combined Business Full Year - SAP billing date aggregations.
...
end mfjpln_sal_format13_excel01;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format13_excel01 as
   ...
   begin
      ...
      /*-*/
      open pld_sal_format13_c01 for var_dynamic_sql using var_sap_company_code, var_sap_company_code, par_sap_bus_sgmnt_code;
      loop
         if var_for_type = 'PRD' then
...
/**************************/
create or replace public synonym mfjpln_sal_format13_excel01 for pld_rep_app.mfjpln_sal_format13_excel01;
grant execute on mfjpln_sal_format13_excel01 to public;