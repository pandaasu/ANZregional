...
/* Package : mfjpln_for_format02_extract                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_for_format02_extract as
...
end mfjpln_for_format02_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_for_format02_extract as
   ...
   begin
      ...
      /**/
      mfjpln_truncate.truncate_table('pld_for_format0200');
      mfjpln_truncate.truncate_table('pld_for_format0201');
      mfjpln_truncate.truncate_table('pld_for_format0202');
      mfjpln_truncate.truncate_table('pld_for_format0203');
      mfjpln_truncate.truncate_table('pld_for_format0204');
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_for_format0200
         (extract_date)
         values(sysdate);
         ...
         select t01.sap_material_code,
           ...
           from material_dim t01,
                ...
                (select distinct(t01.sap_material_code) as sap_material_code
                 ...
                 union
                 select distinct(t01.sap_material_code) as sap_material_code
                   from pld_for_format0204 t01) t03
   ...
   begin
      ...
      loop
         ...
         insert into pld_for_format0201
            (sap_material_code,
             planning_status,
             planning_type,
             planning_cat_old,
   ...
   begin
      ...
      loop
         ...
         insert into pld_for_format0203
            (sap_material_code,
             casting_yyyypp,
             fcst_yyyypp,
             case_qty)
      ...
      loop
         ...
         insert into pld_for_format0204
            (sap_material_code,
             casting_yyyymm,
             fcst_yyyymm,
             case_qty)
      ...
      cursor sales_period_01_fact_c01 is 
         select t01.sap_material_code,
           ...
           from sales_period_01_fact t01,
                material_dim t02
          where t01.sap_material_code = t02.sap_material_code
            and t01.billing_yyyypp >= var_rolling_yyyypp
      ...
      cursor sales_month_01_fact_c01 is 
         select t01.sap_material_code,
           ...
           from sales_month_01_fact t01,
                material_dim t02
          where t01.sap_material_code = t02.sap_material_code
            and t01.billing_yyyymm >= var_rolling_yyyymm
...
/**************************/
create or replace public synonym mfjpln_for_format02_extract for pld_rep_app.mfjpln_for_format02_extract;
grant execute on mfjpln_for_format02_extract to public;