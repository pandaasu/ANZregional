...
/* Package : mfjpln_sal_format03_extract                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format03_extract as

/**DESCRIPTION**
 Sales Extract Format 03 - Invoice date aggregations.
...
end mfjpln_sal_format03_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format03_extract as
   ...
   begin
      ...
      /**/
      mfjpln_truncate.truncate_table('pld_sal_format0300');
      mfjpln_truncate.truncate_table('pld_sal_format0301');
      mfjpln_truncate.truncate_table('pld_sal_format0302');
      mfjpln_truncate.truncate_table('pld_sal_format0303');
      mfjpln_truncate.truncate_table('pld_sal_format0304');
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_format0300
         (extract_date,
          logical_date,
          current_YYYYPP,
          current_YYYYMM,
   ...
   begin
      ...
      /*-*/
      select current_YYYYPP into var_current_YYYYPP from pld_sal_format0300;
      select current_YYYYMM into var_current_YYYYMM from pld_sal_format0300;
   ...
   procedure createMaterialPeriodHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format0301_c01 is 
         select 'x'
         from pld_sal_format0301
         where pld_sal_format0301.sap_company_code = par_sap_company_code
           and pld_sal_format0301.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format0301_c01;
      fetch pld_sal_format0301_c01 into var_work;
      if pld_sal_format0301_c01%notfound then
         insert into pld_sal_format0301
            (sap_company_code,
             sap_material_code,
             tot_ty_qty,
             tot_ty_ton,
   ...
   procedure createMaterialMonthHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format0302_c01 is 
         select 'x'
         from pld_sal_format0302
         where pld_sal_format0302.sap_company_code = par_sap_company_code
           and pld_sal_format0302.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format0302_c01;
      fetch pld_sal_format0302_c01 into var_work;
      if pld_sal_format0302_c01%notfound then
         insert into pld_sal_format0302
            (sap_company_code,
             sap_material_code,
             tot_ty_qty,
             tot_ty_ton,
   ...
   procedure createMaterialPeriodDetail(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format0303_c01 is 
         select 'x'
         from pld_sal_format0303
         where pld_sal_format0303.sap_company_code = par_sap_company_code
           and pld_sal_format0303.sap_material_code = par_sap_material_code
           and pld_sal_format0303.billing_YYYYPP = par_billing_YYYYPP;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format0303_c01;
      fetch pld_sal_format0303_c01 into var_work;
      if pld_sal_format0303_c01%notfound then
         insert into pld_sal_format0303
            (sap_company_code,
             sap_material_code,
             billing_YYYYPP,
             ty_qty,
   ...
   procedure createMaterialMonthDetail(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format0304_c01 is 
         select 'x'
         from pld_sal_format0304
         where pld_sal_format0304.sap_company_code = par_sap_company_code
           and pld_sal_format0304.sap_material_code = par_sap_material_code
           and pld_sal_format0304.billing_YYYYMM = par_billing_YYYYMM;
   ...
   begin 
      ...
      /*-*/
      open pld_sal_format0304_c01;
      fetch pld_sal_format0304_c01 into var_work;
      if pld_sal_format0304_c01%notfound then
         insert into pld_sal_format0304
            (sap_company_code,
             sap_material_code,
             billing_YYYYMM,
             ty_qty,
...
/**************************/
create or replace public synonym mfjpln_sal_format03_extract for pld_rep_app.mfjpln_sal_format03_extract;
grant execute on mfjpln_sal_format03_extract to public;