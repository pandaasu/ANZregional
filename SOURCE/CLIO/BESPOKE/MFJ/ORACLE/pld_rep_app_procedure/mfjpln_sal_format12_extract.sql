...
/* Package : mfjpln_sal_format12_extract                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format12_extract as

/**DESCRIPTION**
 Sales Extract Format 12 - SAP Billing date aggregations.
...
end mfjpln_sal_format12_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format12_extract as
   ...
   begin
      ...
      /**/
      mfjpln_truncate.truncate_table('pld_sal_format1200');
      mfjpln_truncate.truncate_table('pld_sal_format1201');
      mfjpln_truncate.truncate_table('pld_sal_format1202');
      mfjpln_truncate.truncate_table('pld_sal_format1203');
      mfjpln_truncate.truncate_table('pld_sal_format1204');
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_format1200
         (extract_date,
          logical_date,
          current_YYYYPP,
          current_YYYYMM,
   ...
   begin
      ...
      /*-*/
      select current_YYYYPP into var_current_YYYYPP from pld_sal_format1200;
      select current_YYYYMM into var_current_YYYYMM from pld_sal_format1200;
   ...
   procedure createMaterialPeriodHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format1201_c01 is 
         select 'x'
         from pld_sal_format1201
         where pld_sal_format1201.sap_company_code = par_sap_company_code
           and pld_sal_format1201.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format1201_c01;
      fetch pld_sal_format1201_c01 into var_work;
      if pld_sal_format1201_c01%notfound then
         insert into pld_sal_format1201
            (sap_company_code,
             sap_material_code,
             ytd_ty_qty,
             ytd_ty_ton,
   ...
   procedure createMaterialMonthHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format1202_c01 is 
         select 'x'
         from pld_sal_format1202
         where pld_sal_format1202.sap_company_code = par_sap_company_code
           and pld_sal_format1202.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format1202_c01;
      fetch pld_sal_format1202_c01 into var_work;
      if pld_sal_format1202_c01%notfound then
         insert into pld_sal_format1202
            (sap_company_code,
             sap_material_code,
             ytd_ty_qty,
             ytd_ty_ton,
   ...
   procedure createMaterialPeriodDetail(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format1203_c01 is 
         select 'x'
         from pld_sal_format1203
         where pld_sal_format1203.sap_company_code = par_sap_company_code
           and pld_sal_format1203.sap_material_code = par_sap_material_code
           and pld_sal_format1203.billing_YYYYPP = par_billing_YYYYPP;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format1203_c01;
      fetch pld_sal_format1203_c01 into var_work;
      if pld_sal_format1203_c01%notfound then
         insert into pld_sal_format1203
            (sap_company_code,
             sap_material_code,
             billing_YYYYPP,
             ty_qty,
   ...
   procedure createMaterialMonthDetail(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions */
      /*-*/
      cursor pld_sal_format1204_c01 is 
         select 'x'
         from pld_sal_format1204
         where pld_sal_format1204.sap_company_code = par_sap_company_code
           and pld_sal_format1204.sap_material_code = par_sap_material_code
           and pld_sal_format1204.billing_YYYYMM = par_billing_YYYYMM;
   ...
   begin 
      ...
      /*-*/
      open pld_sal_format1204_c01;
      fetch pld_sal_format1204_c01 into var_work;
      if pld_sal_format1204_c01%notfound then
         insert into pld_sal_format1204
            (sap_company_code,
             sap_material_code,
             billing_YYYYMM,
             ty_qty,
...
/**************************/
create or replace public synonym mfjpln_sal_format12_extract for pld_rep_app.mfjpln_sal_format12_extract;
grant execute on mfjpln_sal_format12_extract to public;