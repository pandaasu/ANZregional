...
/* Package : mfjpln_for_format03_excel02                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_for_format03_excel02 as
...
end mfjpln_for_format03_excel02;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_for_format03_excel02 as
                  ...
                  if tblForecast(idx).for_category = '0' then
                     ...
                     if var_wrk_count = 1 then
                        if var_sav_w101_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w101_val-var_sav_w201_val)/var_sav_w101_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w102_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w102_val-var_sav_w202_val)/var_sav_w102_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w103_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w103_val-var_sav_w203_val)/var_sav_w103_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w104_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w104_val-var_sav_w204_val)/var_sav_w104_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w105_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w105_val-var_sav_w205_val)/var_sav_w105_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w106_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w106_val-var_sav_w206_val)/var_sav_w106_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w107_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w107_val-var_sav_w207_val)/var_sav_w107_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w108_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w108_val-var_sav_w208_val)/var_sav_w108_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w109_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w109_val-var_sav_w209_val)/var_sav_w109_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w110_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w110_val-var_sav_w210_val)/var_sav_w110_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w111_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w111_val-var_sav_w211_val)/var_sav_w111_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w112_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w112_val-var_sav_w212_val)/var_sav_w112_val)*100,2),'FM9999990.00');
                        else
                        ...
                        if var_sav_w113_val <> 0 then
                           var_wrk_array := var_wrk_array || chr(9) || to_char(round((1-abs(var_sav_w113_val-var_sav_w213_val)/var_sav_w113_val)*100,2),'FM9999990.00');
                        else
...
/**************************/
create or replace public synonym mfjpln_for_format03_excel02 for pld_rep_app.mfjpln_for_format03_excel02;
grant execute on mfjpln_for_format03_excel02 to public;