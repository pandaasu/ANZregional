...
/* Package : mfjpln_sal_format01_excel04                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format01_excel04 as

/**DESCRIPTION**
 Combined Shipment Report - Invoice date aggregations.
...
end mfjpln_sal_format01_excel04;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format01_excel04 as
   ...
   var_details boolean;
   var_sap_company_code varchar2(6);
   var_for_type varchar2(6);
   ...
   begin
      ...
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Combined Shipment Report - Period - BR Forecast (Yen Millions) - Invoice Date';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Combined Shipment Report - Period - LE Forecast (Yen Millions) - Invoice Date';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Combined Shipment Report - Month - BR Forecast (Yen Millions) - Invoice Date';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Combined Shipment Report - Month - LE Forecast (Yen Millions) - Invoice Date';
      end if;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format01_c01 for var_dynamic_sql using var_sap_company_code, par_sap_bus_sgmnt_code;
      loop
...
/**************************/
create or replace public synonym mfjpln_sal_format01_excel04 for pld_rep_app.mfjpln_sal_format01_excel04;
grant execute on mfjpln_sal_format01_excel04 to public;