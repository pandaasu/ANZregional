...
/* Package : mfjpln_sal_format11_excel02                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format11_excel02 as

/**DESCRIPTION**
 Slow Sales Report - SAP billing date aggregations.
...
end mfjpln_sal_format11_excel02;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format11_excel02 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Slow Sales Report - Period - BR Forecast (Yen Millions) - Delivery Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Slow Sales Report - Period - LE Forecast (Yen Millions) - Delivery Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Slow Sales Report - Month - BR Forecast (Yen Millions) - Delivery Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Slow Sales Report - Month - LE Forecast (Yen Millions) - Delivery Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      end if;
...
/**************************/
create or replace public synonym mfjpln_sal_format11_excel02 for pld_rep_app.mfjpln_sal_format11_excel02;
grant execute on mfjpln_sal_format11_excel02 to public;