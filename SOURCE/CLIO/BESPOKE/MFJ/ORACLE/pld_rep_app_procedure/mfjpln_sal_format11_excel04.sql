...
/* Package : mfjpln_sal_format11_excel04                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format11_excel04 as

/**DESCRIPTION**
 Combined Sales Report - SAP billing date aggregations.
...
end mfjpln_sal_format11_excel04;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format11_excel04 as
   ...
   begin
      ...
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Combined Sales Report - Period - BR Forecast (Yen Millions) - Delivery Date';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Combined Sales Report - Period - LE Forecast (Yen Millions) - Delivery Date';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Combined Sales Report - Month - BR Forecast (Yen Millions) - Delivery Date';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Combined Sales Report - Month - LE Forecast (Yen Millions) - Delivery Date';
      end if;
      ...
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'PTD (Delv)';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'PTD (Delv)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'MTD (Delv)';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'MTD (Delv)';
      end if;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format11_c01 for var_dynamic_sql using var_sap_company_code, par_sap_bus_sgmnt_code;
      loop
...
/**************************/
create or replace public synonym mfjpln_sal_format11_excel04 for pld_rep_app.mfjpln_sal_format11_excel04;
grant execute on mfjpln_sal_format11_excel04 to public;