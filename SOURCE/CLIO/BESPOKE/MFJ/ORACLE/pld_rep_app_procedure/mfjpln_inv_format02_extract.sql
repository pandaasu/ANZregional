...
/* Package : mfjpln_inv_format02_extract                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_inv_format02_extract as
...
end mfjpln_inv_format02_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_inv_format02_extract as
   ...
   begin
      ...
      /**/
      mfjpln_truncate.truncate_table('pld_inv_format0200');
      mfjpln_truncate.truncate_table('pld_inv_format0201');
      mfjpln_truncate.truncate_table('pld_inv_format0202');
      commit;
   ...
   begin
      ...
      /*-*/
      select current_YYYYPP into var_current_YYYYPP from pld_inv_format0200;
      select current_YYYYMM into var_current_YYYYMM from pld_inv_format0200;
   ...
   begin
      ...
      /*-*/
      select inventory_date into var_blnc_date from pld_inv_format0200;
...
/**************************/
create or replace public synonym mfjpln_inv_format02_extract for pld_rep_app.mfjpln_inv_format02_extract;
grant execute on mfjpln_inv_format02_extract to public;