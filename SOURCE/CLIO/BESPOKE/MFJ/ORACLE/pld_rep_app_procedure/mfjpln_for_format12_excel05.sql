...
/* Package : mfjpln_for_format12_excel05                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_for_format12_excel05 as

/**DESCRIPTION**
 Forecast Variant Brand Report - SAP billing date aggregations.
...
end mfjpln_for_format12_excel05;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_for_format12_excel05 as
   ...
   begin
      ...
      /*-*/
      var_wrk_string := 'Forecast Variant Brand Report - Delivery Date';
...
/**************************/
create or replace public synonym mfjpln_for_format12_excel05 for pld_rep_app.mfjpln_for_format12_excel05;
grant execute on mfjpln_for_format12_excel05 to public;