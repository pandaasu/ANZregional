...
/* Package : mfjpln_sal_format12_excel01                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format12_excel01 as

/**DESCRIPTION**
 YTD Performance Report - SAP billing date aggregations.
...
end mfjpln_sal_format12_excel01;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format12_excel01 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' or var_for_type = 'PRD_LE' then
         open pld_sal_format12_c01 for var_dynamic_sql using var_sap_company_code, var_previous_YYYYPP, var_sap_company_code, par_sap_bus_sgmnt_code;
      elsif var_for_type = 'MTH_BR' or var_for_type = 'MTH_LE' then
         open pld_sal_format12_c01 for var_dynamic_sql using var_sap_company_code, var_previous_YYYYMM, var_sap_company_code, par_sap_bus_sgmnt_code;
      end if;
      loop
...
/**************************/
create or replace public synonym mfjpln_sal_format12_excel01 for pld_rep_app.mfjpln_sal_format12_excel01;
grant execute on mfjpln_sal_format12_excel01 to public;