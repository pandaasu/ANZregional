...
/* Package : mfjpln_inv_format02_excel04                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_inv_format02_excel04 as

/**DESCRIPTION**
 No Forecast Product Restricted Inventory Report - Invoice date aggregations.
...
end mfjpln_inv_format02_excel04;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_inv_format02_excel04 as

   /*-*/
   /* Private global declarations */
   /*-*/
   procedure doDetail;
   procedure doDetailDate(par_inv_exp_date in date, par_sap_material_code in varchar2, par_inv_class02 in varchar2);
   ...
   type rcdWarehouse is record(sap_plant_code varchar2(4 char),
                               ...
                               inv_res_qty number(22,0),
                               inv_res_val number(22,0));
   ...
   begin
      ...
      var_dynamic_sql := 'select t01.sap_plant_code
                           ...
                           where t01.sap_material_code = t02.sap_material_code(+)
                             ...
                             and (t01.inv_res_qty <> 0 or
                                  t01.inv_res_val <> 0)
                             and not exists (select ''x'' from pld_inv_format0201 t11
      ...
      loop
         ...
         tblWarehouse(var_wrk_count).inv_res_qty := 0;
         tblWarehouse(var_wrk_count).inv_res_val := 0;
      end loop;
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Period - BR Forecast (Yen Millions)';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Period - LE Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Month - BR Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Month - LE Forecast (Yen Millions)';
      end if;
   ...
   begin
      ...
      if var_srt_type = 'DIS' then
         var_grp_literal := 't01.inv_class02,
                             t01.sap_material_code,
                             t01.inv_exp_date';
         var_srt_literal := 't01.inv_class02 asc,
                             sort_desc asc,
      ...
      /*-*/
      /* Retrieve the restricted inventory with no forecasts */
      /*-*/
      var_dynamic_sql := 'select t01.inv_class02,
                                 t01.inv_exp_date,
                                 t01.sap_material_code,
      ...
      /*-*/
      /* Retrieve the restricted inventory rows */
      /*-*/
      open pld_inv_format0202_c01 for var_dynamic_sql using var_sap_company_code, var_sap_bus_sgmnt_code;
      loop
         fetch pld_inv_format0202_c01 into var_inv_class02,
                                           var_inv_exp_date,
         ...
         /*-*/
         doDetailDate(var_inv_exp_date, var_sap_material_code, var_inv_class02);
   ...
   /***************************************************/
   procedure doDetailDate(par_inv_exp_date in date, par_sap_material_code in varchar2, par_inv_class02 in varchar2) is

      /*-*/
      /* Variable definitions */
      /*-*/
      var_sap_plant_code varchar2(4 char);
      var_inv_res_qty number(22,0);
      var_inv_res_val number(22,0);
      var_wrk_string varchar2(2048 char);
   ...
   begin
      ...
      /*-*/
      for idx in 1..tblWarehouse.count loop
         tblWarehouse(idx).inv_res_qty := 0;
         tblWarehouse(idx).inv_res_val := 0;
      end loop;

      /*-*/
      /* Retrieve the restricted warehouse rows */
      /*-*/
      var_dynamic_sql := 'select t01.sap_plant_code,
                                 t01.inv_res_qty,
                                 t01.inv_res_val
                           ...
                           where t01.sap_company_code = :A
                             ...
                             and t01.inv_class02 = :C
                             and t01.inv_exp_date = :D
                             and (t01.inv_res_qty <> 0 or
                                  t01.inv_res_val <> 0)
                        order by t01.sap_plant_code asc';
      open pld_inv_format0202_c02 for var_dynamic_sql using var_sap_company_code, par_sap_material_code, par_inv_class02, par_inv_exp_date;
      loop
         ...
         for idx in 1..tblWarehouse.count loop
            if tblWarehouse(idx).sap_plant_code = var_sap_plant_code then
               tblWarehouse(idx).inv_res_qty := var_inv_res_qty;
               tblWarehouse(idx).inv_res_val := var_inv_res_val;
            end if;
         end loop;
      end loop;
      ...
      /*-*/
      for idx in 1..tblWarehouse.count loop
         var_wrk_array := var_wrk_array || chr(9) || to_char(tblWarehouse(idx).inv_res_qty,'FM999999999999990') || chr(9) || to_char(tblWarehouse(idx).inv_res_val/1000000,'FM999999990.000000');
      end loop;
...
/**************************/
create or replace public synonym mfjpln_inv_format02_excel04 for pld_rep_app.mfjpln_inv_format02_excel04;
grant execute on mfjpln_inv_format02_excel04 to public;