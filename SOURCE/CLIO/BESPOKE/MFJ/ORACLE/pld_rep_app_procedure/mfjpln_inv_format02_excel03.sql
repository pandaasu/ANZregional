...
/* Package : mfjpln_inv_format02_excel03                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_inv_format02_excel03 as

/**DESCRIPTION**
 No Forecast Product Unrestricted Inventory Report - Invoice date aggregations.
...
end mfjpln_inv_format02_excel03;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_inv_format02_excel03 as
   ...
   type rcdWarehouse is record(sap_plant_code varchar2(4 char),
                               ...
                               inv_unr_qty number(22,0),
                               inv_unr_val number(22,0));
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Period - BR Forecast (Yen Millions)';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Period - LE Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Month - BR Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Month - LE Forecast (Yen Millions)';
      end if;
   ...
   begin
      ...
      /*-*/
      /* Retrieve the unrestricted inventory with no forecasts */
      /*-*/
   ...
   procedure doDetailDate(par_inv_exp_date in date, par_sap_material_code in varchar2, par_inv_class02 in varchar2) is
      ...
      /*-*/
      var_sap_plant_code varchar2(4 char);
      var_inv_unr_qty number(22,0);
      var_inv_unr_val number(22,0);
      var_wrk_string varchar2(2048 char);
   ...
   begin
      ...
      /*-*/
      for idx in 1..tblWarehouse.count loop
         var_wrk_array := var_wrk_array || chr(9) || to_char(tblWarehouse(idx).inv_unr_qty,'FM999999999999990') || chr(9) || to_char(tblWarehouse(idx).inv_unr_val/1000000,'FM999999990.000000');
      end loop;
...
/**************************/
create or replace public synonym mfjpln_inv_format02_excel03 for pld_rep_app.mfjpln_inv_format02_excel03;
grant execute on mfjpln_inv_format02_excel03 to public;