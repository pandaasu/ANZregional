...
/* Package : mfjpln_inv_format02_excel02                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_inv_format02_excel02 as

/**DESCRIPTION**
 Forecast Product Restricted Inventory Report - Invoice date aggregations.
 ...
 **NOTES**
 1. The material is ignored when there is no restricted quantity and value
...
end mfjpln_inv_format02_excel02;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_inv_format02_excel02 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Forecast Product Restricted Inventory Report - Period - BR Forecast (Yen Millions)';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Forecast Product Restricted Inventory Report - Period - LE Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Forecast Product Restricted Inventory Report - Month - BR Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Forecast Product Restricted Inventory Report - Month - LE Forecast (Yen Millions)';
      end if;
   ...
   begin
      ...
      /*-*/
      /* Retrieve the restricted inventory with forecasts */
      /*-*/
...
/**************************/
create or replace public synonym mfjpln_inv_format02_excel02 for pld_rep_app.mfjpln_inv_format02_excel02;
grant execute on mfjpln_inv_format02_excel02 to public;