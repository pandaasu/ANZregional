...
/* Package : mfjpln_sal_format01_excel01                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format01_excel01 as

/**DESCRIPTION**
 Standard Shipment Report - Invoice date aggregations.
...
end mfjpln_sal_format01_excel01;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format01_excel01 as
   ...
   begin
      ...
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Standard Shipment Report - Period - BR Forecast (Yen Millions) - Invoice Date';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Standard Shipment Report - Period - LE Forecast (Yen Millions) - Invoice Date';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Standard Shipment Report - Month - BR Forecast (Yen Millions) - Invoice Date';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Standard Shipment Report - Month - LE Forecast (Yen Millions) - Invoice Date';
      end if;
   ...
   begin
      ...
      /*-*/
      open pld_sal_format01_c01 for var_dynamic_sql using var_sap_company_code, var_sap_bus_sgmnt_code;
      loop
...
/**************************/
create or replace public synonym mfjpln_sal_format01_excel01 for pld_rep_app.mfjpln_sal_format01_excel01;
grant execute on mfjpln_sal_format01_excel01 to public;