...
/* Package : mfjpln_inv_format01_excel02                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_inv_format01_excel02 as
...
end mfjpln_inv_format01_excel02;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_inv_format01_excel02 as
   ...
   begin
      ...
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Finished Goods Inventory Shortage Exceptions Report (less than ' || to_char(var_stock_short_cover,'FM90') || ' weeks cover) - Period - BR Forecast (Yen Millions)';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Finished Goods Inventory Shortage Exceptions Report (less than ' || to_char(var_stock_short_cover,'FM90') || ' weeks cover) - Period - LE Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Finished Goods Inventory Shortage Exceptions Report (less than ' || to_char(var_stock_short_cover,'FM90') || ' weeks cover) - Month - BR Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Finished Goods Inventory Shortage Exceptions Report (less than ' || to_char(var_stock_short_cover,'FM90') || ' weeks cover) - Month - LE Forecast (Yen Millions)';
      end if;
...
/**************************/
create or replace public synonym mfjpln_inv_format01_excel02 for pld_rep_app.mfjpln_inv_format01_excel02;
grant execute on mfjpln_inv_format01_excel02 to public;