...
/* Package : mfjpln_for_format11_excel01                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_for_format11_excel01 as

/**DESCRIPTION**
 Order Variant Report - SAP billing date aggregations.
...
end mfjpln_for_format11_excel01;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_for_format11_excel01 as
   ...
   begin
      ...
      /*-*/
      var_wrk_string := 'Order Variant Report - Delivery Date';
      ...
      if var_for_type = 'PRD' then
         ...
         if var_rep_summary = 'N' then
            var_dynamic_sql := 'select t02.sap_material_code,
                                  ...
                                  from pld_variable t01,
                                       material_dim t02,
                                       pld_for_format1101 t03,
                                       (select t01.sap_material_code sap_material_code
                                               ' || var_for_literal || '
                                          from pld_for_format1103 t01
...
/**************************/
create or replace public synonym mfjpln_for_format11_excel01 for pld_rep_app.mfjpln_for_format11_excel01;
grant execute on mfjpln_for_format11_excel01 to public;