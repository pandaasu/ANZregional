...
/* Package : mfjpln_sal_format02_excel04                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format02_excel04 as

/**DESCRIPTION**
 Operating Plan Report - Invoice date aggregations.
...
end mfjpln_sal_format02_excel04;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format02_excel04 as
   ...
   begin
      ...
      loop
         if var_for_type = 'PRD' then
            fetch pld_sal_format02_c01 into var_yee_ly_val,
                                            var_yee_op_val,
                                            var_w01_val,
                                            var_w02_val,
                                            var_w03_val,
...
/**************************/
create or replace public synonym mfjpln_sal_format02_excel04 for pld_rep_app.mfjpln_sal_format02_excel04;
grant execute on mfjpln_sal_format02_excel04 to public;