...
/* Package : mfjpln_inv_format02_excel01                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_inv_format02_excel01 as
...
end mfjpln_inv_format02_excel01;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_inv_format02_excel01 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Forecast Product Unrestricted Inventory Report - Period - BR Forecast (Yen Millions)';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Forecast Product Unrestricted Inventory Report - Period - LE Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Forecast Product Unrestricted Inventory Report - Month - BR Forecast (Yen Millions)';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Forecast Product Unrestricted Inventory Report - Month - LE Forecast (Yen Millions)';
      end if;
...
/**************************/
create or replace public synonym mfjpln_inv_format02_excel01 for pld_rep_app.mfjpln_inv_format02_excel01;
grant execute on mfjpln_inv_format02_excel01 to public;