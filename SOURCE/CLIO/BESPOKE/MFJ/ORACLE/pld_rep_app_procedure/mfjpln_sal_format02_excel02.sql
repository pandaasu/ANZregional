...
/* Package : mfjpln_sal_format02_excel02                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format02_excel02 as

/**DESCRIPTION**
 Combined Business YEE - Invoice date aggregations.
...
end mfjpln_sal_format02_excel02;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format02_excel02 as
   ...
   begin
      ...
      /*-*/
      open pld_sal_format02_c01 for var_dynamic_sql using var_sap_company_code, var_sap_company_code, par_sap_bus_sgmnt_code;
      loop
         if var_for_type = 'PRD_BR' or var_for_type = 'PRD_LE' then
...
/**************************/
create or replace public synonym mfjpln_sal_format02_excel02 for pld_rep_app.mfjpln_sal_format02_excel02;
grant execute on mfjpln_sal_format02_excel02 to public;