...
/* Package : mfjpln_sal_format01_extract                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format01_extract as
...
end mfjpln_sal_format01_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format01_extract as
   ...
   begin
      ...
      /**/
      mfjpln_truncate.truncate_table('pld_sal_format0100');
      mfjpln_truncate.truncate_table('pld_sal_format0101');
      commit;
   ...
   procedure exe_sales_data is
      ...
      cursor sales_fact_c01 is 
         ...
         from sales_fact
         where sales_fact.billing_date >= var_logical_date
   ...
   begin
      ...
      /*-*/
      select trunc(logical_date) into var_logical_date from pld_sal_format0100;
      select current_YYYYPP into var_current_YYYYPP from pld_sal_format0100;
      select current_YYYYMM into var_current_YYYYMM from pld_sal_format0100;
...
/**************************/
create or replace public synonym mfjpln_sal_format01_extract for pld_rep_app.mfjpln_sal_format01_extract;
grant execute on mfjpln_sal_format01_extract to public;