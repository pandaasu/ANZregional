...
/* Package : mfjpln_sal_format01_excel03                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format01_excel03 as
...
end mfjpln_sal_format01_excel03;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format01_excel03 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Excess Shipment Report - Period - BR Forecast (Yen Millions) - Invoice Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'PRD_LE' then
         var_wrk_string := 'Excess Shipment Report - Period - LE Forecast (Yen Millions) - Invoice Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Excess Shipment Report - Month - BR Forecast (Yen Millions) - Invoice Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_LE' then
         var_wrk_string := 'Excess Shipment Report - Month - LE Forecast (Yen Millions) - Invoice Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      end if;
...
/**************************/
create or replace public synonym mfjpln_sal_format01_excel03 for pld_rep_app.mfjpln_sal_format01_excel03;
grant execute on mfjpln_sal_format01_excel03 to public;
