...
/* Package : mfjpln_sal_format02_excel03                        */
...
/* Package Header */
/******************/
create or replace package mfjpln_sal_format02_excel03 as

/**DESCRIPTION**
 Business Segment YEE - Invoice date aggregations.
...
end mfjpln_sal_format02_excel03;
/

/****************/
/* Package Body */
/****************/
create or replace package body mfjpln_sal_format02_excel03 as
   ...
   begin
      ...
      /*-*/
      var_wrk_string := 'Business Segment YEE';
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' or var_for_type = 'PRD_LE' then
         var_dynamic_sql := 'select t01.ytd_ty_val,
                                    t01.ytd_ly_val,
                                    t01.ytd_op_val,
                                    t01.ytd_fc_val,
                                    t01.ytg_ly_val,
      ...
      /*-*/
      open pld_sal_format02_c01 for var_dynamic_sql using var_sap_company_code, var_sap_company_code, var_sap_bus_sgmnt_code;
      loop
         if var_for_type = 'PRD_BR' or var_for_type = 'PRD_LE' then
...
/**************************/
create or replace public synonym mfjpln_sal_format02_excel03 for pld_rep_app.mfjpln_sal_format02_excel03;
grant execute on mfjpln_sal_format02_excel03 to public;