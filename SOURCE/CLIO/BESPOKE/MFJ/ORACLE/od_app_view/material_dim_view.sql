...
create or replace force view od_app.material_dim_view
   ...
   select ltrim(t01.sap_material_code,' 0') as sap_material_code,
          ...
          t03.material_desc as material_desc_ja,
          ...
          t05.material_desc as rep_item_desc_ja,
     ...
     from material t01,
          ...
          (select t31.sap_material_code,
                  t31.material_desc
             from material_desc t31
            where t31.sap_lang_code = 'JA') t03,
          (select t41.sap_material_code,
                  t41.material_desc
             from material_desc t41
            where t41.sap_lang_code = 'EN') t04,
          (select t51.sap_material_code,
                  t51.material_desc
             from material_desc t51
            where t51.sap_lang_code = 'JA') t05,
          uom t07,
          uom t08,
          uom t09,
          ean_upc_ctgry t10,
    ...
    where t01.sap_material_code = t02.sap_material_code(+)
      ...
      and t01.sap_rep_item_code = t05.sap_material_code(+);
