...
/******************************************************************************/
/**
 Object : sales_period_01_fact_view
 Owner  : dd
...
/* View creation
/*-*/
create or replace force view dd.sales_period_01_fact_view
   (SAP_ORDER_TYPE_CODE, SAP_INVC_TYPE_CODE, BILLING_YYYYPP, BASE_UOM_BILLED_QTY, PIECES_BILLED_QTY, 
...
FROM
  SALES_PERIOD_03_FACT_IN_DW;

/*-*/
/* Authority
/*-*/
grant select on dd.sales_period_01_fact_view to dw_app;

/*-*/
/* Synonym
/*-*/
create or replace public synonym sales_period_01_fact_view for dd.sales_period_01_fact_view;