...
comment on column od.fcst_month.sap_sales_div_cust_code is 'SAP Sales Division Customer Code from Geo Force Hierarchy';
comment on column od.fcst_month.sap_sales_div_sales_org_code is 'SAP Sales Division Sales Organisation Code from Geo Force Hierarchy';
comment on column od.fcst_month.sap_sales_div_distbn_chnl_code is 'SAP Sales Division Distribution Channel Code from Geo Force Hierarchy';
comment on column od.fcst_month.sap_sales_div_division_code is 'SAP Sales Division Division Code from Geo Force Hierarchy';
comment on column od.fcst_month.sap_material_code is 'SAP Material Code';
comment on column od.fcst_month.fcst_value is 'Forecast Value in Company''s default currency';
...
grant select, insert, update, delete on od.fcst_month to mfj_plan;
grant select on od.fcst_month to od_app with grant option;
...
/* Synonym
/**/
create public synonym fcst_month for od.fcst_month;
