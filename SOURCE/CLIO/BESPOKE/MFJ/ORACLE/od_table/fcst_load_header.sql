...
comment on column od.fcst_load_header.fcst_time is 'Forecast time dimension (*PRD or *MTH)';
...
comment on column od.fcst_load_header.fcst_cast_yyyynn is 'Forecast casting period/Month';
