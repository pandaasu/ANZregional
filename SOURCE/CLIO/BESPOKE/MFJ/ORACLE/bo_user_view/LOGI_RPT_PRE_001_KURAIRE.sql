...
/******************************************************************************/
/**
 Object : logi_rpt_pre_001_kuraire
 Owner  : bo_user
...
/* View creation
/*-*/
create or replace force view bo_user.logi_rpt_pre_001_kuraire
...
-- ëqì¸ï™Ç∆ÇµÇƒë®Ç¶ÇÈÇ◊Ç´Ç‡ÇÃ
-- 15926 : ÇrÇmÇeëqì¸ÇÍ
-- 16083 : ÇoÇfÅ@ëqì¸ÇÍ
  AND  DD.SHIP_TO_HIER.SAP_CUST_CODE_LEVEL_2 IN (15926,16083)
--  AND  DD.SALES_MONTH_01_FACT.BILLING_YYYYMM BETWEEN 200401 AND 200412
...
--         Decode(DD.SHIP_TO_HIER.SAP_CUST_CODE_LEVEL_2, Null, Null, 
--         '[' || to_char(DD.SHIP_TO_HIER.SAP_CUST_CODE_LEVEL_2) || '] - No Name Defined' ), 
--         DD.SHIP_TO_HIER.CUST_NAME_JA_LEVEL_2)  IN  ('ÇoÇfÅ@ëqì¸ÇÍ', 'ÇrÇmÇeëqì¸ÇÍ')
  )
GROUP BY
  DD.SALES_ORG_DIM.SAP_SALES_ORG_CODE, 
  DD.DIVISION_DIM.SAP_DIVISION_CODE, 
