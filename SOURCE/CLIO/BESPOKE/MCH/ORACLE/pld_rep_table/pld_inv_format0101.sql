...
create table pld_inv_format0101
   (sap_company_code varchar2(6 char) not null,
    ...
    prd_fut_br_qty number not null,
    prd_fut_rb_qty number not null,
    mth_billed_qty number not null,
    mth_br_qty number not null,
    mth_rb_qty number not null,
    mth_fut_br_qty number not null,
    mth_fut_rb_qty number not null,
    inv_tot_value number not null,
    inv_tot_qty number not null,
    inv_int_qty number not null,
    inv_war_value number not null,
    inv_war_qty number not null,
    inv_hld_qty number not null,
    inv_unk_qty number not null,
    inv_age_qty number not null,
    inv_sal_qty number not null,
    inv_prd_br_ons_cover number not null,
    inv_prd_rb_ons_cover number not null,
    inv_mth_br_ons_cover number not null,
    inv_mth_rb_ons_cover number not null,
    inv_prd_br_sal_cover number not null,
    inv_prd_rb_sal_cover number not null,
    inv_mth_br_sal_cover number not null,
    inv_mth_rb_sal_cover number not null);
...
comment on column pld_inv_format0101.prd_rb_qty is 'Current period rb quantity';
comment on column pld_inv_format0101.prd_fut_br_qty is 'Future periods br quantity';
comment on column pld_inv_format0101.prd_fut_rb_qty is 'Future periods rb quantity';
...
comment on column pld_inv_format0101.mth_rb_qty is 'Current month rb quantity';
comment on column pld_inv_format0101.mth_fut_br_qty is 'Future months br quantity';
comment on column pld_inv_format0101.mth_fut_rb_qty is 'Future months rb quantity';
...
comment on column pld_inv_format0101.inv_int_qty is 'Intransit inventory quantity';
...
comment on column pld_inv_format0101.inv_prd_rb_ons_cover is 'Period rb onshore weeks cover';
comment on column pld_inv_format0101.inv_mth_br_ons_cover is 'Month br onshore weeks cover';
comment on column pld_inv_format0101.inv_mth_rb_ons_cover is 'Month rb onshore weeks cover';
comment on column pld_inv_format0101.inv_prd_br_sal_cover is 'Period br saleable weeks cover';
comment on column pld_inv_format0101.inv_prd_rb_sal_cover is 'Period rb saleable weeks cover';
comment on column pld_inv_format0101.inv_mth_br_sal_cover is 'Month br saleable weeks cover';
comment on column pld_inv_format0101.inv_mth_rb_sal_cover is 'Month rb saleable weeks cover';
