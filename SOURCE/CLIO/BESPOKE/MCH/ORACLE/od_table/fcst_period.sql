...
create table od.fcst_period
   (fcst_period_code                number(8)              not null,
...
comment on column od.fcst_period.fcst_type_code is 'Forecast Type Code';
...
comment on column od.fcst_period.sap_sales_div_cust_code is 'SAP Sales Division Customer Code from Local Hierarchy';
comment on column od.fcst_period.sap_sales_div_sales_org_code is 'SAP Sales Division Sales Organisation Code from Local Hierarchy';
comment on column od.fcst_period.sap_sales_div_distbn_chnl_code is 'SAP Sales Division Distribution Channel Code from Local Hierarchy';
comment on column od.fcst_period.sap_sales_div_division_code is 'SAP Sales Division Division Code from Local Hierarchy';
comment on column od.fcst_period.sap_material_code is 'SAP Material Code';
comment on column od.fcst_period.fcst_value is 'Forecast Value in Company default currency';
...
/**/
alter table od.fcst_period
   add constraint fcst_period_pk primary key (fcst_period_code);

/**/
/* Authority
/**/
grant select, insert, update, delete on od.fcst_period to dw_app;
grant select, insert, update, delete on od.fcst_period to od_app with grant option;
...
/* Synonym
/**/
create or replace public synonym fcst_period for od.fcst_period;
