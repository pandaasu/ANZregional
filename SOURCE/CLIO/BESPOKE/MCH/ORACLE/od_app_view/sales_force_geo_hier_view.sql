...
/******************************************************************************/
/**
 Object : sales_force_geo_hier_view
 Owner  : od_app

 DESCRIPTION
 -----------
 Operational Data Store - Sales Force Geography Hierarchy View
...
/* View creation
/*-*/
create or replace force view od_app.sales_force_geo_hier_view
   (sap_hier_cust_code,
    sap_sales_org_code,
   ...
   select decode(t01.sap_cust_code_level_2,null,t01.sap_cust_code_level_1,
    ...
    where t01.sap_cust_hier_type_code = 'G'
...
/* Authority
/*-*/
grant select on od_app.sales_force_geo_hier_view to dw_app;

/*-*/
/* Synonym
/*-*/
create or replace public synonym sales_force_geo_hier_view for od_app.sales_force_geo_hier_view;
