...
/******************************************************************************/
/**
 Object : std_hier_view
 Owner  : od_app

 DESCRIPTION
 -----------
 Operational Data Store - Standard Hierarchy View

 YYYY/MM   Author         Description
 -------   ------         -----------
 2004/11   Steve Gregan   Created
 2006/04   Steve Gregan   Removed Japanese descriptions
 2006/06   Steve Gregan   Added one time customer inclusions
...
/* View creation
/*-*/
create or replace force view od_app.std_hier_view
   (sap_hier_cust_code,
    sap_sales_org_code,
   ...
   select decode(t01.sap_cust_code_level_2,null,t01.sap_cust_code_level_1,
    ...
    where t01.sap_cust_hier_type_code = 'A'
   ...
   select t11.dsv_value,
          ...
          null,
          null
     from (select dsv_value from table(lics_datastore.retrieve_value('CLIO','STD_HIER_BUILD','ONE_TIME_CUSTOMER'))) t11;

/*-*/
/* Authority
/*-*/
grant select on od_app.std_hier_view to dw_app;

/*-*/
/* Synonym
/*-*/
create or replace public synonym std_hier_view for od_app.std_hier_view;