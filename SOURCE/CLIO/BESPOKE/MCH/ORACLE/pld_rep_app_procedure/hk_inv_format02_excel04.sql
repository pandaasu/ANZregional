...
/* Package : hk_inv_format02_excel04                            */
...
/* Package Header */
/******************/
create or replace package hk_inv_format02_excel04 as
...
end hk_inv_format02_excel04;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_inv_format02_excel04 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Period - BR Forecast (HK$ Thousands)';
      elsif var_for_type = 'PRD_RB' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Period - ROB Forecast (HK$ Thousands)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Month - BR Forecast (HK$ Thousands)';
      elsif var_for_type = 'MTH_RB' then
         var_wrk_string := 'No Forecast Product Restricted Inventory Report - Month - ROB Forecast (HK$ Thousands)';
      end if;
   ...
   begin
      ...
      /*-*/
      for idx in 1..tblWarehouse.count loop
         var_wrk_array := var_wrk_array || chr(9) || to_char(tblWarehouse(idx).inv_res_qty,'FM999999999999990') || chr(9) || to_char(tblWarehouse(idx).inv_res_val/1000,'FM999999990.00000');
      end loop;
...
/**************************/
create or replace public synonym hk_inv_format02_excel04 for pld_rep_app.hk_inv_format02_excel04;
grant execute on hk_inv_format02_excel04 to public;