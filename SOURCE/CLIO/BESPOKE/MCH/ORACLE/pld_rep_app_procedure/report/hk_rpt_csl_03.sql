...
/* Package Header */
/******************/
create or replace package hk_rpt_csl_03 as

/**DESCRIPTION**
 Customer Service Level Report - POP - Previous Period.
...
/* Package Body */
/****************/
create or replace package body hk_rpt_csl_03 as
   ...
   begin
      ...
      /* Start the report
      /*-*/
      hk_csl_prd_11_excel.start_report(par_company_code,'ZPRM');
      ...
      /* Start the sheet
      /*-*/
      hk_csl_prd_11_excel.start_sheet('Customer Service Level - POP - Previous Period Case Fill', 'CASE');
      ...
      /*-*/
      hk_csl_prd_11_excel.add_group(null);
      hk_csl_prd_11_excel.add_column('PRM_OF_PCT','Order Fill %',null,null,null);
      hk_csl_prd_11_excel.add_column('TOT_PRM_CNT','Total Orders',2,2,null);
      hk_csl_prd_11_excel.add_column('FIL_PRM_CNT','Filled Orders',2,2,null);

      /*-*/
      /* Start the sheet
      /*-*/
      hk_csl_prd_11_excel.start_sheet('Customer Service Level - POP - Previous Period Order Fill', 'ORDER');
      ...
      /* Start the sheet
      /*-*/
      hk_csl_prd_11_excel.start_sheet('Customer Service Level - POP - Previous Period Delivery Completion Rate', 'DELIVERY');
      ...
      /*-*/
      hk_csl_prd_11_excel.add_group(null);
      hk_csl_prd_11_excel.add_column('PRM_OT_PCT','On-Time %',null,null,null);
      hk_csl_prd_11_excel.add_column('TOT_PRM_CNT','Total Orders',2,2,null);
      hk_csl_prd_11_excel.add_column('ONT_PRM_CNT','On-Time Orders',2,2,null);

      /*-*/
      /* Start the sheet
      /*-*/
      hk_csl_prd_11_excel.start_sheet('Customer Service Level - POP - Previous Period On-Time Rate', 'ONTIME');
...
/**************************/
create or replace public synonym hk_rpt_csl_03 for pld_rep_app.hk_rpt_csl_03;
grant execute on hk_rpt_csl_03 to public;