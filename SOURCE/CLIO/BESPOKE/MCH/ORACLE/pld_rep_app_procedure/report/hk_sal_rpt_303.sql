...
/* Package Header */
/******************/
create or replace package hk_sal_rpt_303 as
...
/* Package Body */
/****************/
create or replace package body hk_sal_rpt_303 as
   ...
   begin
      ...
      for rcd_cust_node in csr_cust_node loop
            ...
            if rcd_cust_node.node_level = 'STD_HIER_MISSING' then
               ...
               hk_sal_cus_prd_11_excel.define_sheet(var_name,9);
            end if;
            ...
            if rcd_cust_node.node_level = 'STD_HIER_MISSING' then
               ...
               /* Snackfood data
               /*-*/
               hk_sal_cus_prd_11_excel.set_parameter_string('BUS_SGMNT_CODE','01');
               hk_sal_cus_prd_11_excel.set_hierarchy(1,'COMPANY',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(2,'BUS_SGMNT',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(3,'BDT',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(4,'BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(5,'BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(6,'BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(7,'BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(8,'REP_ITEM',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(9,'MATERIAL',false);
               hk_sal_cus_prd_11_excel.retrieve_data;

               /*-*/
               /* Food data
               /*-*/
               hk_sal_cus_prd_11_excel.set_parameter_string('BUS_SGMNT_CODE','02');
               hk_sal_cus_prd_11_excel.set_hierarchy(1,'COMPANY',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(2,'BUS_SGMNT',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(3,'BDT',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(4,'BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(5,'PRDCT_CTGRY',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(6,'CNSMR_PACK',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(7,'PACK_SIZE',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(8,'REP_ITEM',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(9,'MATERIAL',false);
               hk_sal_cus_prd_11_excel.retrieve_data;
               ...
               /* Petcare data
               /*-*/
               hk_sal_cus_prd_11_excel.set_parameter_string('BUS_SGMNT_CODE','05');
               hk_sal_cus_prd_11_excel.set_hierarchy(1,'COMPANY',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(2,'BUS_SGMNT',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(3,'BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(4,'PRDCT_CTGRY',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(5,'CNSMR_PACK',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(6,'SUB_BRAND',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(7,'PACK_SIZE',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(8,'REP_ITEM',false);
               hk_sal_cus_prd_11_excel.set_hierarchy(9,'MATERIAL',false);
               hk_sal_cus_prd_11_excel.retrieve_data;
...
/**************************/
create or replace public synonym hk_sal_rpt_303 for pld_rep_app.hk_sal_rpt_303;
grant execute on hk_sal_rpt_303 to public;