...
/* Package Header */
/******************/
create or replace package hk_rpt_csl_02 as

/**DESCRIPTION**
 Customer Service Level Report - Finished Goods - Current Period.
...
/* Package Body */
/****************/
create or replace package body hk_rpt_csl_02 as
   ...
   begin
      ...
      /* Start the report
      /*-*/
      hk_csl_prd_12_excel.start_report(par_company_code,'FERT');
      ...
      /* Start the sheet
      /*-*/
      hk_csl_prd_12_excel.start_sheet('Customer Service Level - Finished Goods - Current Period Case Fill', 'CASE');
      ...
      /*-*/
      hk_csl_prd_12_excel.add_group(null);
      hk_csl_prd_12_excel.add_column('PRD_OF_PCT','Order Fill %',null,null,null);
      hk_csl_prd_12_excel.add_column('TOT_ORD_CNT','Total Orders',2,2,null);
      hk_csl_prd_12_excel.add_column('FIL_ORD_CNT','Filled Orders',2,2,null);

      /*-*/
      /* Start the sheet
      /*-*/
      hk_csl_prd_12_excel.start_sheet('Customer Service Level - Finished Goods - Current Period Order Fill', 'ORDER');
      ...
      /* Start the sheet
      /*-*/
      hk_csl_prd_12_excel.start_sheet('Customer Service Level - Finished Goods - Current Period Delivery Completion Rate', 'DELIVERY');
      ...
      /*-*/
      hk_csl_prd_12_excel.add_group(null);
      hk_csl_prd_12_excel.add_column('PRD_OT_PCT','On-Time %',null,null,null);
      hk_csl_prd_12_excel.add_column('TOT_ORD_CNT','Total Orders',2,2,null);
      hk_csl_prd_12_excel.add_column('ONT_ORD_CNT','On-Time Orders',2,2,null);

      /*-*/
      /* Start the sheet
      /*-*/
      hk_csl_prd_12_excel.start_sheet('Customer Service Level - Finished Goods - Current Period On-Time Rate', 'ONTIME');
...
/**************************/
create or replace public synonym hk_rpt_csl_02 for pld_rep_app.hk_rpt_csl_02;
grant execute on hk_rpt_csl_02 to public;