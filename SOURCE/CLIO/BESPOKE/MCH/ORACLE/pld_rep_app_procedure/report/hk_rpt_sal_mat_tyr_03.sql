...
/* Package Header */
/******************/
create or replace package hk_rpt_sal_mat_tyr_03 as

/**DESCRIPTION**
 Material Business Segment YEE Report.
...
end hk_rpt_sal_mat_tyr_03;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_rpt_sal_mat_tyr_03 as

   /*-*/
   /* Private package methods
   /*-*/
   procedure do_prd_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2);
   procedure do_prd_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2);
   procedure do_mth_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2);
   procedure do_mth_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2);
   ...
   begin
      ...
      if par_for_type = 'PRD_BR' then
         do_prd_br(par_company_code, par_bus_sgmnt_code, par_val_type);
      elsif par_for_type = 'PRD_RB' then
         do_prd_rb(par_company_code, par_bus_sgmnt_code, par_val_type);
      elsif par_for_type = 'MTH_BR' then
         do_mth_br(par_company_code, par_bus_sgmnt_code, par_val_type);
      elsif par_for_type = 'MTH_RB' then
         do_mth_rb(par_company_code, par_bus_sgmnt_code, par_val_type);
      end if;
   ...
   /********************************************************/
   procedure do_prd_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2) is
   ...
   begin
      ...
      /*-*/
      var_string := 'Material Business Segment YEE - Period - BR Forecast';
   ...
   /*********************************************************/
   procedure do_prd_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2) is
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Business Segment YEE - Period - ROB Forecast';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
   ...
   /*******************************************************/
   procedure do_mth_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2) is
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Business Segment YEE - Month - BR Forecast';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
   ...
   /********************************************************/
   procedure do_mth_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_val_type in varchar2) is
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Business Segment YEE - Month - ROB Forecast';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
...
/**************************/
create or replace public synonym hk_rpt_sal_mat_tyr_03 for pld_rep_app.hk_rpt_sal_mat_tyr_03;
grant execute on hk_rpt_sal_mat_tyr_03 to public;