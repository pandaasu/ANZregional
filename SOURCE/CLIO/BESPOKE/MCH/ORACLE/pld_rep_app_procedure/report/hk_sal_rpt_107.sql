...
/* Package Header */
/******************/
create or replace package hk_sal_rpt_107 as

/**DESCRIPTION**
 Period sales summary report by material by customer hierarchy.
...
/* Package Body */
/****************/
create or replace package body hk_sal_rpt_107 as
   ...
   begin
      ...
      /*-*/
      var_string := 'Period Sales Summary Report by Material by Customer';
...
/**************************/
create or replace public synonym hk_sal_rpt_107 for pld_rep_app.hk_sal_rpt_107;
grant execute on hk_sal_rpt_107 to public;