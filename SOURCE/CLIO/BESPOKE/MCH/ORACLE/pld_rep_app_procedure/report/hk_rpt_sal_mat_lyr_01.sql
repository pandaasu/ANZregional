...
/* Package Header */
/******************/
create or replace package hk_rpt_sal_mat_lyr_01 as

/**DESCRIPTION**
 Material Combined Business Full Year Report.
...
end hk_rpt_sal_mat_lyr_01;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_rpt_sal_mat_lyr_01 as
   ...
   begin
      ...
      /*-*/
      var_string := 'Material Combined Business Full Year - Period';
      ...
      /* Define sheet
      /*-*/
      hk_sal_mat_prd_13_excel.define_sheet('Report',9);
      ...
      hk_sal_mat_prd_13_excel.set_hierarchy(1,'COMPANY',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(2,'BUS_SGMNT',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(3,'BDT',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(4,'BRAND',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(5,'INGRED_VRTY',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(6,'CNSMR_PACK',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(7,'PACK_SIZE',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(8,'REP_ITEM',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(9,'MATERIAL',false);
      ...
      hk_sal_mat_prd_13_excel.set_hierarchy(3,'BDT',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(4,'BRAND',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(5,'PRDCT_CTGRY',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(6,'CNSMR_PACK',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(7,'PACK_SIZE',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(8,'REP_ITEM',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(9,'MATERIAL',false);
      ...
      hk_sal_mat_prd_13_excel.set_hierarchy(5,'SUB_BRAND',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(6,'CNSMR_PACK',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(7,'PACK_SIZE',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(8,'REP_ITEM',false);
      hk_sal_mat_prd_13_excel.set_hierarchy(9,'MATERIAL',false);
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Combined Business Full Year - Month';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
      ...
      /* Define sheet
      /*-*/
      hk_sal_mat_mth_13_excel.define_sheet('Report',9);
      ...
      hk_sal_mat_mth_13_excel.set_hierarchy(1,'COMPANY',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(2,'BUS_SGMNT',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(3,'BDT',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(4,'BRAND',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(5,'INGRED_VRTY',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(6,'CNSMR_PACK',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(7,'PACK_SIZE',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(8,'REP_ITEM',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(9,'MATERIAL',false);
      ...
      hk_sal_mat_mth_13_excel.set_hierarchy(3,'BDT',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(4,'BRAND',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(5,'PRDCT_CTGRY',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(6,'CNSMR_PACK',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(7,'PACK_SIZE',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(8,'REP_ITEM',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(9,'MATERIAL',false);
      ...
      hk_sal_mat_mth_13_excel.set_hierarchy(5,'SUB_BRAND',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(6,'CNSMR_PACK',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(7,'PACK_SIZE',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(8,'REP_ITEM',false);
      hk_sal_mat_mth_13_excel.set_hierarchy(9,'MATERIAL',false);
...
/**************************/
create or replace public synonym hk_rpt_sal_mat_lyr_01 for pld_rep_app.hk_rpt_sal_mat_lyr_01;
grant execute on hk_rpt_sal_mat_lyr_01 to public;