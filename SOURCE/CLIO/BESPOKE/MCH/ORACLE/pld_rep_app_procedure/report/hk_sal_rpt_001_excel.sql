...
/* Package Header */
/******************/
create or replace package hk_sal_rpt_001_excel as
...
end hk_sal_rpt_001_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_rpt_001_excel as
   ...
   begin
      ...
      hk_sal_base_excel.tbl_hierarchy('STD_HIER04').hie_ssql := 'max(decode(t03.sap_cust_code_level_4,null,''UNKNOWN'',t03.sap_cust_code_level_4))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER04').hie_tsql := 'max(''('' || t03.sap_cust_code_level_4 || '') '' || decode(t03.cust_name_en_level_4,null,''UNKNOWN'',t03.cust_name_en_level_4))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER04').hie_gsql := 't03.sap_cust_code_level_4';

      hk_sal_base_excel.tbl_hierarchy('STD_HIER05').hie_ssql := 'max(decode(t03.sap_cust_code_level_5,null,''UNKNOWN'',t03.sap_cust_code_level_5))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER05').hie_tsql := 'max(''('' || t03.sap_cust_code_level_5 || '') '' || decode(t03.cust_name_en_level_5,null,''UNKNOWN'',t03.cust_name_en_level_5))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER05').hie_gsql := 't03.sap_cust_code_level_5';

      hk_sal_base_excel.tbl_hierarchy('STD_HIER06').hie_ssql := 'max(decode(t03.sap_cust_code_level_6,null,''UNKNOWN'',t03.sap_cust_code_level_6))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER06').hie_tsql := 'max(''('' || t03.sap_cust_code_level_6 || '') '' || decode(t03.cust_name_en_level_6,null,''UNKNOWN'',t03.cust_name_en_level_6))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER06').hie_gsql := 't03.sap_cust_code_level_6';

      hk_sal_base_excel.tbl_hierarchy('STD_HIER07').hie_ssql := 'max(decode(t03.sap_cust_code_level_7,null,''UNKNOWN'',t03.sap_cust_code_level_7))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER07').hie_tsql := 'max(''('' || t03.sap_cust_code_level_7 || '') '' || decode(t03.cust_name_en_level_7,null,''UNKNOWN'',t03.cust_name_en_level_7))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER07').hie_gsql := 't03.sap_cust_code_level_7';

      hk_sal_base_excel.tbl_hierarchy('STD_HIER08').hie_ssql := 'max(decode(t03.sap_cust_code_level_8,null,''UNKNOWN'',t03.sap_cust_code_level_8))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER08').hie_tsql := 'max(''('' || t03.sap_cust_code_level_8 || '') '' || decode(t03.cust_name_en_level_8,null,''UNKNOWN'',t03.cust_name_en_level_8))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER08').hie_gsql := 't03.sap_cust_code_level_8';

      hk_sal_base_excel.tbl_hierarchy('STD_HIER09').hie_ssql := 'max(decode(t03.sap_cust_code_level_9,null,''UNKNOWN'',t03.sap_cust_code_level_9))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER09').hie_tsql := 'max(''('' || t03.sap_cust_code_level_9 || '') '' || decode(t03.cust_name_en_level_9,null,''UNKNOWN'',t03.cust_name_en_level_9))';
      hk_sal_base_excel.tbl_hierarchy('STD_HIER09').hie_gsql := 't03.sap_cust_code_level_9';

      /*-*/
      /* Initialise the customer tables variables
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'std_hier t03';
      hk_sal_base_excel.tbl_main_join := '''x''=''x'' and t03.sap_hier_cust_code like ''1%''';
...
/**************************/
create or replace public synonym hk_sal_rpt_001_excel for pld_rep_app.hk_sal_rpt_001_excel;
grant execute on hk_sal_rpt_001_excel to public;