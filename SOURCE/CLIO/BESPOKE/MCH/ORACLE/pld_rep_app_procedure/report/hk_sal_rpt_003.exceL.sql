...
/* Package Header */
/******************/
create or replace package hk_sal_rpt_003_excel as
...
end hk_sal_rpt_003_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_rpt_003_excel as
   ...
   begin
      ...
      hk_sal_base_excel.tbl_main_join := '''x''=''x'' and sap_material_type_code = ''ZREP''';
...
/**************************/
create or replace public synonym hk_sal_rpt_003_excel for pld_rep_app.hk_sal_rpt_003_excel;
grant execute on hk_sal_rpt_003_excel to public;