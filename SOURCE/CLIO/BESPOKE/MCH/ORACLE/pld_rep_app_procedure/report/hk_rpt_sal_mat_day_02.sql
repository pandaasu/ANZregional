...
/* Package Header */
/******************/
create or replace package hk_rpt_sal_mat_day_02 as

/**DESCRIPTION**
 Material Standard Sales Report.
 ...
 **PARAMETERS**
 ...
 par_for_type = Forecast type (mandatory)
   ...
   /* Public declarations
   /*-*/
   function main(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_for_type in varchar2) return varchar2;

end hk_rpt_sal_mat_day_02;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_rpt_sal_mat_day_02 as

   /*-*/
   /* Private package methods
   /*-*/
   procedure do_prd_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2);
   procedure do_prd_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2);
   procedure do_mth_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2);
   procedure do_mth_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2);

   /*******************************************/
   /* This function performs the main routine */
   /*******************************************/
   function main(par_company_code in varchar2, par_bus_sgmnt_code in varchar2, par_for_type in varchar2) return varchar2 is
   ...
   begin
      ...
      if par_for_type = 'PRD_BR' then
         do_prd_br(par_company_code, par_bus_sgmnt_code);
      elsif par_for_type = 'PRD_RB' then
         do_prd_rb(par_company_code, par_bus_sgmnt_code);
      elsif par_for_type = 'MTH_BR' then
         do_mth_br(par_company_code, par_bus_sgmnt_code);
      elsif par_for_type = 'MTH_RB' then
         do_mth_rb(par_company_code, par_bus_sgmnt_code);
      end if;
   ...
   /********************************************************/
   procedure do_prd_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2) is
   ...
   begin
      ...
      /*-*/
      var_string := 'Material Standard Sales Report - Period - BR Forecast (HK$ Thousands) - Billing Date';
      ...
      /* Define sheet
      /*-*/
      hk_sal_mat_prd_11_excel.define_sheet('Report',8);
      ...
      if par_bus_sgmnt_code = '01' then
         ...
         hk_sal_mat_prd_11_excel.set_hierarchy(1,'BUS_SGMNT',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(2,'BDT',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(3,'BRAND',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(4,'INGRED_VRTY',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(5,'CNSMR_PACK',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(6,'PACK_SIZE',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(7,'REP_ITEM',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(8,'MATERIAL',false);
         ...
         hk_sal_mat_prd_11_excel.set_hierarchy(1,'BUS_SGMNT',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(2,'BRAND',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(3,'PRDCT_CTGRY',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(4,'SUB_BRAND',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(5,'CNSMR_PACK',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(6,'PACK_SIZE',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(7,'REP_ITEM',false);
         hk_sal_mat_prd_11_excel.set_hierarchy(8,'MATERIAL',false);
   ...
   /*********************************************************/
   procedure do_prd_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2) is
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Standard Sales Report - Period - ROB Forecast (HK$ Thousands) - Billing Date';
   ...
   /*******************************************************/
   procedure do_mth_br(par_company_code in varchar2, par_bus_sgmnt_code in varchar2) is
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Standard Sales Report - Month - BR Forecast (HK$ Thousands) - Billing Date';
      ...
      /* Define sheet
      /*-*/
      hk_sal_mat_mth_11_excel.define_sheet('Report',8);
      ...
      if par_bus_sgmnt_code = '01' then
         ...
         hk_sal_mat_mth_11_excel.set_hierarchy(1,'BUS_SGMNT',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(2,'BDT',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(3,'BRAND',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(4,'INGRED_VRTY',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(5,'CNSMR_PACK',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(6,'PACK_SIZE',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(7,'REP_ITEM',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(8,'MATERIAL',false);
      elsif par_bus_sgmnt_code = '02' then
         ...
         hk_sal_mat_mth_11_excel.set_hierarchy(1,'BUS_SGMNT',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(2,'BRAND',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(3,'PRDCT_CTGRY',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(4,'SUB_BRAND',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(5,'CNSMR_PACK',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(6,'PACK_SIZE',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(7,'REP_ITEM',false);
         hk_sal_mat_mth_11_excel.set_hierarchy(8,'MATERIAL',false);
   ...
   /********************************************************/
   procedure do_mth_rb(par_company_code in varchar2, par_bus_sgmnt_code in varchar2) is
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material Standard Sales Report - Month - ROB Forecast (HK$ Thousands) - Billing Date';
...
/**************************/
create or replace public synonym hk_rpt_sal_mat_day_02 for pld_rep_app.hk_rpt_sal_mat_day_02;
grant execute on hk_rpt_sal_mat_day_02 to public;