...
/* Package Header */
/******************/
create or replace package hk_rpt_sal_mat_tyr_02 as

/**DESCRIPTION**
 Material YTD Performance Report.
...
end hk_rpt_sal_mat_tyr_02;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_rpt_sal_mat_tyr_02 as
   ...
   begin
      ...
      /*-*/
      var_string := 'Material YTD Performance Report - Period - BR Forecast';
      ...
      /*-*/
      if par_val_type = 'QTY' then
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_QTY','Value',3,3,1);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_BR_QTY','% BR',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_QTY','% Plan',null,null,null);
         ...
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_TON','Value',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_BR_TON','% BR',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_TON','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
         ...
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_GSV','Value',3,5,1000);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_BR_GSV','% BR',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_GSV','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
         ...
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_NIV','Value',3,5,1000);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_BR_NIV','% BR',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_NIV','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material YTD Performance Report - Period - ROB Forecast';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
      ...
      if par_val_type = 'QTY' then
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_QTY','Value',3,3,1);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_RB_QTY','% ROB',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_QTY','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_QTY','Value',3,3,1);
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_OP_QTY','% Plan',null,null,null);
         ...
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_TON','Value',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_RB_TON','% ROB',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_TON','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_TON','Value',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_OP_TON','% Plan',null,null,null);
         ...
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_GSV','Value',3,5,1000);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_RB_GSV','% ROB',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_GSV','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_GSV','Value',3,5,1000);
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_OP_GSV','% Plan',null,null,null);
         ...
         hk_sal_mat_prd_12_excel.add_group('Actual');
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_NIV','Value',3,5,1000);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_RB_NIV','% ROB',null,null,null);
         hk_sal_mat_prd_12_excel.add_column('PRD_TY_OP_NIV','% Plan',null,null,null);
         hk_sal_mat_prd_12_excel.add_group('YTD');
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_NIV','Value',3,5,1000);
         hk_sal_mat_prd_12_excel.add_column('YTD_TY_OP_NIV','% Plan',null,null,null);
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material YTD Performance Report - Month - BR Forecast';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
      ...
      /*-*/
      if par_val_type = 'QTY' then
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_QTY','Value',3,3,1);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_BR_QTY','% BR',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_QTY','% Plan',null,null,null);
         ...
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_TON','Value',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_BR_TON','% BR',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_TON','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
         ...
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_GSV','Value',3,5,1000);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_BR_GSV','% BR',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_GSV','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
         ...
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_NIV','Value',3,5,1000);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_BR_NIV','% BR',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_NIV','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
   ...
   begin
      ...
      /* Initialise the report heading
      /*-*/
      var_string := 'Material YTD Performance Report - Month - ROB Forecast';
      if par_val_type = 'QTY' then
         var_string := var_string || ' - Quantity - Billing Date';
      elsif par_val_type = 'TON' then
         var_string := var_string || ' - Tonnes - Billing Date';
      ...
      if par_val_type = 'QTY' then
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_QTY','Value',3,3,1);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_RB_QTY','% ROB',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_QTY','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_QTY','Value',3,3,1);
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_OP_QTY','% Plan',null,null,null);
         ...
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_TON','Value',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_RB_TON','% ROB',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_TON','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_TON','Value',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_OP_TON','% Plan',null,null,null);
         ...
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_GSV','Value',3,5,1000);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_RB_GSV','% ROB',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_GSV','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_GSV','Value',3,5,1000);
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_OP_GSV','% Plan',null,null,null);
         ...
         hk_sal_mat_mth_12_excel.add_group('Actual');
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_NIV','Value',3,5,1000);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_RB_NIV','% ROB',null,null,null);
         hk_sal_mat_mth_12_excel.add_column('MTH_TY_OP_NIV','% Plan',null,null,null);
         hk_sal_mat_mth_12_excel.add_group('YTD');
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_NIV','Value',3,5,1000);
         hk_sal_mat_mth_12_excel.add_column('YTD_TY_OP_NIV','% Plan',null,null,null);
...
/**************************/
create or replace public synonym hk_rpt_sal_mat_tyr_02 for pld_rep_app.hk_rpt_sal_mat_tyr_02;
grant execute on hk_rpt_sal_mat_tyr_02 to public;