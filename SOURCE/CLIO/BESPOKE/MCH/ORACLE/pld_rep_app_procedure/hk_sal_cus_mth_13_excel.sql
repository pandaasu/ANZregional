...
/* Package : hk_sal_cus_mth_13_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_mth_13_excel as
...
end hk_sal_cus_mth_13_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_mth_13_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_cus_mth_1300 pld_sal_cus_mth_1300%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_cus_mth_1300 is 
         select *
         from pld_sal_cus_mth_1300 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_cus_mth_1300;
      fetch csr_pld_sal_cus_mth_1300 into rcd_pld_sal_cus_mth_1300;
      if csr_pld_sal_cus_mth_1300%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_cus_mth_1300;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_CUS_MTH_1300 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_cus_mth_1300.extract_status || ' ' || rcd_pld_sal_cus_mth_1300.sales_status,
                                    'Month Year End: ' || substr(to_char(rcd_pld_sal_cus_mth_1300.current_yyyymm-100,'fm000000'),1,4));
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_cus_mth_1301 t01,material_dim t02,std_hier t03';
      ...
      hk_sal_base_excel.tbl_table(11).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,m01_qty,m02_qty,m03_qty,m04_qty,m05_qty,m06_qty,m07_qty,m08_qty,m09_qty,m10_qty,m11_qty,m12_qty from pld_sal_cus_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t11';
      ...
      hk_sal_base_excel.tbl_table(12).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,m01_ton,m02_ton,m03_ton,m04_ton,m05_ton,m06_ton,m07_ton,m08_ton,m09_ton,m10_ton,m11_ton,m12_ton from pld_sal_cus_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t12';
      ...
      hk_sal_base_excel.tbl_table(13).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,m01_gsv,m02_gsv,m03_gsv,m04_gsv,m05_gsv,m06_gsv,m07_gsv,m08_gsv,m09_gsv,m10_gsv,m11_gsv,m12_gsv from pld_sal_cus_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t13';
      ...
      hk_sal_base_excel.tbl_table(14).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,m01_niv,m02_niv,m03_niv,m04_niv,m05_niv,m06_niv,m07_niv,m08_niv,m09_niv,m10_niv,m11_niv,m12_niv from pld_sal_cus_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t14';
...
/**************************/
create or replace public synonym hk_sal_cus_mth_13_excel for pld_rep_app.hk_sal_cus_mth_13_excel;
grant execute on hk_sal_cus_mth_13_excel to public;