...
/* Package : hk_sal_mat_prd_12_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_mat_prd_12_excel as
...
end hk_sal_mat_prd_12_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_mat_prd_12_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_mat_prd_1200 pld_sal_mat_prd_1200%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_mat_prd_1200 is 
         select *
         from pld_sal_mat_prd_1200 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_mat_prd_1200;
      fetch csr_pld_sal_mat_prd_1200 into rcd_pld_sal_mat_prd_1200;
      if csr_pld_sal_mat_prd_1200%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_mat_prd_1200;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_MAT_PRD_1200 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_mat_prd_1200.extract_status || ' ' || rcd_pld_sal_mat_prd_1200.sales_status,
                                    'Period End: ' || substr(to_char(rcd_pld_sal_mat_prd_1200.current_yyyypp,'fm000000'),1,4) || '/' || substr(to_char(rcd_pld_sal_mat_prd_1200.current_yyyypp-1,'fm000000'),5,6));
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_mat_prd_1201 t01,material_dim t02';
      hk_sal_base_excel.tbl_main_join := 't01.sap_material_code = t02.sap_material_code(+) and t01.sap_company_code = :A';

      hk_sal_base_excel.tbl_table(11).tab_name := '(select sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''AOP'') t11';
      hk_sal_base_excel.tbl_table(11).tab_join := 'and t01.sap_material_code = t11.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(12).tab_name := '(select sap_material_code,p01_ton,p02_ton,p03_ton,p04_ton,p05_ton,p06_ton,p07_ton,p08_ton,p09_ton,p10_ton,p11_ton,p12_ton,p13_ton from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''AOP'') t12';
      hk_sal_base_excel.tbl_table(12).tab_join := 'and t01.sap_material_code = t12.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(13).tab_name := '(select sap_material_code,p01_gsv,p02_gsv,p03_gsv,p04_gsv,p05_gsv,p06_gsv,p07_gsv,p08_gsv,p09_gsv,p10_gsv,p11_gsv,p12_gsv,p13_gsv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''AOP'') t13';
      hk_sal_base_excel.tbl_table(13).tab_join := 'and t01.sap_material_code = t13.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(14).tab_name := '(select sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''AOP'') t14';
      hk_sal_base_excel.tbl_table(14).tab_join := 'and t01.sap_material_code = t14.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(21).tab_name := '(select sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ABR'') t21';
      hk_sal_base_excel.tbl_table(21).tab_join := 'and t01.sap_material_code = t21.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(22).tab_name := '(select sap_material_code,p01_ton,p02_ton,p03_ton,p04_ton,p05_ton,p06_ton,p07_ton,p08_ton,p09_ton,p10_ton,p11_ton,p12_ton,p13_ton from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ABR'') t22';
      hk_sal_base_excel.tbl_table(22).tab_join := 'and t01.sap_material_code = t22.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(23).tab_name := '(select sap_material_code,p01_gsv,p02_gsv,p03_gsv,p04_gsv,p05_gsv,p06_gsv,p07_gsv,p08_gsv,p09_gsv,p10_gsv,p11_gsv,p12_gsv,p13_gsv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ABR'') t23';
      hk_sal_base_excel.tbl_table(23).tab_join := 'and t01.sap_material_code = t23.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(24).tab_name := '(select sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ABR'') t24';
      hk_sal_base_excel.tbl_table(24).tab_join := 'and t01.sap_material_code = t24.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(31).tab_name := '(select sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ARB'') t31';
      hk_sal_base_excel.tbl_table(31).tab_join := 'and t01.sap_material_code = t31.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(32).tab_name := '(select sap_material_code,p01_ton,p02_ton,p03_ton,p04_ton,p05_ton,p06_ton,p07_ton,p08_ton,p09_ton,p10_ton,p11_ton,p12_ton,p13_ton from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ARB'') t32';
      hk_sal_base_excel.tbl_table(32).tab_join := 'and t01.sap_material_code = t32.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(33).tab_name := '(select sap_material_code,p01_gsv,p02_gsv,p03_gsv,p04_gsv,p05_gsv,p06_gsv,p07_gsv,p08_gsv,p09_gsv,p10_gsv,p11_gsv,p12_gsv,p13_gsv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ARB'') t33';
      hk_sal_base_excel.tbl_table(33).tab_join := 'and t01.sap_material_code = t33.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(34).tab_name := '(select sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''ARB'') t34';
      hk_sal_base_excel.tbl_table(34).tab_join := 'and t01.sap_material_code = t34.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(41).tab_name := '(select sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''LYR'') t41';
      hk_sal_base_excel.tbl_table(41).tab_join := 'and t01.sap_material_code = t41.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(42).tab_name := '(select sap_material_code,p01_ton,p02_ton,p03_ton,p04_ton,p05_ton,p06_ton,p07_ton,p08_ton,p09_ton,p10_ton,p11_ton,p12_ton,p13_ton from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''LYR'') t42';
      hk_sal_base_excel.tbl_table(42).tab_join := 'and t01.sap_material_code = t42.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(43).tab_name := '(select sap_material_code,p01_gsv,p02_gsv,p03_gsv,p04_gsv,p05_gsv,p06_gsv,p07_gsv,p08_gsv,p09_gsv,p10_gsv,p11_gsv,p12_gsv,p13_gsv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''LYR'') t43';
      hk_sal_base_excel.tbl_table(43).tab_join := 'and t01.sap_material_code = t43.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(44).tab_name := '(select sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''LYR'') t44';
      hk_sal_base_excel.tbl_table(44).tab_join := 'and t01.sap_material_code = t44.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(51).tab_name := '(select sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''TOP'') t51';
      hk_sal_base_excel.tbl_table(51).tab_join := 'and t01.sap_material_code = t51.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(52).tab_name := '(select sap_material_code,p01_ton,p02_ton,p03_ton,p04_ton,p05_ton,p06_ton,p07_ton,p08_ton,p09_ton,p10_ton,p11_ton,p12_ton,p13_ton from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''TOP'') t52';
      hk_sal_base_excel.tbl_table(52).tab_join := 'and t01.sap_material_code = t52.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(53).tab_name := '(select sap_material_code,p01_gsv,p02_gsv,p03_gsv,p04_gsv,p05_gsv,p06_gsv,p07_gsv,p08_gsv,p09_gsv,p10_gsv,p11_gsv,p12_gsv,p13_gsv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''TOP'') t53';
      hk_sal_base_excel.tbl_table(53).tab_join := 'and t01.sap_material_code = t53.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(54).tab_name := '(select sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_mat_prd_1202 where sap_company_code = :A and dta_type = ''TOP'') t54';
...
/**************************/
create or replace public synonym hk_sal_mat_prd_12_excel for pld_rep_app.hk_sal_mat_prd_12_excel;
grant execute on hk_sal_mat_prd_12_excel to public;