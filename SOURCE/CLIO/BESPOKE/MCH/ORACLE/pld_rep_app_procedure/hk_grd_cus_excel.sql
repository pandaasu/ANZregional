...
/* Package Header */
/******************/
create or replace package hk_grd_cus_excel as
...
end hk_grd_cus_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_grd_cus_excel as
   ...
   begin
      ...
      hk_sal_base_excel.tbl_main_join := '''x''=''x''';
...
/**************************/
create or replace public synonym hk_grd_cus_excel for pld_rep_app.hk_grd_cus_excel;
grant execute on hk_grd_cus_excel to public;