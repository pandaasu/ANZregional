...
/* Package : hk_sal_cus_prd_01_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_prd_01_excel as
...
end hk_sal_cus_prd_01_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_prd_01_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_cus_prd_0100 pld_sal_cus_prd_0100%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_cus_prd_0100 is 
         select *
         from pld_sal_cus_prd_0100 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_cus_prd_0100;
      fetch csr_pld_sal_cus_prd_0100 into rcd_pld_sal_cus_prd_0100;
      if csr_pld_sal_cus_prd_0100%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_cus_prd_0100;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_CUS_PRD_0100 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_cus_prd_0100.extract_status || ' ' || rcd_pld_sal_cus_prd_0100.sales_status,
                                    rcd_pld_sal_cus_prd_0100.prd_asofdays);
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_cus_prd_0101 t01,material_dim t02,std_hier t03';
...
/**************************/
create or replace public synonym hk_sal_cus_prd_01_excel for pld_rep_app.hk_sal_cus_prd_01_excel;
grant execute on hk_sal_cus_prd_01_excel to public;