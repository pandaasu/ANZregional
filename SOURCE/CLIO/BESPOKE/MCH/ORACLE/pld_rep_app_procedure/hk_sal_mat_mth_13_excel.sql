...
/* Package : hk_sal_mat_mth_13_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_mat_mth_13_excel as
...
end hk_sal_mat_mth_13_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_mat_mth_13_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_mat_mth_1300 pld_sal_mat_mth_1300%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_mat_mth_1300 is 
         select *
         from pld_sal_mat_mth_1300 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_mat_mth_1300;
      fetch csr_pld_sal_mat_mth_1300 into rcd_pld_sal_mat_mth_1300;
      if csr_pld_sal_mat_mth_1300%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_mat_mth_1300;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_MAT_MTH_1300 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_mat_mth_1300.extract_status || ' ' || rcd_pld_sal_mat_mth_1300.sales_status,
                                    'Month Year End: ' || substr(to_char(rcd_pld_sal_mat_mth_1300.current_yyyymm-100,'fm000000'),1,4));
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_mat_mth_1301 t01,material_dim t02';
      hk_sal_base_excel.tbl_main_join := 't01.sap_material_code = t02.sap_material_code(+) and t01.sap_company_code = :A';

      hk_sal_base_excel.tbl_table(11).tab_name := '(select sap_material_code,m01_qty,m02_qty,m03_qty,m04_qty,m05_qty,m06_qty,m07_qty,m08_qty,m09_qty,m10_qty,m11_qty,m12_qty from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t11';
      hk_sal_base_excel.tbl_table(11).tab_join := 'and t01.sap_material_code = t11.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(12).tab_name := '(select sap_material_code,m01_ton,m02_ton,m03_ton,m04_ton,m05_ton,m06_ton,m07_ton,m08_ton,m09_ton,m10_ton,m11_ton,m12_ton from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t12';
      hk_sal_base_excel.tbl_table(12).tab_join := 'and t01.sap_material_code = t12.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(13).tab_name := '(select sap_material_code,m01_gsv,m02_gsv,m03_gsv,m04_gsv,m05_gsv,m06_gsv,m07_gsv,m08_gsv,m09_gsv,m10_gsv,m11_gsv,m12_gsv from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t13';
      hk_sal_base_excel.tbl_table(13).tab_join := 'and t01.sap_material_code = t13.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(14).tab_name := '(select sap_material_code,m01_niv,m02_niv,m03_niv,m04_niv,m05_niv,m06_niv,m07_niv,m08_niv,m09_niv,m10_niv,m11_niv,m12_niv from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''TYR'') t14';
      hk_sal_base_excel.tbl_table(14).tab_join := 'and t01.sap_material_code = t14.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(41).tab_name := '(select sap_material_code,m01_qty,m02_qty,m03_qty,m04_qty,m05_qty,m06_qty,m07_qty,m08_qty,m09_qty,m10_qty,m11_qty,m12_qty from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''LYR'') t41';
      hk_sal_base_excel.tbl_table(41).tab_join := 'and t01.sap_material_code = t41.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(42).tab_name := '(select sap_material_code,m01_ton,m02_ton,m03_ton,m04_ton,m05_ton,m06_ton,m07_ton,m08_ton,m09_ton,m10_ton,m11_ton,m12_ton from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''LYR'') t42';
      hk_sal_base_excel.tbl_table(42).tab_join := 'and t01.sap_material_code = t42.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(43).tab_name := '(select sap_material_code,m01_gsv,m02_gsv,m03_gsv,m04_gsv,m05_gsv,m06_gsv,m07_gsv,m08_gsv,m09_gsv,m10_gsv,m11_gsv,m12_gsv from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''LYR'') t43';
      hk_sal_base_excel.tbl_table(43).tab_join := 'and t01.sap_material_code = t43.sap_material_code(+)';

      hk_sal_base_excel.tbl_table(44).tab_name := '(select sap_material_code,m01_niv,m02_niv,m03_niv,m04_niv,m05_niv,m06_niv,m07_niv,m08_niv,m09_niv,m10_niv,m11_niv,m12_niv from pld_sal_mat_mth_1302 where sap_company_code = :A and dta_type = ''LYR'') t44';
      ...
      /*-*/
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_tabi := 11;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_dsql := 'sum(nvl(t11.m01_qty,0)),sum(nvl(t11.m02_qty,0)),sum(nvl(t11.m03_qty,0)),sum(nvl(t11.m04_qty,0)),sum(nvl(t11.m05_qty,0)),sum(nvl(t11.m06_qty,0)),sum(nvl(t11.m07_qty,0)),sum(nvl(t11.m08_qty,0)),sum(nvl(t11.m09_qty,0)),sum(nvl(t11.m10_qty,0)),sum(nvl(t11.m11_qty,0)),sum(nvl(t11.m12_qty,0))';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_zsql := 'nvl(t11.m01_qty,0) != 0 or nvl(t11.m02_qty,0) != 0 or nvl(t11.m03_qty,0) != 0 or nvl(t11.m04_qty,0) != 0 or nvl(t11.m05_qty,0) != 0 or nvl(t11.m06_qty,0) != 0 or nvl(t11.m07_qty,0) != 0 or nvl(t11.m08_qty,0) != 0 or nvl(t11.m09_qty,0) != 0 or nvl(t11.m10_qty,0) != 0 or nvl(t11.m11_qty,0) != 0 or nvl(t11.m12_qty,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_decp := 0;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_decr := 0;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_QTY').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_tabi := 12;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_dsql := 'sum(nvl(t12.m01_ton,0)),sum(nvl(t12.m02_ton,0)),sum(nvl(t12.m03_ton,0)),sum(nvl(t12.m04_ton,0)),sum(nvl(t12.m05_ton,0)),sum(nvl(t12.m06_ton,0)),sum(nvl(t12.m07_ton,0)),sum(nvl(t12.m08_ton,0)),sum(nvl(t12.m09_ton,0)),sum(nvl(t12.m10_ton,0)),sum(nvl(t12.m11_ton,0)),sum(nvl(t12.m12_ton,0))';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_zsql := 'nvl(t12.m01_ton,0) != 0 or nvl(t12.m02_ton,0) != 0 or nvl(t12.m03_ton,0) != 0 or nvl(t12.m04_ton,0) != 0 or nvl(t12.m05_ton,0) != 0 or nvl(t12.m06_ton,0) != 0 or nvl(t12.m07_ton,0) != 0 or nvl(t12.m08_ton,0) != 0 or nvl(t12.m09_ton,0) != 0 or nvl(t12.m10_ton,0) != 0 or nvl(t12.m11_ton,0) != 0 or nvl(t12.m12_ton,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_decp := 2;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_decr := 6;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_TON').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_tabi := 13;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_dsql := 'sum(nvl(t13.m01_gsv,0)),sum(nvl(t13.m02_gsv,0)),sum(nvl(t13.m03_gsv,0)),sum(nvl(t13.m04_gsv,0)),sum(nvl(t13.m05_gsv,0)),sum(nvl(t13.m06_gsv,0)),sum(nvl(t13.m07_gsv,0)),sum(nvl(t13.m08_gsv,0)),sum(nvl(t13.m09_gsv,0)),sum(nvl(t13.m10_gsv,0)),sum(nvl(t13.m11_gsv,0)),sum(nvl(t13.m12_gsv,0))';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_zsql := 'nvl(t13.m01_gsv,0) != 0 or nvl(t13.m02_gsv,0) != 0 or nvl(t13.m03_gsv,0) != 0 or nvl(t13.m04_gsv,0) != 0 or nvl(t13.m05_gsv,0) != 0 or nvl(t13.m06_gsv,0) != 0 or nvl(t13.m07_gsv,0) != 0 or nvl(t13.m08_gsv,0) != 0 or nvl(t13.m09_gsv,0) != 0 or nvl(t13.m10_gsv,0) != 0 or nvl(t13.m11_gsv,0) != 0 or nvl(t13.m12_gsv,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_decp := 2;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_decr := 2;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_GSV').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_tabi := 14;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_dsql := 'sum(nvl(t14.m01_niv,0)),sum(nvl(t14.m02_niv,0)),sum(nvl(t14.m03_niv,0)),sum(nvl(t14.m04_niv,0)),sum(nvl(t14.m05_niv,0)),sum(nvl(t14.m06_niv,0)),sum(nvl(t14.m07_niv,0)),sum(nvl(t14.m08_niv,0)),sum(nvl(t14.m09_niv,0)),sum(nvl(t14.m10_niv,0)),sum(nvl(t14.m11_niv,0)),sum(nvl(t14.m12_niv,0))';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_zsql := 'nvl(t14.m01_niv,0) != 0 or nvl(t14.m02_niv,0) != 0 or nvl(t14.m03_niv,0) != 0 or nvl(t14.m04_niv,0) != 0 or nvl(t14.m05_niv,0) != 0 or nvl(t14.m06_niv,0) != 0 or nvl(t14.m07_niv,0) != 0 or nvl(t14.m08_niv,0) != 0 or nvl(t14.m09_niv,0) != 0 or nvl(t14.m10_niv,0) != 0 or nvl(t14.m11_niv,0) != 0 or nvl(t14.m12_niv,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_decp := 2;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_decr := 2;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_TYR_NIV').col_lnd2 := null;

      /*-*/

      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_tabi := 41;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_dsql := 'sum(nvl(t41.m01_qty,0)),sum(nvl(t41.m02_qty,0)),sum(nvl(t41.m03_qty,0)),sum(nvl(t41.m04_qty,0)),sum(nvl(t41.m05_qty,0)),sum(nvl(t41.m06_qty,0)),sum(nvl(t41.m07_qty,0)),sum(nvl(t41.m08_qty,0)),sum(nvl(t41.m09_qty,0)),sum(nvl(t41.m10_qty,0)),sum(nvl(t41.m11_qty,0)),sum(nvl(t41.m12_qty,0))';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_zsql := 'nvl(t41.m01_qty,0) != 0 or nvl(t41.m02_qty,0) != 0 or nvl(t41.m03_qty,0) != 0 or nvl(t41.m04_qty,0) != 0 or nvl(t41.m05_qty,0) != 0 or nvl(t41.m06_qty,0) != 0 or nvl(t41.m07_qty,0) != 0 or nvl(t41.m08_qty,0) != 0 or nvl(t41.m09_qty,0) != 0 or nvl(t41.m10_qty,0) != 0 or nvl(t41.m11_qty,0) != 0 or nvl(t41.m12_qty,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_decp := 0;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_decr := 0;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_QTY').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_tabi := 42;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_dsql := 'sum(nvl(t42.m01_ton,0)),sum(nvl(t42.m02_ton,0)),sum(nvl(t42.m03_ton,0)),sum(nvl(t42.m04_ton,0)),sum(nvl(t42.m05_ton,0)),sum(nvl(t42.m06_ton,0)),sum(nvl(t42.m07_ton,0)),sum(nvl(t42.m08_ton,0)),sum(nvl(t42.m09_ton,0)),sum(nvl(t42.m10_ton,0)),sum(nvl(t42.m11_ton,0)),sum(nvl(t42.m12_ton,0))';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_zsql := 'nvl(t42.m01_ton,0) != 0 or nvl(t42.m02_ton,0) != 0 or nvl(t42.m03_ton,0) != 0 or nvl(t42.m04_ton,0) != 0 or nvl(t42.m05_ton,0) != 0 or nvl(t42.m06_ton,0) != 0 or nvl(t42.m07_ton,0) != 0 or nvl(t42.m08_ton,0) != 0 or nvl(t42.m09_ton,0) != 0 or nvl(t42.m10_ton,0) != 0 or nvl(t42.m11_ton,0) != 0 or nvl(t42.m12_ton,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_decp := 2;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_decr := 6;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_TON').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_tabi := 43;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_dsql := 'sum(nvl(t43.m01_gsv,0)),sum(nvl(t43.m02_gsv,0)),sum(nvl(t43.m03_gsv,0)),sum(nvl(t43.m04_gsv,0)),sum(nvl(t43.m05_gsv,0)),sum(nvl(t43.m06_gsv,0)),sum(nvl(t43.m07_gsv,0)),sum(nvl(t43.m08_gsv,0)),sum(nvl(t43.m09_gsv,0)),sum(nvl(t43.m10_gsv,0)),sum(nvl(t43.m11_gsv,0)),sum(nvl(t43.m12_gsv,0))';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_zsql := 'nvl(t43.m01_gsv,0) != 0 or nvl(t43.m02_gsv,0) != 0 or nvl(t43.m03_gsv,0) != 0 or nvl(t43.m04_gsv,0) != 0 or nvl(t43.m05_gsv,0) != 0 or nvl(t43.m06_gsv,0) != 0 or nvl(t43.m07_gsv,0) != 0 or nvl(t43.m08_gsv,0) != 0 or nvl(t43.m09_gsv,0) != 0 or nvl(t43.m10_gsv,0) != 0 or nvl(t43.m11_gsv,0) != 0 or nvl(t43.m12_gsv,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_decp := 2;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_decr := 2;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_GSV').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_tabi := 44;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_htxt := 'M01'||chr(9)||'M02'||chr(9)||'M03'||chr(9)||'M04'||chr(9)||'M05'||chr(9)||'M06'||chr(9)||'M07'||chr(9)||'M08'||chr(9)||'M09'||chr(9)||'M10'||chr(9)||'M11'||chr(9)||'M12';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_ccnt := 12;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_dsql := 'sum(nvl(t44.m01_niv,0)),sum(nvl(t44.m02_niv,0)),sum(nvl(t44.m03_niv,0)),sum(nvl(t44.m04_niv,0)),sum(nvl(t44.m05_niv,0)),sum(nvl(t44.m06_niv,0)),sum(nvl(t44.m07_niv,0)),sum(nvl(t44.m08_niv,0)),sum(nvl(t44.m09_niv,0)),sum(nvl(t44.m10_niv,0)),sum(nvl(t44.m11_niv,0)),sum(nvl(t44.m12_niv,0))';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_zsql := 'nvl(t44.m01_niv,0) != 0 or nvl(t44.m02_niv,0) != 0 or nvl(t44.m03_niv,0) != 0 or nvl(t44.m04_niv,0) != 0 or nvl(t44.m05_niv,0) != 0 or nvl(t44.m06_niv,0) != 0 or nvl(t44.m07_niv,0) != 0 or nvl(t44.m08_niv,0) != 0 or nvl(t44.m09_niv,0) != 0 or nvl(t44.m10_niv,0) != 0 or nvl(t44.m11_niv,0) != 0 or nvl(t44.m12_niv,0) != 0';
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_decp := 2;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_decr := 2;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_scle := 1;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_ref1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_ref2 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('MLY0112_LYR_NIV').col_lnd2 := null;
...
/**************************/
create or replace public synonym hk_sal_mat_mth_13_excel for pld_rep_app.hk_sal_mat_mth_13_excel;
grant execute on hk_sal_mat_mth_13_excel to public;