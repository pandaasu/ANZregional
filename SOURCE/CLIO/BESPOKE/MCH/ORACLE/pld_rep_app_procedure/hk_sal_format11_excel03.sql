...
/* Package : hk_sal_format11_excel03                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_format11_excel03 as

/**DESCRIPTION**
 Excess Sales Report - Billing date aggregations.
...
end hk_sal_format11_excel03;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_format11_excel03 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Excess Sales Report - Period - BR Forecast (HK$ Thousands) - Billing Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'PRD_RB' then
         var_wrk_string := 'Excess Sales Report - Period - ROB Forecast (HK$ Thousands) - Billing Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Excess Sales Report - Month - BR Forecast (HK$ Thousands) - Billing Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_RB' then
         var_wrk_string := 'Excess Sales Report - Month - ROB Forecast (HK$ Thousands) - Billing Date - Tracking > ' || to_char(var_rpt_percent,'FM990.00') || '%';
      end if;
...
/**************************/
create or replace public synonym hk_sal_format11_excel03 for pld_rep_app.hk_sal_format11_excel03;
grant execute on hk_sal_format11_excel03 to public;
