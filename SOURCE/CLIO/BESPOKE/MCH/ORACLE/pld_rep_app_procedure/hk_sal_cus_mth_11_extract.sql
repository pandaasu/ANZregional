...
/* Package : hk_sal_cus_mth_11_extract                          */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_mth_11_extract as

/**DESCRIPTION**
 Customer MTD month billing date extract.
...
end hk_sal_cus_mth_11_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_mth_11_extract as
   ...
   begin
      ...
      /**/
      delete from pld_sal_cus_mth_1100 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_mth_1101 where sap_company_code = par_sap_company_code;
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_cus_mth_1100
         (sap_company_code,
          extract_date,
          logical_date,
          current_yyyymm,
   ...
   begin
      ...
      loop
         ...
         createMonthHeader(order_fact_r01.sap_company_code,
   ...
   begin
      ...
      /*-*/
      select trunc(logical_date) into var_logical_date from pld_sal_cus_mth_1100 where sap_company_code = par_sap_company_code;
      select current_yyyymm into var_current_yyyymm from pld_sal_cus_mth_1100 where sap_company_code = par_sap_company_code;
      ...
      loop
         ...
         createMonthHeader(sales_fact_r01.sap_company_code,
      ...
      /*-*/
      /* Extract the month sales values - current month
      /*-*/
   ...
   procedure exe_forecast_data(par_sap_company_code in varchar2) is
      ...
      cursor fcst_month_01_fact_c01 is 
         ...
         where t01.sap_material_code = t02.sap_material_code(+)
           ...
           and t01.billing_yyyymm = var_current_yyyymm
           and (t01.op_qty <> 0 or
                t01.br_qty <> 0 or
                t01.rb_qty <> 0 or
   ...
   procedure createMonthHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions
      /*-*/
      cursor pld_sal_cus_mth_1101_c01 is 
         select 'x'
         from pld_sal_cus_mth_1101
         where pld_sal_cus_mth_1101.sap_company_code = par_sap_company_code
           and pld_sal_cus_mth_1101.sap_ship_to_cust_code = par_sap_ship_to_cust_code
           and pld_sal_cus_mth_1101.sap_sales_org_code = par_sap_sales_org_code
           and pld_sal_cus_mth_1101.sap_distbn_chnl_code = par_sap_distbn_chnl_code
           and pld_sal_cus_mth_1101.sap_division_code = par_sap_division_code
           and pld_sal_cus_mth_1101.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_cus_mth_1101_c01;
      fetch pld_sal_cus_mth_1101_c01 into var_work;
      if pld_sal_cus_mth_1101_c01%notfound then
         insert into pld_sal_cus_mth_1101
            (sap_company_code,
      ...
      close pld_sal_cus_mth_1101_c01;
...
/**************************/
create or replace public synonym hk_sal_cus_mth_11_extract for pld_rep_app.hk_sal_cus_mth_11_extract;
grant execute on hk_sal_cus_mth_11_extract to public;