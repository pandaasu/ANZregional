...
/* Package Header */
/******************/
create or replace package hk_csl_prd_01_extract as

/**DESCRIPTION**
 Customer service level period invoice date extract
...
end hk_csl_prd_01_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_csl_prd_01_extract as
   ...
   begin
      ...
      /**/
      delete from pld_csl_prd_0100 where sap_company_code = par_sap_company_code;
      delete from pld_csl_prd_0101 where sap_company_code = par_sap_company_code;
      delete from pld_csl_prd_0102 where sap_company_code = par_sap_company_code;
      commit;
         ...
         select t01.sap_company_code as sap_company_code,
           ...
           from (select t01.sap_company_code as sap_company_code,
                  ...
                  where t01.ord_doc_num = t02.sales_doc_num
                    ...
                    and t02.billing_yyyypp = var_current_yyyypp
                  union all
                 select t01.sap_company_code as sap_company_code,
                        t01.sap_ship_to_cust_code as sap_ship_to_cust_code,
                        t01.sap_sales_hdr_sales_org_code as sap_sales_hdr_sales_org_code,
   ...
   begin
      ...
      /*-*/
      select current_yyyypp into var_current_yyyypp from pld_csl_prd_0100 where sap_company_code = par_sap_company_code;
      var_current_yyyypp := mfjpln_control.previousPeriod(var_current_yyyypp, true);

      /*-*/
      /* Extract the order invoiced values
      /*-*/
      open order_fact_c01;
      loop
...
/**************************/
create or replace public synonym hk_csl_prd_01_extract for pld_rep_app.hk_csl_prd_01_extract;
grant execute on hk_csl_prd_01_extract to public;