...
/* Package : hk_sal_cus_prd_11_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_prd_11_excel as
...
end hk_sal_cus_prd_11_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_prd_11_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_cus_prd_1100 pld_sal_cus_prd_1100%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_cus_prd_1100 is 
         select *
         from pld_sal_cus_prd_1100 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_cus_prd_1100;
      fetch csr_pld_sal_cus_prd_1100 into rcd_pld_sal_cus_prd_1100;
      if csr_pld_sal_cus_prd_1100%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_cus_prd_1100;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_CUS_PRD_1100 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_cus_prd_1100.extract_status || ' ' || rcd_pld_sal_cus_prd_1100.sales_status,
                                    rcd_pld_sal_cus_prd_1100.prd_asofdays);
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_cus_prd_1101 t01,material_dim t02,std_hier t03';
      ...
      hk_sal_base_excel.tbl_main_join := hk_sal_base_excel.tbl_main_join || ' and t02.sap_material_type_code not in (''ZPRM'',''ZHIE'')';
      ...
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_htxt := 'Unposted+Actual QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_dsql := 'sum(nvl(t01.ord_uc_qty,0)+nvl(t01.ord_cn_qty,0)+nvl(t01.cur_ty_qty,0))';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_zsql := '(nvl(t01.ord_uc_qty,0)+nvl(t01.ord_cn_qty,0)+nvl(t01.cur_ty_qty,0)) != 0';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_decp := 0;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_decr := 0;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_ref1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_ref2 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_htxt := 'Unposted+Actual TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_dsql := 'sum(nvl(t01.ord_uc_ton,0)+nvl(t01.ord_cn_ton,0)+nvl(t01.cur_ty_ton,0))';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_zsql := '(nvl(t01.ord_uc_ton,0)+nvl(t01.ord_cn_ton,0)+nvl(t01.cur_ty_ton,0)) != 0';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_decp := 6;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_ref1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_ref2 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_htxt := 'Unposted+Actual GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_dsql := 'sum(nvl(t01.ord_uc_gsv,0)+nvl(t01.ord_cn_gsv,0)+nvl(t01.cur_ty_gsv,0))';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_zsql := '(nvl(t01.ord_uc_gsv,0)+nvl(t01.ord_cn_gsv,0)+nvl(t01.cur_ty_gsv,0)) != 0';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_ref1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_ref2 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV').col_lnd2 := null;

      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_htxt := 'Unposted+Actual NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_ctyp := '1';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_dsql := 'sum(nvl(t01.ord_uc_niv,0)+nvl(t01.ord_cn_niv,0)+nvl(t01.cur_ty_niv,0))';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_zsql := '(nvl(t01.ord_uc_niv,0)+nvl(t01.ord_cn_niv,0)+nvl(t01.cur_ty_niv,0)) != 0';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_ref1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_ref2 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_lnd1 := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV').col_lnd2 := null;
      ...
      hk_sal_base_excel.tbl_column('ORD_UC_TON_SHR').col_htxt := 'Unconfirmed TON % Share';
      ...
      hk_sal_base_excel.tbl_column('ORD_CN_TON_SHR').col_htxt := 'Confirmed TON % Share';
      ...
      hk_sal_base_excel.tbl_column('ORD_UP_TON_SHR').col_htxt := 'Unposted TON % Share';
      ...
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_htxt := 'Unposted+Actual QTY % Share';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_ref1 := 'ORD_TOT_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_ref2 := 'ORD_TOT_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_QTY_SHR').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_htxt := 'Unposted+Actual TON % Share';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_ref1 := 'ORD_TOT_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_ref2 := 'ORD_TOT_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_TON_SHR').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_htxt := 'Unposted+Actual GSV % Share';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_ref1 := 'ORD_TOT_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_ref2 := 'ORD_TOT_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_GSV_SHR').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_htxt := 'Unposted+Actual NIV % Share';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_ref1 := 'ORD_TOT_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_ref2 := 'ORD_TOT_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_NIV_SHR').col_lnd2 := 'NoY';
      ...
      hk_sal_base_excel.tbl_column('CUR_DY_TON_SHR').col_htxt := 'Day TON % Share';
      ...
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_htxt := 'Unpost+Actual QTY % OP';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_ref1 := 'ORD_TOT_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_ref2 := 'PTD_OP_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_QTY').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_htxt := 'Unpost+Actual TON % OP';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_ref1 := 'ORD_TOT_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_ref2 := 'PTD_OP_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_TON').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_htxt := 'Unpost+Actual GSV % OP';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_ref1 := 'ORD_TOT_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_ref2 := 'PTD_OP_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_GSV').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_htxt := 'Unpost+Actual NIV % OP';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_ref1 := 'ORD_TOT_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_ref2 := 'PTD_OP_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_OP_NIV').col_lnd2 := 'NoY';
      ...
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_htxt := 'Unpost+Actual QTY % BR';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_ref1 := 'ORD_TOT_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_ref2 := 'PTD_BR_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_QTY').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_htxt := 'Unpost+Actual TON % BR';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_ref1 := 'ORD_TOT_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_ref2 := 'PTD_BR_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_TON').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_htxt := 'Unpost+Actual GSV % BR';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_ref1 := 'ORD_TOT_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_ref2 := 'PTD_BR_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_GSV').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_htxt := 'Unpost+Actual NIV % BR';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_ref1 := 'ORD_TOT_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_ref2 := 'PTD_BR_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_BR_NIV').col_lnd2 := 'NoY';
      ...
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_htxt := 'Unpost+Actual QTY % ROB';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_ref1 := 'ORD_TOT_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_ref2 := 'PTD_RB_QTY';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_QTY').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_htxt := 'Unpost+Actual TON % ROB';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_ref1 := 'ORD_TOT_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_ref2 := 'PTD_RB_TON';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_TON').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_htxt := 'Unpost+Actual GSV % ROB';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_ref1 := 'ORD_TOT_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_ref2 := 'PTD_RB_GSV';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_GSV').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_tabi := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_htxt := 'Unpost+Actual NIV % ROB';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_ctyp := '2';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_dsql := '0';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_zsql := null;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_decp := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_decr := 2;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_scle := 1;
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_ref1 := 'ORD_TOT_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_ref2 := 'PTD_RB_NIV';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('ORD_TOT_RB_NIV').col_lnd2 := 'NoY';
      ...
      hk_sal_base_excel.tbl_column('PTD_LY_TON_SHR').col_htxt := 'SPLY TON % Share';
...
/**************************/
create or replace public synonym hk_sal_cus_prd_11_excel for pld_rep_app.hk_sal_cus_prd_11_excel;
grant execute on hk_sal_cus_prd_11_excel to public;