...
/* Package : hk_sal_cus_prd_03_extract                          */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_prd_03_extract as

/**DESCRIPTION**
 Customer PLY period invoice date extract.
...
end hk_sal_cus_prd_03_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_prd_03_extract as
   ...
   begin
      ...
      /**/
      delete from pld_sal_cus_prd_0300 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_prd_0301 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_prd_0302 where sap_company_code = par_sap_company_code;
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_cus_prd_0300
         (sap_company_code,
          extract_date,
          logical_date,
          current_yyyypp,
   ...
   begin
      ...
      /*-*/
      select current_yyyypp into var_current_yyyypp from pld_sal_cus_prd_0300 where sap_company_code = par_sap_company_code;
      ...
      loop
         ...
         update pld_sal_cus_prd_0301
            set tot_ty_qty = tot_ty_qty + sales_period_01_fact_r01.billed_qty,
                tot_ty_ton = tot_ty_ton + sales_period_01_fact_r01.billed_ton,
                tot_ty_gsv = tot_ty_gsv + sales_period_01_fact_r01.billed_gsv,
                tot_ty_niv = tot_ty_niv + sales_period_01_fact_r01.billed_niv
      ...
      loop
         ...
         update pld_sal_cus_prd_0301
            set tot_ly_qty = tot_ly_qty + sales_period_01_fact_r01.billed_qty,
                tot_ly_ton = tot_ly_ton + sales_period_01_fact_r01.billed_ton,
                tot_ly_gsv = tot_ly_gsv + sales_period_01_fact_r01.billed_gsv,
                tot_ly_niv = tot_ly_niv + sales_period_01_fact_r01.billed_niv
            where sap_company_code = sales_period_01_fact_r01.sap_company_code
              and sap_ship_to_cust_code = sales_period_01_fact_r01.sap_ship_to_cust_code
              and sap_sales_org_code = sales_period_01_fact_r01.sap_sales_dtl_sales_org_code
              and sap_distbn_chnl_code = sales_period_01_fact_r01.sap_sales_dtl_distbn_chnl_code
   ...
   procedure createPeriodHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions
      /*-*/
      cursor pld_sal_cus_prd_0301_c01 is 
         select 'x'
         from pld_sal_cus_prd_0301
         where pld_sal_cus_prd_0301.sap_company_code = par_sap_company_code
           and pld_sal_cus_prd_0301.sap_ship_to_cust_code = par_sap_ship_to_cust_code
           and pld_sal_cus_prd_0301.sap_sales_org_code = par_sap_sales_org_code
           and pld_sal_cus_prd_0301.sap_distbn_chnl_code = par_sap_distbn_chnl_code
           and pld_sal_cus_prd_0301.sap_division_code = par_sap_division_code
           and pld_sal_cus_prd_0301.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_cus_prd_0301_c01;
      fetch pld_sal_cus_prd_0301_c01 into var_work;
      if pld_sal_cus_prd_0301_c01%notfound then
         insert into pld_sal_cus_prd_0301
            (sap_company_code,
      ...
      close pld_sal_cus_prd_0301_c01;
   ...
   begin 
      ...
      /*-*/
      insert into pld_sal_cus_prd_0302
         (sap_company_code,
          sap_ship_to_cust_code,
          sap_sales_org_code,
          sap_distbn_chnl_code,
...
/**************************/
create or replace public synonym hk_sal_cus_prd_03_extract for pld_rep_app.hk_sal_cus_prd_03_extract;
grant execute on hk_sal_cus_prd_03_extract to public;