...
/* Package : hk_sal_cus_mth_02_extract                          */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_mth_02_extract as

/**DESCRIPTION**
 Customer MTH month invoice date extract.
...
end hk_sal_cus_mth_02_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_mth_02_extract as
   ...
   begin
      ...
      /**/
      delete from pld_sal_cus_mth_0200 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_mth_0201 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_mth_0202 where sap_company_code = par_sap_company_code;
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_cus_mth_0200
         (sap_company_code,
          extract_date,
          logical_date,
          current_yyyymm,
   ...
   begin
      ...
      /*-*/
      select current_yyyymm into var_current_yyyymm from pld_sal_cus_mth_0200 where sap_company_code = par_sap_company_code;
      ...
      loop
         ...
         createMonthHeader(sales_month_01_fact_r01.sap_company_code,
                           sales_month_01_fact_r01.sap_ship_to_cust_code,
                           sales_month_01_fact_r01.sap_sales_dtl_sales_org_code,
                           sales_month_01_fact_r01.sap_sales_dtl_distbn_chnl_code,
                           sales_month_01_fact_r01.sap_sales_dtl_division_code,
                           sales_month_01_fact_r01.sap_material_code);

         if sales_month_01_fact_r01.billing_yyyymm = var_current_yyyymm - 1  then
            update pld_sal_cus_mth_0201
               ...
               where sap_company_code = sales_month_01_fact_r01.sap_company_code
                 and sap_ship_to_cust_code = sales_month_01_fact_r01.sap_ship_to_cust_code
                 and sap_sales_org_code = sales_month_01_fact_r01.sap_sales_dtl_sales_org_code
                 and sap_distbn_chnl_code = sales_month_01_fact_r01.sap_sales_dtl_distbn_chnl_code
                 and sap_division_code = sales_month_01_fact_r01.sap_sales_dtl_division_code
   ...
   procedure createMonthHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions
      /*-*/
      cursor pld_sal_cus_mth_0201_c01 is 
         select 'x'
         from pld_sal_cus_mth_0201
         where pld_sal_cus_mth_0201.sap_company_code = par_sap_company_code
           and pld_sal_cus_mth_0201.sap_ship_to_cust_code = par_sap_ship_to_cust_code
           and pld_sal_cus_mth_0201.sap_sales_org_code = par_sap_sales_org_code
           and pld_sal_cus_mth_0201.sap_distbn_chnl_code = par_sap_distbn_chnl_code
           and pld_sal_cus_mth_0201.sap_division_code = par_sap_division_code
           and pld_sal_cus_mth_0201.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_cus_mth_0201_c01;
      fetch pld_sal_cus_mth_0201_c01 into var_work;
      if pld_sal_cus_mth_0201_c01%notfound then
         insert into pld_sal_cus_mth_0201
            (sap_company_code,
      ...
      close pld_sal_cus_mth_0201_c01;
   ...
   begin 
      ...
      /*-*/
      insert into pld_sal_cus_mth_0202
         (sap_company_code,
          sap_ship_to_cust_code,
          sap_sales_org_code,
          sap_distbn_chnl_code,
...
/**************************/
create or replace public synonym hk_sal_cus_mth_02_extract for pld_rep_app.hk_sal_cus_mth_02_extract;
grant execute on hk_sal_cus_mth_02_extract to public;