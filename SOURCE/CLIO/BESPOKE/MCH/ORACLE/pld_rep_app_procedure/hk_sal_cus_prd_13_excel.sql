...
/* Package : hk_sal_cus_prd_13_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_prd_13_excel as
...
end hk_sal_cus_prd_13_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_prd_13_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_cus_prd_1300 pld_sal_cus_prd_1300%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_cus_prd_1300 is 
         select *
         from pld_sal_cus_prd_1300 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_cus_prd_1300;
      fetch csr_pld_sal_cus_prd_1300 into rcd_pld_sal_cus_prd_1300;
      if csr_pld_sal_cus_prd_1300%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_cus_prd_1300;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_CUS_PRD_1300 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_cus_prd_1300.extract_status || ' ' || rcd_pld_sal_cus_prd_1300.sales_status,
                                    'Period Year End: ' || substr(to_char(rcd_pld_sal_cus_prd_1300.current_yyyypp-100,'fm000000'),1,4));
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_cus_prd_1301 t01,material_dim t02,std_hier t03';
      ...
      hk_sal_base_excel.tbl_table(11).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_cus_prd_1302 where sap_company_code = :A and dta_type = ''TYR'') t11';
      ...
      hk_sal_base_excel.tbl_table(14).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_cus_prd_1302 where sap_company_code = :A and dta_type = ''TYR'') t14';
...
/**************************/
create or replace public synonym hk_sal_cus_prd_13_excel for pld_rep_app.hk_sal_cus_prd_13_excel;
grant execute on hk_sal_cus_prd_13_excel to public;