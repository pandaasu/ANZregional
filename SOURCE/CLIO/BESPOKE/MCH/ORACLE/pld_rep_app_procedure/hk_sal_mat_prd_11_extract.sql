...
/* Package : hk_sal_mat_prd_11_extract                          */
...
/* Package Header */
/******************/
create or replace package hk_sal_mat_prd_11_extract as

/**DESCRIPTION**
 Material PTD period billing date extract.
...
end hk_sal_mat_prd_11_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_mat_prd_11_extract as
   ...
   begin
      ...
      /**/
      delete from pld_sal_mat_prd_1100 where sap_company_code = par_sap_company_code; 
      delete from pld_sal_mat_prd_1101 where sap_company_code = par_sap_company_code;
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_mat_prd_1100
         (sap_company_code,
          extract_date,
          logical_date,
          current_yyyypp,
   ...
   begin
      ...
      /*-*/
      select trunc(logical_date) into var_logical_date from pld_sal_mat_prd_1100 where sap_company_code = par_sap_company_code;
      select current_yyyypp into var_current_yyyypp from pld_sal_mat_prd_1100 where sap_company_code = par_sap_company_code;
   ...
   procedure createPeriodHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions
      /*-*/
      cursor pld_sal_mat_prd_1101_c01 is 
         select 'x'
         from pld_sal_mat_prd_1101
         where pld_sal_mat_prd_1101.sap_company_code = par_sap_company_code
           and pld_sal_mat_prd_1101.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_mat_prd_1101_c01;
      fetch pld_sal_mat_prd_1101_c01 into var_work;
      if pld_sal_mat_prd_1101_c01%notfound then
         insert into pld_sal_mat_prd_1101
            (sap_company_code,
             sap_material_code,
             ord_uc_qty,
             ord_uc_ton,
      ...
      close pld_sal_mat_prd_1101_c01;
...
/**************************/
create or replace public synonym hk_sal_mat_prd_11_extract for pld_rep_app.hk_sal_mat_prd_11_extract;
grant execute on hk_sal_mat_prd_11_extract to public;