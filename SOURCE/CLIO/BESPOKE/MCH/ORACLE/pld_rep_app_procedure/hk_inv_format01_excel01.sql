...
/* Package : hk_inv_format01_excel01                            */
...
/* Package Header */
/******************/
create or replace package hk_inv_format01_excel01 as
 ...
 **NOTES**
 ...
 5. The doCover procedure must be synchronised with hk_inv_format01_extract cover calculation
...
end hk_inv_format01_excel01;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_inv_format01_excel01 as
   ...
   type rcdSummary is record(current_value varchar2(256 char),
                             ...
                             wrk_billed_qty number,
                             wrk_fc_qty number,
                             wrk_ft_qty number,
                             wrk_ons_qty number,
                             wrk_ons_cover number,
                             wrk_sal_qty number,
                             wrk_sal_cover number);
   ...
   begin
      ...
      if var_for_type = 'PRD_BR' then
         if var_inv_type = 'F' then
            var_wrk_string := 'Standard Finished Goods Inventory Report - Period - BR Forecast (HK$ Thousands)';
         else
            var_wrk_string := 'Standard Bulk Inventory Report - Period - BR Forecast (HK$ Thousands)';
         end if;
      elsif var_for_type = 'PRD_RB' then
         if var_inv_type = 'F' then
            var_wrk_string := 'Standard Finished Goods Inventory Report - Period - ROB Forecast (HK$ Thousands)';
         else
            var_wrk_string := 'Standard Bulk Inventory Report - Period - ROB Forecast HK$ Thousands)';
         end if;
      elsif var_for_type = 'MTH_BR' then
         if var_inv_type = 'F' then
            var_wrk_string := 'Standard Finished Goods Inventory Report - Month - BR Forecast (HK$ Thousands)';
         else
            var_wrk_string := 'Standard Bulk Inventory Report - Month - BR Forecast (HK$ Thousands)';
         end if;
      elsif var_for_type = 'MTH_RB' then
         if var_inv_type = 'F' then
            var_wrk_string := 'Standard Finished Goods Inventory Report - Month - ROB Forecast (HK$ Thousands)';
         else
            var_wrk_string := 'Standard Bulk Inventory Report - Month - ROB Forecast (HK$ Thousands)';
         end if;
      end if;
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' or var_for_type = 'PRD_RB' then
      ...
      elsif var_for_type = 'MTH_BR' or var_for_type = 'MTH_RB' then
...
/**************************/
create or replace public synonym hk_inv_format01_excel01 for pld_rep_app.hk_inv_format01_excel01;
grant execute on hk_inv_format01_excel01 to public;