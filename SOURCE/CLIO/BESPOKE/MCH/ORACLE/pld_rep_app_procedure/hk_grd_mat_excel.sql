...
/* Package Header */
/******************/
create or replace package hk_grd_mat_excel as
...
end hk_grd_mat_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_grd_mat_excel as
...
/**************************/
create or replace public synonym hk_grd_mat_excel for pld_rep_app.hk_grd_mat_excel;
grant execute on hk_grd_mat_excel to public;