...
/* Package : hk_sal_format11_excel02                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_format11_excel02 as

/**DESCRIPTION**
 Slow Sales Report - Billing date aggregations.
...
end hk_sal_format11_excel02;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_format11_excel02 as
   ...
   function main(par_sap_company_code in varchar2,
      ...
      cursor pld_sal_format1100_c01 is 
         ...
         where pld_sal_format1100.sap_company_code = var_sap_company_code;
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Slow Sales Report - Period - BR Forecast (HK$ Thousands) - Billing Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'PRD_RB' then
         var_wrk_string := 'Slow Sales Report - Period - ROB Forecast (HK$ Thousands) - Billing Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Slow Sales Report - Month - BR Forecast (HK$ Thousands) - Billing Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      elsif var_for_type = 'MTH_RB' then
         var_wrk_string := 'Slow Sales Report - Month - ROB Forecast (HK$ Thousands) - Billing Date - Tracking < ' || to_char(var_rpt_percent,'FM990.00') || '%';
      end if;
...
/**************************/
create or replace public synonym hk_sal_format11_excel02 for pld_rep_app.hk_sal_format11_excel02;
grant execute on hk_sal_format11_excel02 to public;