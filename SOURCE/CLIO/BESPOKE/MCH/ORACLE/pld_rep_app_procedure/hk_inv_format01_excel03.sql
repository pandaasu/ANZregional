...
/* Package : hk_inv_format01_excel03                            */
...
/* Package Header */
/******************/
create or replace package hk_inv_format01_excel03 as
...
end hk_inv_format01_excel03;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_inv_format01_excel03 as
   ...
   begin
      ...
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'Finished Goods Inventory Excess Exceptions Report (greater than ' || to_char(var_stock_excess_cover,'FM90') || ' weeks cover) - Period - BR Forecast (HK$ Thousands)';
      elsif var_for_type = 'PRD_RB' then
         var_wrk_string := 'Finished Goods Inventory Excess Exceptions Report (greater than ' || to_char(var_stock_excess_cover,'FM90') || ' weeks cover) - Period - ROB Forecast (HK$ Thousands)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'Finished Goods Inventory Excess Exceptions Report (greater than ' || to_char(var_stock_excess_cover,'FM90') || ' weeks cover) - Month - BR Forecast (HK$ Thousands)';
      elsif var_for_type = 'MTH_RB' then
         var_wrk_string := 'Finished Goods Inventory Excess Exceptions Report (greater than ' || to_char(var_stock_excess_cover,'FM90') || ' weeks cover) - Month - ROB Forecast (HK$ Thousands)';
      end if;
...
/**************************/
create or replace public synonym hk_inv_format01_excel03 for pld_rep_app.hk_inv_format01_excel03;
grant execute on hk_inv_format01_excel03 to public;