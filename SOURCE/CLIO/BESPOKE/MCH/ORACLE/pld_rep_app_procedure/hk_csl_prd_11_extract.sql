...
/* Package Header */
/******************/
create or replace package hk_csl_prd_11_extract as
...
end hk_csl_prd_11_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_csl_prd_11_extract as
   ...
   begin
      ...
      /**/
      delete from pld_csl_prd_1100 where sap_company_code = par_sap_company_code;
      delete from pld_csl_prd_1101 where sap_company_code = par_sap_company_code;
      delete from pld_csl_prd_1102 where sap_company_code = par_sap_company_code;
      commit;
   ...
   begin
      ...
      /*-*/
      select current_yyyypp into var_current_yyyypp from pld_csl_prd_1100 where sap_company_code = par_sap_company_code;
...
/**************************/
create or replace public synonym hk_csl_prd_11_extract for pld_rep_app.hk_csl_prd_11_extract;
grant execute on hk_csl_prd_11_extract to public;