...
/* Package : hk_sal_cus_prd_12_extract                          */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_prd_12_extract as

/**DESCRIPTION**
 Customer PRD period billing date extract.
...
end hk_sal_cus_prd_12_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_prd_12_extract as
   ...
   begin
      ...
      /**/
      delete from pld_sal_cus_prd_1200 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_prd_1201 where sap_company_code = par_sap_company_code;
      delete from pld_sal_cus_prd_1202 where sap_company_code = par_sap_company_code;
      commit;
   ...
   begin
      ...
      /*-*/
      insert into pld_sal_cus_prd_1200
         (sap_company_code,
          extract_date,
          logical_date,
          current_yyyypp,
   ...
   begin
      ...
      /*-*/
      select current_yyyypp into var_current_yyyypp from pld_sal_cus_prd_1200 where sap_company_code = par_sap_company_code;
   ...
   procedure createPeriodHeader(par_sap_company_code in varchar2,
      ...
      /* Cursor definitions
      /*-*/
      cursor pld_sal_cus_prd_1201_c01 is 
         select 'x'
         from pld_sal_cus_prd_1201
         where pld_sal_cus_prd_1201.sap_company_code = par_sap_company_code
           and pld_sal_cus_prd_1201.sap_ship_to_cust_code = par_sap_ship_to_cust_code
           and pld_sal_cus_prd_1201.sap_sales_org_code = par_sap_sales_org_code
           and pld_sal_cus_prd_1201.sap_distbn_chnl_code = par_sap_distbn_chnl_code
           and pld_sal_cus_prd_1201.sap_division_code = par_sap_division_code
           and pld_sal_cus_prd_1201.sap_material_code = par_sap_material_code;
   ...
   begin
      ...
      /*-*/
      open pld_sal_cus_prd_1201_c01;
      fetch pld_sal_cus_prd_1201_c01 into var_work;
      if pld_sal_cus_prd_1201_c01%notfound then
         insert into pld_sal_cus_prd_1201
            (sap_company_code,
      ...
      close pld_sal_cus_prd_1201_c01;
   ...
   begin 
      ...
      /*-*/
      insert into pld_sal_cus_prd_1202
         (sap_company_code,
          sap_ship_to_cust_code,
          sap_sales_org_code,
          sap_distbn_chnl_code,
...
/**************************/
create or replace public synonym hk_sal_cus_prd_12_extract for pld_rep_app.hk_sal_cus_prd_12_extract;
grant execute on hk_sal_cus_prd_12_extract to public;