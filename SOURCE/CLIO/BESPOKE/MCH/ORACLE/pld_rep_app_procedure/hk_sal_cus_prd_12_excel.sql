...
/* Package : hk_sal_cus_prd_12_excel                            */
...
/* Package Header */
/******************/
create or replace package hk_sal_cus_prd_12_excel as
...
end hk_sal_cus_prd_12_excel;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_sal_cus_prd_12_excel as

   /*-*/
   /* Private package variables
   /*-*/
   rcd_pld_sal_cus_prd_1200 pld_sal_cus_prd_1200%rowtype;
   ...
   procedure start_report(par_company_code in varchar2) is
      ...
      /* Cursor definitions
      /*-*/
      cursor csr_pld_sal_cus_prd_1200 is 
         select *
         from pld_sal_cus_prd_1200 t01
   ...
   begin
      ...
      /*-*/
      var_found := true;
      open csr_pld_sal_cus_prd_1200;
      fetch csr_pld_sal_cus_prd_1200 into rcd_pld_sal_cus_prd_1200;
      if csr_pld_sal_cus_prd_1200%notfound then
         var_found := false;
      end if;
      close csr_pld_sal_cus_prd_1200;
      if var_found = false then
         raise_application_error(-20000, 'Extract control row PLD_SAL_CUS_PRD_1200 not found');
      end if;
   ...
   begin
      ...
      hk_sal_base_excel.start_sheet(par_htxt1,
                                    rcd_pld_sal_cus_prd_1200.extract_status || ' ' || rcd_pld_sal_cus_prd_1200.sales_status,
                                    'Period End: ' || substr(to_char(rcd_pld_sal_cus_prd_1200.current_yyyypp,'fm000000'),1,4) || '/' || substr(to_char(rcd_pld_sal_cus_prd_1200.current_yyyypp-1,'fm000000'),5,6));
   ...
   begin
      ...
      /*-*/
      hk_sal_base_excel.tbl_main_name := 'pld_sal_cus_prd_1201 t01,material_dim t02,std_hier t03';
      ...
      hk_sal_base_excel.tbl_table(11).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,p01_qty,p02_qty,p03_qty,p04_qty,p05_qty,p06_qty,p07_qty,p08_qty,p09_qty,p10_qty,p11_qty,p12_qty,p13_qty from pld_sal_cus_prd_1202 where sap_company_code = :A and dta_type = ''AOP'') t11';
      ...
      hk_sal_base_excel.tbl_table(14).tab_name := '(select sap_ship_to_cust_code,sap_sales_org_code,sap_distbn_chnl_code,sap_division_code,sap_material_code,p01_niv,p02_niv,p03_niv,p04_niv,p05_niv,p06_niv,p07_niv,p08_niv,p09_niv,p10_niv,p11_niv,p12_niv,p13_niv from pld_sal_cus_prd_1202 where sap_company_code = :A and dta_type = ''AOP'') t14';
      ...
      hk_sal_base_excel.tbl_column('YTD_TY_OP_QTY').col_ref1 := 'YTD_TY_QTY';
      hk_sal_base_excel.tbl_column('YTD_TY_OP_QTY').col_ref2 := 'YTD_OP_QTY';
      ...
      hk_sal_base_excel.tbl_column('YTD_TY_TON_SHR').col_htxt := 'YTD ACT TON % Share';
      ...
      hk_sal_base_excel.tbl_column('YTD_LY_TON_SHR').col_htxt := 'YTD LY TON % Share';
      ...
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_htxt := 'YTG BR QTY % Share';
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_ref1 := 'YTG_BR_QTY';
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_ref2 := 'YTG_BR_QTY';
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('YTG_BR_QTY_SHR').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_htxt := 'YTG BR TON % Share';
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_ref1 := 'YTG_BR_TON';
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_ref2 := 'YTG_BR_TON';
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('YTG_BR_TON_SHR').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_htxt := 'YTG BR GSV % Share';
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_ref1 := 'YTG_BR_GSV';
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_ref2 := 'YTG_BR_GSV';
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('YTG_BR_GSV_SHR').col_lnd2 := 'NoY';

      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_tabi := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_htxt := 'YTG BR NIV % Share';
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_ctyp := '3';
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_ccnt := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_dsql := '0';
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_zsql := null;
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_decp := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_decr := 2;
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_scle := 1;
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_ref1 := 'YTG_BR_NIV';
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_ref2 := 'YTG_BR_NIV';
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_lnd1 := 'NoX';
      hk_sal_base_excel.tbl_column('YTG_BR_NIV_SHR').col_lnd2 := 'NoY';
      ...
      hk_sal_base_excel.tbl_column('YEE_TB_TON_SHR').col_htxt := 'YEE ACT/BR TON % Share';
      ...
      hk_sal_base_excel.tbl_column('YEE_TR_TON_SHR').col_htxt := 'YEE ACT/ROB TON % Share';
      ...
      hk_sal_base_excel.tbl_column('YEE_LY_TON_SHR').col_htxt := 'YEE LY TON % Share';
...
/**************************/
create or replace public synonym hk_sal_cus_prd_12_excel for pld_rep_app.hk_sal_cus_prd_12_excel;
grant execute on hk_sal_cus_prd_12_excel to public;