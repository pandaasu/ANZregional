...
/* Package : hk_inv_format02_excel03                            */
...
/* Package Header */
/******************/
create or replace package hk_inv_format02_excel03 as
...
end hk_inv_format02_excel03;
/

/****************/
/* Package Body */
/****************/
create or replace package body hk_inv_format02_excel03 as
   ...
   begin
      ...
      /*-*/
      if var_for_type = 'PRD_BR' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Period - BR Forecast (HK$ Thousands)';
      elsif var_for_type = 'PRD_RB' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Period - ROB Forecast (HK$ Thousands)';
      elsif var_for_type = 'MTH_BR' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Month - BR Forecast (HK$ Thousands)';
      elsif var_for_type = 'MTH_RB' then
         var_wrk_string := 'No Forecast Product Unrestricted Inventory Report - Month - ROB Forecast (HK$ Thousands)';
      end if;
...
/**************************/
create or replace public synonym hk_inv_format02_excel03 for pld_rep_app.hk_inv_format02_excel03;
grant execute on hk_inv_format02_excel03 to public;