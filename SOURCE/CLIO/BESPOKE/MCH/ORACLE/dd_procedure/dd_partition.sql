...
/* Package Header */
/******************/
create or replace package dd_partition as
...
/* Package Body */
/****************/
create or replace package body dd_partition as
   ...
   begin
      ...
      if (var_prefix = 'P' and var_period = '13') then
         ...
         raise_application_error(-20000, 'DD_PARTITION - invalid table partition date range');
      end if;
...
/**************************/
create or replace public synonym dd_partition for dd.dd_partition;
grant execute on dd_partition to dw_app;