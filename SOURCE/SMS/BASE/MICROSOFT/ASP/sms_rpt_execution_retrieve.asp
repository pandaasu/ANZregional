...
'// Script  : sms_rpt_execution_retrieve.asp                     //
'// Author  : Steve Gregan                                       //
'// Date    : July 2009                                          //
'// Text    : This script implements the report execution        //
...
'//////////////////////////////////////////////////////////////////
   ...
   '//
   strReturn = GetSecurityCheck("SMS_RPT_EXECUTION")
...
sub ProcessRequest()
   ...
   '//
   '// Retrieve the recipient definition
   '//
   strStatement = "select xml_text from table(sms_app.sms_rec_function.retrieve_execution)"
