...
'// Script  : sms_rpt_enquiry_report.asp                         //
'// Author  : Steve Gregan                                       //
'// Date    : July 2009                                          //
'// Text    : This script implements the enquiry report          //
...
sub ProcessRequest()
   ...
   '//
   strStatement = "select xml_text from table(sms_app.sms_rep_function.retrieve_report)"
