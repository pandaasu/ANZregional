...
/* Package Header */
/******************/
create or replace package lads_app.ladods01_extract as

   /******************************************************************************/
   /* Package Definition                                                         */
   /******************************************************************************/
   /**
    Package : ladods01_extract
    Owner   : lads_app
...
end ladods01_extract;
/

/****************/
/* Package Body */
/****************/
create or replace package body lads_app.ladods01_extract as
   ...
   exception
      ...
      when others then
         ...
         /*-*/
         raise_application_error(-20000, 'FATAL ERROR - LADODS01_EXTRACT - ' || var_exception);
...
/**************************/
create or replace public synonym ladods01_extract for lads_app.ladods01_extract;
grant execute on ladods01_extract to public;
