...
/* Package Header */
/******************/
create or replace package ics_ladwms02 as
...
/**
 System  : LADS
 Package : ics_ladwms02
 Owner   : ICS_APP
 Author  : Steve Gregan

 Description
 -----------
    LADS -> CHINA WAREHOUSE MATERIAL MASTER EXTRACT
...
/* Package Body */
/****************/
create or replace package body ics_ladwms02 as
