--
-- ICS_LADWMS07_EXTRACT  (Package) 
--
CREATE OR REPLACE PACKAGE ICS_APP."ICS_LADWMS07_EXTRACT" as
...
/**
 System  : LADS
 Package : ics_LADWMS07_extract
 Owner   : ICS_APP
 Author  : Steve Gregan

 Description
 -----------
    LADS -> Thailand Warehouse Material Master Extract (IDS)
 ...
 2011/12   Ben Halicki          Updated for Thailand IDS implementation
...
end ics_LADWMS07_extract;
/


--
-- ICS_LADWMS07_EXTRACT  (Synonym) 
--
CREATE PUBLIC SYNONYM ICS_LADWMS07_EXTRACT FOR ICS_APP.ICS_LADWMS07_EXTRACT;


GRANT EXECUTE ON ICS_APP.ICS_LADWMS07_EXTRACT TO LICS_APP;


--
-- ICS_LADWMS07_EXTRACT  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY ICS_APP."ICS_LADWMS07_EXTRACT" as
   ...
   /* Constants
   /*-*/
   var_interface constant varchar2(8) := 'LADWMS07';
   ...
   exception
      ...
      when others then
         ...
         /* Raise
         /*-*/
         raise_application_error(-20000,'ICS_LADWMS07_EXTRACT - FORMAT_XML_STR - Error formatting string ['||par_string||'] - ['||SQLERRM||']');
