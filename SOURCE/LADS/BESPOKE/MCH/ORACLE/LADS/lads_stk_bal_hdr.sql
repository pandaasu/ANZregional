...
comment on column lads_stk_bal_hdr.lads_flattened is 'LADS Flattened Status - 0 Unflattened, 1 Flattened to BDS, 2 Excluded/Skipped';
...
grant select, update on lads_stk_bal_hdr to bds_app;
