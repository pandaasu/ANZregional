...
create or replace package body lads_atllad04 as
   ...
   begin
      ...
      if var_trn_ignore = true then
         ...
         begin
            lads_atllad04_monitor.execute_before(rcd_lads_mat_hdr.matnr);
         exception
            when others then
         ...
         begin
            lads_atllad04_monitor.execute_after(rcd_lads_mat_hdr.matnr);
         exception
            when others then
               lics_inbound_utility.add_exception(substr(SQLERRM, 1, 512));
         end;         
   ...
   begin
      ...
      rcd_lads_mat_hdr.lads_flattened := '0';
      ...
      begin
         ...
         values
            (rcd_lads_mat_hdr.matnr,
             ...
             rcd_lads_mat_hdr.lads_flattened);
      exception
         when dup_val_on_index then
            ...
            if sql%found and var_idoc_timestamp <= rcd_lads_mat_hdr.idoc_timestamp then
      ...
      update lads_mat_hdr set
         ...
         lads_flattened = rcd_lads_mat_hdr.lads_flattened
      where matnr = rcd_lads_mat_hdr.matnr;
