...
create or replace package body lads_atllad01 as
   ...
   begin
      ...
      rcd_lads_ctl_rec_hpi.lads_flattened := '0';
      ...
      begin
         ...
         values
            (rcd_lads_ctl_rec_hpi.cntl_rec_id,
             ...
             rcd_lads_ctl_rec_hpi.lads_flattened);
      exception
         when dup_val_on_index then
            ...
            if sql%found and var_idoc_timestamp <= rcd_lads_ctl_rec_hpi.idoc_timestamp then
      ...
      update lads_ctl_rec_hpi set
         ...
         lads_flattened = rcd_lads_ctl_rec_hpi.lads_flattened
      where cntl_rec_id = rcd_lads_ctl_rec_hpi.cntl_rec_id;
