...
create or replace package lads_atllad07_monitor as
   ...
   /* Public declarations
   /*-*/
   procedure execute(par_klart in varchar2, par_class in varchar2);
...
create or replace package body lads_atllad07_monitor as
   ...
   /***********************************************/
   procedure execute(par_klart in varchar2, par_class in varchar2) is
   ...
   exception
      ...
      when others then
         ...
         /*-*/
         raise_application_error(-20000, 'LADS_ATLLAD07_MONITOR - EXECUTE - ' || substr(SQLERRM, 1, 1024));
