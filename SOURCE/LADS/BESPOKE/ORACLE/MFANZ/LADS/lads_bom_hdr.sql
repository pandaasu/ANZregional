...
/**
 ...
 2007/02   Linden Glen    Added LADS_FLATTENED
...
comment on column lads_bom_hdr.lads_flattened is 'LADS Flattened Status - 0 Unflattened, 1 Flattened to BDS, 2 Excluded/Skipped';
...
grant select, update on lads_bom_hdr to bds_app;

/**/
/* Synonym
/**/
create or replace public synonym lads_bom_hdr for lads.lads_bom_hdr;
