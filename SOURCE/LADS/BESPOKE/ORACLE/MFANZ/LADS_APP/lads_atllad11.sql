...
create or replace package body lads_atllad11 as
   ...
   procedure process_record_hdr(par_record in varchar2) is
      ...
      /* Local definitions
      /*-*/
      var_idoc_timestamp lads_cus_hdr.idoc_timestamp%type;
   ...
   begin
      ...
      rcd_lads_cus_hdr.lads_flattened := '0';
      ...
      begin
         ...
         values
            (rcd_lads_cus_hdr.kunnr,
             ...
             rcd_lads_cus_hdr.lads_flattened);
      exception
         when dup_val_on_index then
            ...
            if sql%found and var_idoc_timestamp <= rcd_lads_cus_hdr.idoc_timestamp then
      ...
      update lads_cus_hdr set
         ...
         lads_flattened = rcd_lads_cus_hdr.lads_flattened
      where kunnr = rcd_lads_cus_hdr.kunnr;
