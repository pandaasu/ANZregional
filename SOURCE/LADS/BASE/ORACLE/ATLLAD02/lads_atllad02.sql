...
create or replace package body lads_atllad02 as
   ...
   begin
      ...
      if var_trn_ignore = true then
         ...
         commit;
         begin
            lads_atllad02_monitor.execute(rcd_lads_stk_bal_hdr.bukrs,
   ...
   procedure process_record_hdr(par_record in varchar2) is
      ...
      /* Local cursors
      /*-*/
      cursor csr_lads_stk_bal_hdr_01 is
         select
            t01.bukrs,
            t01.werks,
            t01.lgort,
      ...
      rcd_lads_stk_bal_hdr_01 csr_lads_stk_bal_hdr_01%rowtype;
   ...
   begin
      ...
      /*-*/
      if not(rcd_lads_stk_bal_hdr.bukrs is null) and
         not(rcd_lads_stk_bal_hdr.werks is null) and
         not(rcd_lads_stk_bal_hdr.lgort is null) and
         not(rcd_lads_stk_bal_hdr.budat is null) and
         not(rcd_lads_stk_bal_hdr.timlo is null) then
         var_exists := true;
         open csr_lads_stk_bal_hdr_01;
         fetch csr_lads_stk_bal_hdr_01 into rcd_lads_stk_bal_hdr_01;
         if csr_lads_stk_bal_hdr_01%notfound then
            var_exists := false;
         end if;
         close csr_lads_stk_bal_hdr_01;
         if var_exists = true then
            if rcd_lads_stk_bal_hdr.idoc_timestamp > rcd_lads_stk_bal_hdr_01.idoc_timestamp then
      ...
      if sql%notfound then
         ...
         values
            (rcd_lads_stk_bal_hdr.bukrs,
             ...
             rcd_lads_stk_bal_hdr.lgort,
             rcd_lads_stk_bal_hdr.budat,
             rcd_lads_stk_bal_hdr.credat,
             rcd_lads_stk_bal_hdr.cretim,
             rcd_lads_stk_bal_hdr.vbund,
             rcd_lads_stk_bal_hdr.timlo,
             rcd_lads_stk_bal_hdr.mblnr,
