...
create or replace package body lads_atllad19 as
   ...
   begin
      ...
      if var_trn_ignore = true then
         ...
         commit;
         begin
            lads_atllad19_monitor.execute(rcd_lads_ven_hdr.lifnr);
         exception
            when others then
               lics_inbound_utility.add_exception(substr(SQLERRM, 1, 512));
         end;
   ...
   procedure process_record_hdr(par_record in varchar2) is
      ...
      rcd_lads_ven_hdr_01 csr_lads_ven_hdr_01%rowtype;
   ...
   begin
      ...
      /*-*/
      if not(rcd_lads_ven_hdr.lifnr is null) then
         var_exists := true;
         open csr_lads_ven_hdr_01;
         fetch csr_lads_ven_hdr_01 into rcd_lads_ven_hdr_01;
         if csr_lads_ven_hdr_01%notfound then
            var_exists := false;
         end if;
         close csr_lads_ven_hdr_01;
         if var_exists = true then
            if rcd_lads_ven_hdr.idoc_timestamp > rcd_lads_ven_hdr_01.idoc_timestamp then
      ...
      if sql%notfound then
         ...
         values
            (rcd_lads_ven_hdr.lifnr,
             rcd_lads_ven_hdr.begru,
             rcd_lads_ven_hdr.brsch,
             rcd_lads_ven_hdr.erdat,
             rcd_lads_ven_hdr.ernam,
             rcd_lads_ven_hdr.konzs,
             rcd_lads_ven_hdr.ktokk,
             rcd_lads_ven_hdr.kunnr,
             rcd_lads_ven_hdr.lnrza,
             rcd_lads_ven_hdr.loevm,
             rcd_lads_ven_hdr.name1,
             rcd_lads_ven_hdr.name2,
             rcd_lads_ven_hdr.name3,
             rcd_lads_ven_hdr.name4,
             rcd_lads_ven_hdr.sortl,
             rcd_lads_ven_hdr.sperr,
             rcd_lads_ven_hdr.sperm,
             rcd_lads_ven_hdr.spras,
             rcd_lads_ven_hdr.stcd1,
             rcd_lads_ven_hdr.stcd2,
             rcd_lads_ven_hdr.stkza,
             rcd_lads_ven_hdr.stkzu,
             rcd_lads_ven_hdr.xcpdk,
             rcd_lads_ven_hdr.xzemp,
             rcd_lads_ven_hdr.vbund,
             rcd_lads_ven_hdr.fiskn,
             rcd_lads_ven_hdr.stceg,
             rcd_lads_ven_hdr.stkzn,
             rcd_lads_ven_hdr.sperq,
             rcd_lads_ven_hdr.adrnr,
             rcd_lads_ven_hdr.gbort,
             rcd_lads_ven_hdr.gbdat,
             rcd_lads_ven_hdr.sexkz,
             rcd_lads_ven_hdr.kraus,
             rcd_lads_ven_hdr.revdb,
             rcd_lads_ven_hdr.qssys,
             rcd_lads_ven_hdr.ktock,
             rcd_lads_ven_hdr.werks,
             rcd_lads_ven_hdr.ltsna,
             rcd_lads_ven_hdr.werkr,
             rcd_lads_ven_hdr.plkal,
             rcd_lads_ven_hdr.duefl,
             rcd_lads_ven_hdr.txjcd,
             rcd_lads_ven_hdr.scacd,
             rcd_lads_ven_hdr.sfrgr,
             rcd_lads_ven_hdr.lzone,
             rcd_lads_ven_hdr.dlgrp,
             rcd_lads_ven_hdr.fityp,
             rcd_lads_ven_hdr.stcdt,
             rcd_lads_ven_hdr.regss,
             rcd_lads_ven_hdr.actss,
             rcd_lads_ven_hdr.stcd3,
             rcd_lads_ven_hdr.stcd4,
             rcd_lads_ven_hdr.ipisp,
             rcd_lads_ven_hdr.profs,
             rcd_lads_ven_hdr.stgdl,
             rcd_lads_ven_hdr.emnfr,
             rcd_lads_ven_hdr.nodel,
             rcd_lads_ven_hdr.lfurl,
             rcd_lads_ven_hdr.j_1kfrepre,
             rcd_lads_ven_hdr.j_1kftbus,
             rcd_lads_ven_hdr.j_1kftind,
             rcd_lads_ven_hdr.qssysdat,
             rcd_lads_ven_hdr.podkzb,
             rcd_lads_ven_hdr.fisku,
             rcd_lads_ven_hdr.stenr,
             rcd_lads_ven_hdr.psois,
             rcd_lads_ven_hdr.pson1,
             rcd_lads_ven_hdr.pson2,
             rcd_lads_ven_hdr.pson3,
             rcd_lads_ven_hdr.psovn,
