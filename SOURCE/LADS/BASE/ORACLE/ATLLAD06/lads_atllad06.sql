...
create or replace package body lads_atllad06 as
   ...
   procedure process_record_hdr(par_record in varchar2) is
      ...
      cursor csr_lads_cla_hdr_01 is
         ...
         where t01.obtab = rcd_lads_cla_hdr.obtab
           and t01.objek = rcd_lads_cla_hdr.objek
           and t01.klart = rcd_lads_cla_hdr.klart;
      rcd_lads_cla_hdr_01 csr_lads_cla_hdr_01%rowtype;
   ...
   begin
      ...
      /*-*/
      if not(rcd_lads_cla_hdr.obtab is null) and
         not(rcd_lads_cla_hdr.objek is null) and
         not(rcd_lads_cla_hdr.klart is null) then
         var_exists := true;
         open csr_lads_cla_hdr_01;
         fetch csr_lads_cla_hdr_01 into rcd_lads_cla_hdr_01;
         if csr_lads_cla_hdr_01%notfound then
            var_exists := false;
         end if;
         close csr_lads_cla_hdr_01;
         if var_exists = true then
            if rcd_lads_cla_hdr.idoc_timestamp > rcd_lads_cla_hdr_01.idoc_timestamp then
