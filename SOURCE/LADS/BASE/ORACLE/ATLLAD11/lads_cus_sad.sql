...
/**
 ...
 2006/11   Steve Gregan   Added columns: ZZCURRENTFLAG
                                         ZZFUTUREFLAG
                                         ZZMARKETACCTFLAG
 2007/08   Steve Gregan   Added columns for Atlas 3.2.1 upgrade
...
create table lads_cus_sad
   (kunnr                                        varchar2(10 char)                   not null,
    ...
    zzcspiv                                      varchar2(1 char)                    null,
    zzcmph                                       number                              null,
    zzcmph_uom                                   varchar2(3 char)                    null,
    zzhppl                                       varchar2(1 char)                    null,
    zzhppc                                       varchar2(1 char)                    null,
    zztmr                                        varchar2(1 char)                    null,
    zzpppm                                       varchar2(18 char)                   null,
    zzmpph                                       number                              null,
    zzmpph_uom                                   varchar2(3 char)                    null);
...
comment on column lads_cus_sad.zzcspiv is 'Customer Specific Packing Instruction Validation';
comment on column lads_cus_sad.zzcmph is 'Customer Maximum Pallet Height';
comment on column lads_cus_sad.zzcmph_uom is 'Customer Maximum Pallet Height UoM';
comment on column lads_cus_sad.zzhppl is 'Homogeneous pick pallet for layers';
comment on column lads_cus_sad.zzhppc is 'Homogenous pick pallet for cases';
comment on column lads_cus_sad.zztmr is 'Transport modules required';
comment on column lads_cus_sad.zzpppm is 'Pick Pallet packaging material';
comment on column lads_cus_sad.zzmpph is 'Pick pallet maximum Height';
comment on column lads_cus_sad.zzmpph_uom is 'Pick pallet maximum Height UoM';
