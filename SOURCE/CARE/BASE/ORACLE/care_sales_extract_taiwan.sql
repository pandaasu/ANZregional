...
/* Package Header */
/******************/
create or replace package care_sales_extract_taiwan as

/******************************************************************************/
/* Package Definition                                                         */
/******************************************************************************/
/**
 Package : care_sales_extract_taiwan
 Owner   : dw_app

 Description
 -----------
 Care - Sales Extract - Taiwan Version
...
end care_sales_extract_taiwan;
/

/****************/
/* Package Body */
/****************/
create or replace package body care_sales_extract_taiwan as
         ...
         select t02.source_logx_code,
           ...
           from (select t01.trad_unit_code as trad_unit_code,
                  ...
                  where t01.trad_unit_code = t02.trad_unit_code
                    ...
                    and (t01.order_type not like 'NSR%')
...
/**************************/
create or replace public synonym care_sales_extract_taiwan for dw_app.care_sales_extract_taiwan;
grant execute on care_sales_extract_taiwan to public;
