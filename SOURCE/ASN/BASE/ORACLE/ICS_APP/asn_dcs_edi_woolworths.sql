...
/* Package Header */
/******************/
create or replace package asn_dcs_edi_woolworths as
   ...
   /**
    System  : asn
    Package : asn_dcs_edi_woolworths
    Owner   : ics_app
    Author  : Steve Gregan

    Description
    -----------
    Advanced Shipping Notice - ASN Distribution Centre Shipment EDI Message - WOOLWORTHS

    This package contain the processing logic for distribution centre advanced shipping notices
    WOOLWORTHS EDI message. The package exposes the following procedure:
    ...
    2008/06   Steve Gregan   Changed the outbound interface to ASNEDI02
...
end asn_dcs_edi_woolworths;
/

/****************/
/* Package Body */
/****************/
create or replace package body asn_dcs_edi_woolworths as
   ...
   procedure send_message(par_smsg_nbr in number) is
      ...
      cursor csr_asn_dcs_det is 
         select * 
          ...
          order by t01.dcd_whs_cust_gtin asc,
                   t01.dcd_whs_btch asc,
                   t01.dcd_whs_bbdt asc,
                   t01.dcd_whs_sscc_nbr asc;
   ...
   begin
      ...
      tbl_outbound(tbl_outbound.count+1) := '<XML_ATLAS_ASN_WOOLWORTHS>';
      ...
      loop
         ...
         if var_020ind = false or
            ...
            tbl_outbound(tbl_outbound.count+1) := '      <TIHILAY>' || to_char(nvl(rcd_asn_dcs_det.dcd_whs_palt_lay,0),'fm990') || '</TIHILAY>';
      ...
      /*-*/
      var_instance := lics_outbound_loader.create_interface('ASNEDI02',null,null);
...
/**************************/
create or replace public synonym asn_dcs_edi_woolworths for ics_app.asn_dcs_edi_woolworths;
grant execute on asn_dcs_edi_woolworths to public;
