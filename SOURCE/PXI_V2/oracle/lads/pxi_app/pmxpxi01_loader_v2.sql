prompt :: Compile Package [pmxpxi01_loader_v2] ::::::::::::::::::::::::::::::::::::::::

create or replace package pxi_app.pmxpxi01_loader_v2 as
...
end pmxpxi01_loader_v2;
/

create or replace package body pxi_app.pmxpxi01_loader_v2 as

/*******************************************************************************
  Package Constants
*******************************************************************************/
  pc_package_name constant pxi_common.st_package_name := 'PMXPXI01_LOADER_V2';
...
grant execute on pxi_app.pmxpxi01_loader_v2 to lics_app, fflu_app, site_app;
