prompt :: Compile Package [pxiatl01_extract_v2] :::::::::::::::::::::::::::::::::::::::

create or replace package pxi_app.pxiatl01_extract_v2 as
/*******************************************************************************
** PACKAGE DEFINITION
********************************************************************************
...
end pxiatl01_extract_v2;
/

create or replace package body pxi_app.pxiatl01_extract_v2 as
...
/*******************************************************************************
  Package Constants
*******************************************************************************/
  pc_package_name constant pxi_common.st_package_name := 'PXIATL01_EXTRACT_V2';
  pc_outbound_interface_name constant pxi_common.st_interface_name := 'PXIATL01';
...
*******************************************************************************/
   ...
   begin
     ...
     if ti_data.count = 0 then
       ...
       v_instance := lics_outbound_loader.create_interface(pc_outbound_interface_name);
...
grant execute on pxi_app.pxiatl01_extract_v2 to lics_app, fflu_app, site_app;
