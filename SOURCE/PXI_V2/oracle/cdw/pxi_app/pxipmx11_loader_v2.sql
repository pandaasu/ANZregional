prompt :: Compile Package [pxipmx11_loader_v2] ::::::::::::::::::::::::::::::::::::::::

create or replace package pxi_app.pxipmx11_loader_v2 as
  /*****************************************************************************
  ** PACKAGE DEFINITION
  ******************************************************************************

    Schema    : pxi_app
    Package   : PXIPMX11_LOADER_V2
    Author    : Chris Horn
...
end pxipmx11_loader_v2;
/

create or replace package body pxi_app.pxipmx11_loader_v2 as

/*******************************************************************************
  Package Constants
*******************************************************************************/
  -- Package Cosntants
  pc_package_name constant pxi_common.st_package_name := 'PXIPMX11_LOADER_V2';
...
grant execute on pxi_app.pxipmx11_loader_v2 to lics_app, fflu_app;
